 ...
 */var dm;function Jv(){if(dm)return Ae;dm=1;var i=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),h=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),P=Symbol.iterator;function M(V){return V===null||typeof V!="object"?null:(V=P&&V[P]||V["@@iterator"],typeof V=="function"?V:null)}var z={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},B=Object.assign,G={};function $(V,H,de){this.props=V,this.context=H,this.refs=G,this.updater=de||z}$.prototype.isReactComponent={},$.prototype.setState=function(V,H){if(typeof V!="object"&&typeof V!="function"&&V!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,V,H,"setState")},$.prototype.forceUpdate=function(V){this.updater.enqueueForceUpdate(this,V,"forceUpdate")};function pe(){}pe.prototype=$.prototype;function ce(V,H,de){this.props=V,this.context=H,this.refs=G,this.updater=de||z}var te=ce.prototype=new pe;te.constructor=ce,B(te,$.prototype),te.isPureReactComponent=!0;var fe=Array.isArray,Ne=Object.prototype.hasOwnProperty,he={current:null},k={key:!0,ref:!0,__self:!0,__source:!0};function T(V,H,de){var Ie,Se={},xe=null,be=null;if(H!=null)for(Ie in H.ref!==void 0&&(be=H.ref),H.key!==void 0&&(xe=""+H.key),H)Ne.call(H,Ie)&&!k.hasOwnProperty(Ie)&&(Se[Ie]=H[Ie]);var Fe=arguments.length-2;if(Fe===1)Se.children=de;else if(1<Fe){for(var Be=Array(Fe),_t=0;_t<Fe;_t++)Be[_t]=arguments[_t+2];Se.children=Be}if(V&&V.defaultProps)for(Ie in Fe=V.defaultProps,Fe)Se[Ie]===void 0&&(Se[Ie]=Fe[Ie]);return{$$typeof:i,type:V,key:xe,ref:be,props:Se,_owner:he.current}}function A(V,H){return{$$typeof:i,type:V.type,key:H,ref:V.ref,props:V.props,_owner:V._owner}}function R(V){return typeof V=="object"&&V!==null&&V.$$typeof===i}function x(V){var H={"=":"=0",":":"=2"};return"$"+V.replace(/[=:]/g,function(de){return H[de]})}var D=/\/+/g;function S(V,H){return typeof V=="object"&&V!==null&&V.key!=null?x(""+V.key):H.toString(36)}function Xe(V,H,de,Ie,Se){var xe=typeof V;(xe==="undefined"||xe==="boolean")&&(V=null);var be=!1;if(V===null)be=!0;else switch(xe){case"string":case"number":be=!0;break;case"object":switch(V.$$typeof){case i:case e:be=!0}}if(be)return be=V,Se=Se(be),V=Ie===""?"."+S(be,0):Ie,fe(Se)?(de="",V!=null&&(de=V.replace(D,"$&/")+"/"),Xe(Se,H,de,"",function(_t){return _t})):Se!=null&&(R(Se)&&(Se=A(Se,de+(!Se.key||be&&be.key===Se.key?"":(""+Se.key).replace(D,"$&/")+"/")+V)),H.push(Se)),1;if(be=0,Ie=Ie===""?".":Ie+":",fe(V))for(var Fe=0;Fe<V.length;Fe++){xe=V[Fe];var Be=Ie+S(xe,Fe);be+=Xe(xe,H,de,Be,Se)}else if(Be=M(V),typeof Be=="function")for(V=Be.call(V),Fe=0;!(xe=V.next()).done;)xe=xe.value,Be=Ie+S(xe,Fe++),be+=Xe(xe,H,de,Be,Se);else if(xe==="object")throw H=String(V),Error("Objects are not valid as a React child (found: "+(H==="[object Object]"?"object with keys {"+Object.keys(V).join(", ")+"}":H)+"). If you meant to render a collection of children, use an array instead.");return be}function yt(V,H,de){if(V==null)return V;var Ie=[],Se=0;return Xe(V,Ie,"","",function(xe){return H.call(de,xe,Se++)}),Ie}function it(V){if(V._status===-1){var H=V._result;H=H(),H.then(function(de){(V._status===0||V._status===-1)&&(V._status=1,V._result=de)},function(de){(V._status===0||V._status===-1)&&(V._status=2,V._result=de)}),V._status===-1&&(V._status=0,V._result=H)}if(V._status===1)return V._result.default;throw V._result}var Le={current:null},Z={transition:null},ue={ReactCurrentDispatcher:Le,ReactCurrentBatchConfig:Z,ReactCurrentOwner:he};function ne(){throw Error("act(...) is not supported in production builds of React.")}return Ae.Children={map:yt,forEach:function(V,H,de){yt(V,function(){H.apply(this,arguments)},de)},count:function(V){var H=0;return yt(V,function(){H++}),H},toArray:function(V){return yt(V,function(H){return H})||[]},only:function(V){if(!R(V))throw Error("React.Children.only expected to receive a single React element child.");return V}},Ae.Component=$,Ae.Fragment=t,Ae.Profiler=o,Ae.PureComponent=ce,Ae.StrictMode=s,Ae.Suspense=g,Ae.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=ue,Ae.act=ne,Ae.cloneElement=function(V,H,de){if(V==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+V+".");var Ie=B({},V.props),Se=V.key,xe=V.ref,be=V._owner;if(H!=null){if(H.ref!==void 0&&(xe=H.ref,be=he.current),H.key!==void 0&&(Se=""+H.key),V.type&&V.type.defaultProps)var Fe=V.type.defaultProps;for(Be in H)Ne.call(H,Be)&&!k.hasOwnProperty(Be)&&(Ie[Be]=H[Be]===void 0&&Fe!==void 0?Fe[Be]:H[Be])}var Be=arguments.length-2;if(Be===1)Ie.children=de;else if(1<Be){Fe=Array(Be);for(var _t=0;_t<Be;_t++)Fe[_t]=arguments[_t+2];Ie.children=Fe}return{$$typeof:i,type:V.type,key:Se,ref:xe,props:Ie,_owner:be}},Ae.createContext=function(V){return V={$$typeof:h,_currentValue:V,_currentValue2:V,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},V.Provider={$$typeof:u,_context:V},V.Consumer=V},Ae.createElement=T,Ae.createFactory=function(V){var H=T.bind(null,V);return H.type=V,H},Ae.createRef=function(){return{current:null}},Ae.forwardRef=function(V){return{$$typeof:m,render:V}},Ae.isValidElement=R,Ae.lazy=function(V){return{$$typeof:w,_payload:{_status:-1,_result:V},_init:it}},Ae.memo=function(V,H){return{$$typeof:v,type:V,compare:H===void 0?null:H}},Ae.startTransition=function(V){var H=Z.transition;Z.transition={};try{V()}finally{Z.transition=H}},Ae.unstable_act=ne,Ae.useCallback=function(V,H){return Le.current.useCallback(V,H)},Ae.useContext=function(V){return Le.current.useContext(V)},Ae.useDebugValue=function(){},Ae.useDeferredValue=function(V){return Le.current.useDeferredValue(V)},Ae.useEffect=function(V,H){return Le.current.useEffect(V,H)},Ae.useId=function(){return Le.current.useId()},Ae.useImperativeHandle=function(V,H,de){return Le.current.useImperativeHandle(V,H,de)},Ae.useInsertionEffect=function(V,H){return Le.current.useInsertionEffect(V,H)},Ae.useLayoutEffect=function(V,H){return Le.current.useLayoutEffect(V,H)},Ae.useMemo=function(V,H){return Le.current.useMemo(V,H)},Ae.useReducer=function(V,H,de){return Le.current.useReducer(V,H,de)},Ae.useRef=function(V){return Le.current.useRef(V)},Ae.useState=function(V){return Le.current.useState(V)},Ae.useSyncExternalStore=function(V,H,de){return Le.current.useSyncExternalStore(V,H,de)},Ae.useTransition=function(){return Le.current.useTransition()},Ae.version="18.3.1",Ae}var fm;function fd(){return fm||(fm=1,Ph.exports=Jv()),Ph.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var pm;function Zv(){if(pm)return fa;pm=1;var i=fd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,u={key:!0,ref:!0,__self:!0,__source:!0};function h(m,g,v){var w,P={},M=null,z=null;v!==void 0&&(M=""+v),g.key!==void 0&&(M=""+g.key),g.ref!==void 0&&(z=g.ref);for(w in g)s.call(g,w)&&!u.hasOwnProperty(w)&&(P[w]=g[w]);if(m&&m.defaultProps)for(w in g=m.defaultProps,g)P[w]===void 0&&(P[w]=g[w]);return{$$typeof:e,type:m,key:M,ref:z,props:P,_owner:o.current}}return fa.Fragment=t,fa.jsx=h,fa.jsxs=h,fa}var mm;function e0(){return mm||(mm=1,kh.exports=Zv()),kh.exports}var j=e0(),lt=fd(),nu={},Nh={exports:{}},Xt={},xh={exports:{}},Dh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var gm;function t0(){return gm||(gm=1,function(i){function e(Z,ue){var ne=Z.length;Z.push(ue);e:for(;0<ne;){var V=ne-1>>>1,H=Z[V];if(0<o(H,ue))Z[V]=ue,Z[ne]=H,ne=V;else break e}}function t(Z){return Z.length===0?null:Z[0]}function s(Z){if(Z.length===0)return null;var ue=Z[0],ne=Z.pop();if(ne!==ue){Z[0]=ne;e:for(var V=0,H=Z.length,de=H>>>1;V<de;){var Ie=2*(V+1)-1,Se=Z[Ie],xe=Ie+1,be=Z[xe];if(0>o(Se,ne))xe<H&&0>o(be,Se)?(Z[V]=be,Z[xe]=ne,V=xe):(Z[V]=Se,Z[Ie]=ne,V=Ie);else if(xe<H&&0>o(be,ne))Z[V]=be,Z[xe]=ne,V=xe;else break e}}return ue}function o(Z,ue){var ne=Z.sortIndex-ue.sortIndex;return ne!==0?ne:Z.id-ue.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;i.unstable_now=function(){return u.now()}}else{var h=Date,m=h.now();i.unstable_now=function(){return h.now()-m}}var g=[],v=[],w=1,P=null,M=3,z=!1,B=!1,G=!1,$=typeof setTimeout=="function"?setTimeout:null,pe=typeof clearTimeout=="function"?clearTimeout:null,ce=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function te(Z){for(var ue=t(v);ue!==null;){if(ue.callback===null)s(v);else if(ue.startTime<=Z)s(v),ue.sortIndex=ue.expirationTime,e(g,ue);else break;ue=t(v)}}function fe(Z){if(G=!1,te(Z),!B)if(t(g)!==null)B=!0,it(Ne);else{var ue=t(v);ue!==null&&Le(fe,ue.startTime-Z)}}function Ne(Z,ue){B=!1,G&&(G=!1,pe(T),T=-1),z=!0;var ne=M;try{for(te(ue),P=t(g);P!==null&&(!(P.expirationTime>ue)||Z&&!x());){var V=P.callback;if(typeof V=="function"){P.callback=null,M=P.priorityLevel;var H=V(P.expirationTime<=ue);ue=i.unstable_now(),typeof H=="function"?P.callback=H:P===t(g)&&s(g),te(ue)}else s(g);P=t(g)}if(P!==null)var de=!0;else{var Ie=t(v);Ie!==null&&Le(fe,Ie.startTime-ue),de=!1}return de}finally{P=null,M=ne,z=!1}}var he=!1,k=null,T=-1,A=5,R=-1;function x(){return!(i.unstable_now()-R<A)}function D(){if(k!==null){var Z=i.unstable_now();R=Z;var ue=!0;try{ue=k(!0,Z)}finally{ue?S():(he=!1,k=null)}}else he=!1}var S;if(typeof ce=="function")S=function(){ce(D)};else if(typeof MessageChannel<"u"){var Xe=new MessageChannel,yt=Xe.port2;Xe.port1.onmessage=D,S=function(){yt.postMessage(null)}}else S=function(){$(D,0)};function it(Z){k=Z,he||(he=!0,S())}function Le(Z,ue){T=$(function(){Z(i.unstable_now())},ue)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(Z){Z.callback=null},i.unstable_continueExecution=function(){B||z||(B=!0,it(Ne))},i.unstable_forceFrameRate=function(Z){0>Z||125<Z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<Z?Math.floor(1e3/Z):5},i.unstable_getCurrentPriorityLevel=function(){return M},i.unstable_getFirstCallbackNode=function(){return t(g)},i.unstable_next=function(Z){switch(M){case 1:case 2:case 3:var ue=3;break;default:ue=M}var ne=M;M=ue;try{return Z()}finally{M=ne}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(Z,ue){switch(Z){case 1:case 2:case 3:case 4:case 5:break;default:Z=3}var ne=M;M=Z;try{return ue()}finally{M=ne}},i.unstable_scheduleCallback=function(Z,ue,ne){var V=i.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?V+ne:V):ne=V,Z){case 1:var H=-1;break;case 2:H=250;break;case 5:H=1073741823;break;case 4:H=1e4;break;default:H=5e3}return H=ne+H,Z={id:w++,callback:ue,priorityLevel:Z,startTime:ne,expirationTime:H,sortIndex:-1},ne>V?(Z.sortIndex=ne,e(v,Z),t(g)===null&&Z===t(v)&&(G?(pe(T),T=-1):G=!0,Le(fe,ne-V))):(Z.sortIndex=H,e(g,Z),B||z||(B=!0,it(Ne))),Z},i.unstable_shouldYield=x,i.unstable_wrapCallback=function(Z){var ue=M;return function(){var ne=M;M=ue;try{return Z.apply(this,arguments)}finally{M=ne}}}}(Dh)),Dh}var ym;function n0(){return ym||(ym=1,xh.exports=t0()),xh.exports}/**
 * @license React
...
*/var li,Xg;(function(){var i;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(k,T){function A(){}A.prototype=T.prototype,k.D=T.prototype,k.prototype=new A,k.prototype.constructor=k,k.C=function(R,x,D){for(var S=Array(arguments.length-2),Xe=2;Xe<arguments.length;Xe++)S[Xe-2]=arguments[Xe];return T.prototype[x].apply(R,S)}}function t(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(s,t),s.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(k,T,A){A||(A=0);var R=Array(16);if(typeof T=="string")for(var x=0;16>x;++x)R[x]=T.charCodeAt(A++)|T.charCodeAt(A++)<<8|T.charCodeAt(A++)<<16|T.charCodeAt(A++)<<24;else for(x=0;16>x;++x)R[x]=T[A++]|T[A++]<<8|T[A++]<<16|T[A++]<<24;T=k.g[0],A=k.g[1],x=k.g[2];var D=k.g[3],S=T+(D^A&(x^D))+R[0]+3614090360&4294967295;T=A+(S<<7&4294967295|S>>>25),S=D+(x^T&(A^x))+R[1]+3905402710&4294967295,D=T+(S<<12&4294967295|S>>>20),S=x+(A^D&(T^A))+R[2]+606105819&4294967295,x=D+(S<<17&4294967295|S>>>15),S=A+(T^x&(D^T))+R[3]+3250441966&4294967295,A=x+(S<<22&4294967295|S>>>10),S=T+(D^A&(x^D))+R[4]+4118548399&4294967295,T=A+(S<<7&4294967295|S>>>25),S=D+(x^T&(A^x))+R[5]+1200080426&4294967295,D=T+(S<<12&4294967295|S>>>20),S=x+(A^D&(T^A))+R[6]+2821735955&4294967295,x=D+(S<<17&4294967295|S>>>15),S=A+(T^x&(D^T))+R[7]+4249261313&4294967295,A=x+(S<<22&4294967295|S>>>10),S=T+(D^A&(x^D))+R[8]+1770035416&4294967295,T=A+(S<<7&4294967295|S>>>25),S=D+(x^T&(A^x))+R[9]+2336552879&4294967295,D=T+(S<<12&4294967295|S>>>20),S=x+(A^D&(T^A))+R[10]+4294925233&4294967295,x=D+(S<<17&4294967295|S>>>15),S=A+(T^x&(D^T))+R[11]+2304563134&4294967295,A=x+(S<<22&4294967295|S>>>10),S=T+(D^A&(x^D))+R[12]+1804603682&4294967295,T=A+(S<<7&4294967295|S>>>25),S=D+(x^T&(A^x))+R[13]+4254626195&4294967295,D=T+(S<<12&4294967295|S>>>20),S=x+(A^D&(T^A))+R[14]+2792965006&4294967295,x=D+(S<<17&4294967295|S>>>15),S=A+(T^x&(D^T))+R[15]+1236535329&4294967295,A=x+(S<<22&4294967295|S>>>10),S=T+(x^D&(A^x))+R[1]+4129170786&4294967295,T=A+(S<<5&4294967295|S>>>27),S=D+(A^x&(T^A))+R[6]+3225465664&4294967295,D=T+(S<<9&4294967295|S>>>23),S=x+(T^A&(D^T))+R[11]+643717713&4294967295,x=D+(S<<14&4294967295|S>>>18),S=A+(D^T&(x^D))+R[0]+3921069994&4294967295,A=x+(S<<20&4294967295|S>>>12),S=T+(x^D&(A^x))+R[5]+3593408605&4294967295,T=A+(S<<5&4294967295|S>>>27),S=D+(A^x&(T^A))+R[10]+38016083&4294967295,D=T+(S<<9&4294967295|S>>>23),S=x+(T^A&(D^T))+R[15]+3634488961&4294967295,x=D+(S<<14&4294967295|S>>>18),S=A+(D^T&(x^D))+R[4]+3889429448&4294967295,A=x+(S<<20&4294967295|S>>>12),S=T+(x^D&(A^x))+R[9]+568446438&4294967295,T=A+(S<<5&4294967295|S>>>27),S=D+(A^x&(T^A))+R[14]+3275163606&4294967295,D=T+(S<<9&4294967295|S>>>23),S=x+(T^A&(D^T))+R[3]+4107603335&4294967295,x=D+(S<<14&4294967295|S>>>18),S=A+(D^T&(x^D))+R[8]+1163531501&4294967295,A=x+(S<<20&4294967295|S>>>12),S=T+(x^D&(A^x))+R[13]+2850285829&4294967295,T=A+(S<<5&4294967295|S>>>27),S=D+(A^x&(T^A))+R[2]+4243563512&4294967295,D=T+(S<<9&4294967295|S>>>23),S=x+(T^A&(D^T))+R[7]+1735328473&4294967295,x=D+(S<<14&4294967295|S>>>18),S=A+(D^T&(x^D))+R[12]+2368359562&4294967295,A=x+(S<<20&4294967295|S>>>12),S=T+(A^x^D)+R[5]+4294588738&4294967295,T=A+(S<<4&4294967295|S>>>28),S=D+(T^A^x)+R[8]+2272392833&4294967295,D=T+(S<<11&4294967295|S>>>21),S=x+(D^T^A)+R[11]+1839030562&4294967295,x=D+(S<<16&4294967295|S>>>16),S=A+(x^D^T)+R[14]+4259657740&4294967295,A=x+(S<<23&4294967295|S>>>9),S=T+(A^x^D)+R[1]+2763975236&4294967295,T=A+(S<<4&4294967295|S>>>28),S=D+(T^A^x)+R[4]+1272893353&4294967295,D=T+(S<<11&4294967295|S>>>21),S=x+(D^T^A)+R[7]+4139469664&4294967295,x=D+(S<<16&4294967295|S>>>16),S=A+(x^D^T)+R[10]+3200236656&4294967295,A=x+(S<<23&4294967295|S>>>9),S=T+(A^x^D)+R[13]+681279174&4294967295,T=A+(S<<4&4294967295|S>>>28),S=D+(T^A^x)+R[0]+3936430074&4294967295,D=T+(S<<11&4294967295|S>>>21),S=x+(D^T^A)+R[3]+3572445317&4294967295,x=D+(S<<16&4294967295|S>>>16),S=A+(x^D^T)+R[6]+76029189&4294967295,A=x+(S<<23&4294967295|S>>>9),S=T+(A^x^D)+R[9]+3654602809&4294967295,T=A+(S<<4&4294967295|S>>>28),S=D+(T^A^x)+R[12]+3873151461&4294967295,D=T+(S<<11&4294967295|S>>>21),S=x+(D^T^A)+R[15]+530742520&4294967295,x=D+(S<<16&4294967295|S>>>16),S=A+(x^D^T)+R[2]+3299628645&4294967295,A=x+(S<<23&4294967295|S>>>9),S=T+(x^(A|~D))+R[0]+4096336452&4294967295,T=A+(S<<6&4294967295|S>>>26),S=D+(A^(T|~x))+R[7]+1126891415&4294967295,D=T+(S<<10&4294967295|S>>>22),S=x+(T^(D|~A))+R[14]+2878612391&4294967295,x=D+(S<<15&4294967295|S>>>17),S=A+(D^(x|~T))+R[5]+4237533241&4294967295,A=x+(S<<21&4294967295|S>>>11),S=T+(x^(A|~D))+R[12]+1700485571&4294967295,T=A+(S<<6&4294967295|S>>>26),S=D+(A^(T|~x))+R[3]+2399980690&4294967295,D=T+(S<<10&4294967295|S>>>22),S=x+(T^(D|~A))+R[10]+4293915773&4294967295,x=D+(S<<15&4294967295|S>>>17),S=A+(D^(x|~T))+R[1]+2240044497&4294967295,A=x+(S<<21&4294967295|S>>>11),S=T+(x^(A|~D))+R[8]+1873313359&4294967295,T=A+(S<<6&4294967295|S>>>26),S=D+(A^(T|~x))+R[15]+4264355552&4294967295,D=T+(S<<10&4294967295|S>>>22),S=x+(T^(D|~A))+R[6]+2734768916&4294967295,x=D+(S<<15&4294967295|S>>>17),S=A+(D^(x|~T))+R[13]+1309151649&4294967295,A=x+(S<<21&4294967295|S>>>11),S=T+(x^(A|~D))+R[4]+4149444226&4294967295,T=A+(S<<6&4294967295|S>>>26),S=D+(A^(T|~x))+R[11]+3174756917&4294967295,D=T+(S<<10&4294967295|S>>>22),S=x+(T^(D|~A))+R[2]+718787259&4294967295,x=D+(S<<15&4294967295|S>>>17),S=A+(D^(x|~T))+R[9]+3951481745&4294967295,k.g[0]=k.g[0]+T&4294967295,k.g[1]=k.g[1]+(x+(S<<21&4294967295|S>>>11))&4294967295,k.g[2]=k.g[2]+x&4294967295,k.g[3]=k.g[3]+D&4294967295}s.prototype.u=function(k,T){T===void 0&&(T=k.length);for(var A=T-this.blockSize,R=this.B,x=this.h,D=0;D<T;){if(x==0)for(;D<=A;)o(this,k,D),D+=this.blockSize;if(typeof k=="string"){for(;D<T;)if(R[x++]=k.charCodeAt(D++),x==this.blockSize){o(this,R),x=0;break}}else for(;D<T;)if(R[x++]=k[D++],x==this.blockSize){o(this,R),x=0;break}}this.h=x,this.o+=T},s.prototype.v=function(){var k=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);k[0]=128;for(var T=1;T<k.length-8;++T)k[T]=0;var A=8*this.o;for(T=k.length-8;T<k.length;++T)k[T]=A&255,A/=256;for(this.u(k),k=Array(16),T=A=0;4>T;++T)for(var R=0;32>R;R+=8)k[A++]=this.g[T]>>>R&255;return k};function u(k,T){var A=m;return Object.prototype.hasOwnProperty.call(A,k)?A[k]:A[k]=T(k)}function h(k,T){this.h=T;for(var A=[],R=!0,x=k.length-1;0<=x;x--){var D=k[x]|0;R&&D==T||(A[x]=D,R=!1)}this.g=A}var m={};function g(k){return-128<=k&&128>k?u(k,function(T){return new h([T|0],0>T?-1:0)}):new h([k|0],0>k?-1:0)}function v(k){if(isNaN(k)||!isFinite(k))return P;if(0>k)return $(v(-k));for(var T=[],A=1,R=0;k>=A;R++)T[R]=k/A|0,A*=4294967296;return new h(T,0)}function w(k,T){if(k.length==0)throw Error("number format error: empty string");if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(k.charAt(0)=="-")return $(w(k.substring(1),T));if(0<=k.indexOf("-"))throw Error('number format error: interior "-" character');for(var A=v(Math.pow(T,8)),R=P,x=0;x<k.length;x+=8){var D=Math.min(8,k.length-x),S=parseInt(k.substring(x,x+D),T);8>D?(D=v(Math.pow(T,D)),R=R.j(D).add(v(S))):(R=R.j(A),R=R.add(v(S)))}return R}var P=g(0),M=g(1),z=g(16777216);i=h.prototype,i.m=function(){if(G(this))return-$(this).m();for(var k=0,T=1,A=0;A<this.g.length;A++){var R=this.i(A);k+=(0<=R?R:4294967296+R)*T,T*=4294967296}return k},i.toString=function(k){if(k=k||10,2>k||36<k)throw Error("radix out of range: "+k);if(B(this))return"0";if(G(this))return"-"+$(this).toString(k);for(var T=v(Math.pow(k,6)),A=this,R="";;){var x=fe(A,T).g;A=pe(A,x.j(T));var D=((0<A.g.length?A.g[0]:A.h)>>>0).toString(k);if(A=x,B(A))return D+R;for(;6>D.length;)D="0"+D;R=D+R}},i.i=function(k){return 0>k?0:k<this.g.length?this.g[k]:this.h};function B(k){if(k.h!=0)return!1;for(var T=0;T<k.g.length;T++)if(k.g[T]!=0)return!1;return!0}function G(k){return k.h==-1}i.l=function(k){return k=pe(this,k),G(k)?-1:B(k)?0:1};function $(k){for(var T=k.g.length,A=[],R=0;R<T;R++)A[R]=~k.g[R];return new h(A,~k.h).add(M)}i.abs=function(){return G(this)?$(this):this},i.add=function(k){for(var T=Math.max(this.g.length,k.g.length),A=[],R=0,x=0;x<=T;x++){var D=R+(this.i(x)&65535)+(k.i(x)&65535),S=(D>>>16)+(this.i(x)>>>16)+(k.i(x)>>>16);R=S>>>16,D&=65535,S&=65535,A[x]=S<<16|D}return new h(A,A[A.length-1]&-2147483648?-1:0)};function pe(k,T){return k.add($(T))}i.j=function(k){if(B(this)||B(k))return P;if(G(this))return G(k)?$(this).j($(k)):$($(this).j(k));if(G(k))return $(this.j($(k)));if(0>this.l(z)&&0>k.l(z))return v(this.m()*k.m());for(var T=this.g.length+k.g.length,A=[],R=0;R<2*T;R++)A[R]=0;for(R=0;R<this.g.length;R++)for(var x=0;x<k.g.length;x++){var D=this.i(R)>>>16,S=this.i(R)&65535,Xe=k.i(x)>>>16,yt=k.i(x)&65535;A[2*R+2*x]+=S*yt,ce(A,2*R+2*x),A[2*R+2*x+1]+=D*yt,ce(A,2*R+2*x+1),A[2*R+2*x+1]+=S*Xe,ce(A,2*R+2*x+1),A[2*R+2*x+2]+=D*Xe,ce(A,2*R+2*x+2)}for(R=0;R<T;R++)A[R]=A[2*R+1]<<16|A[2*R];for(R=T;R<2*T;R++)A[R]=0;return new h(A,0)};function ce(k,T){for(;(k[T]&65535)!=k[T];)k[T+1]+=k[T]>>>16,k[T]&=65535,T++}function te(k,T){this.g=k,this.h=T}function fe(k,T){if(B(T))throw Error("division by zero");if(B(k))return new te(P,P);if(G(k))return T=fe($(k),T),new te($(T.g),$(T.h));if(G(T))return T=fe(k,$(T)),new te($(T.g),T.h);if(30<k.g.length){if(G(k)||G(T))throw Error("slowDivide_ only works with positive integers.");for(var A=M,R=T;0>=R.l(k);)A=Ne(A),R=Ne(R);var x=he(A,1),D=he(R,1);for(R=he(R,2),A=he(A,2);!B(R);){var S=D.add(R);0>=S.l(k)&&(x=x.add(A),D=S),R=he(R,1),A=he(A,1)}return T=pe(k,x.j(T)),new te(x,T)}for(x=P;0<=k.l(T);){for(A=Math.max(1,Math.floor(k.m()/T.m())),R=Math.ceil(Math.log(A)/Math.LN2),R=48>=R?1:Math.pow(2,R-48),D=v(A),S=D.j(T);G(S)||0<S.l(k);)A-=R,D=v(A),S=D.j(T);B(D)&&(D=M),x=x.add(D),k=pe(k,S)}return new te(x,k)}i.A=function(k){return fe(this,k).h},i.and=function(k){for(var T=Math.max(this.g.length,k.g.length),A=[],R=0;R<T;R++)A[R]=this.i(R)&k.i(R);return new h(A,this.h&k.h)},i.or=function(k){for(var T=Math.max(this.g.length,k.g.length),A=[],R=0;R<T;R++)A[R]=this.i(R)|k.i(R);return new h(A,this.h|k.h)},i.xor=function(k){for(var T=Math.max(this.g.length,k.g.length),A=[],R=0;R<T;R++)A[R]=this.i(R)^k.i(R);return new h(A,this.h^k.h)};function Ne(k){for(var T=k.g.length+1,A=[],R=0;R<T;R++)A[R]=k.i(R)<<1|k.i(R-1)>>>31;return new h(A,k.h)}function he(k,T){var A=T>>5;T%=32;for(var R=k.g.length-A,x=[],D=0;D<R;D++)x[D]=0<T?k.i(D+A)>>>T|k.i(D+A+1)<<32-T:k.i(D+A);return new h(x,k.h)}s.prototype.digest=s.prototype.v,s.prototype.reset=s.prototype.s,s.prototype.update=s.prototype.u,Xg=s,h.prototype.add=h.prototype.add,h.prototype.multiply=h.prototype.j,h.prototype.modulo=h.prototype.A,h.prototype.compare=h.prototype.l,h.prototype.toNumber=h.prototype.m,h.prototype.toString=h.prototype.toString,h.prototype.getBits=h.prototype.i,h.fromNumber=v,h.fromString=w,li=h}).apply(typeof xm<"u"?xm:typeof self<"u"?self:typeof window<"u"?window:{});var ru=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Yg,pa,Jg,cu,Qh,Zg,ey,ty;(function(){var i,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(l,f,y){return l==Array.prototype||l==Object.prototype||(l[f]=y.value),l};function t(l){l=[typeof globalThis=="object"&&globalThis,l,typeof window=="object"&&window,typeof self=="object"&&self,typeof ru=="object"&&ru];for(var f=0;f<l.length;++f){var y=l[f];if(y&&y.Math==Math)return y}throw Error("Cannot find global object")}var s=t(this);function o(l,f){if(f)e:{var y=s;l=l.split(".");for(var E=0;E<l.length-1;E++){var O=l[E];if(!(O in y))break e;y=y[O]}l=l[l.length-1],E=y[l],f=f(E),f!=E&&f!=null&&e(y,l,{configurable:!0,writable:!0,value:f})}}function u(l,f){l instanceof String&&(l+="");var y=0,E=!1,O={next:function(){if(!E&&y<l.length){var U=y++;return{value:f(U,l[U]),done:!1}}return E=!0,{done:!0,value:void 0}}};return O[Symbol.iterator]=function(){return O},O}o("Array.prototype.values",function(l){return l||function(){return u(this,function(f,y){return y})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var h=h||{},m=this||self;function g(l){var f=typeof l;return f=f!="object"?f:l?Array.isArray(l)?"array":f:"null",f=="array"||f=="object"&&typeof l.length=="number"}function v(l){var f=typeof l;return f=="object"&&l!=null||f=="function"}function w(l,f,y){return l.call.apply(l.bind,arguments)}function P(l,f,y){if(!l)throw Error();if(2<arguments.length){var E=Array.prototype.slice.call(arguments,2);return function(){var O=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(O,E),l.apply(f,O)}}return function(){return l.apply(f,arguments)}}function M(l,f,y){return M=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?w:P,M.apply(null,arguments)}function z(l,f){var y=Array.prototype.slice.call(arguments,1);return function(){var E=y.slice();return E.push.apply(E,arguments),l.apply(this,E)}}function B(l,f){function y(){}y.prototype=f.prototype,l.aa=f.prototype,l.prototype=new y,l.prototype.constructor=l,l.Qb=function(E,O,U){for(var J=Array(arguments.length-2),je=2;je<arguments.length;je++)J[je-2]=arguments[je];return f.prototype[O].apply(E,J)}}function G(l){const f=l.length;if(0<f){const y=Array(f);for(let E=0;E<f;E++)y[E]=l[E];return y}return[]}function $(l,f){for(let y=1;y<arguments.length;y++){const E=arguments[y];if(g(E)){const O=l.length||0,U=E.length||0;l.length=O+U;for(let J=0;J<U;J++)l[O+J]=E[J]}else l.push(E)}}class pe{constructor(f,y){this.i=f,this.j=y,this.h=0,this.g=null}get(){let f;return 0<this.h?(this.h--,f=this.g,this.g=f.next,f.next=null):f=this.i(),f}}function ce(l){return/^[\s\xa0]*$/.test(l)}function te(){var l=m.navigator;return l&&(l=l.userAgent)?l:""}function fe(l){return fe[" "](l),l}fe[" "]=function(){};var Ne=te().indexOf("Gecko")!=-1&&!(te().toLowerCase().indexOf("webkit")!=-1&&te().indexOf("Edge")==-1)&&!(te().indexOf("Trident")!=-1||te().indexOf("MSIE")!=-1)&&te().indexOf("Edge")==-1;function he(l,f,y){for(const E in l)f.call(y,l[E],E,l)}function k(l,f){for(const y in l)f.call(void 0,l[y],y,l)}function T(l){const f={};for(const y in l)f[y]=l[y];return f}const A="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function R(l,f){let y,E;for(let O=1;O<arguments.length;O++){E=arguments[O];for(y in E)l[y]=E[y];for(let U=0;U<A.length;U++)y=A[U],Object.prototype.hasOwnProperty.call(E,y)&&(l[y]=E[y])}}function x(l){var f=1;l=l.split(":");const y=[];for(;0<f&&l.length;)y.push(l.shift()),f--;return l.length&&y.push(l.join(":")),y}function D(l){m.setTimeout(()=>{throw l},0)}function S(){var l=ue;let f=null;return l.g&&(f=l.g,l.g=l.g.next,l.g||(l.h=null),f.next=null),f}class Xe{constructor(){this.h=this.g=null}add(f,y){const E=yt.get();E.set(f,y),this.h?this.h.next=E:this.g=E,this.h=E}}var yt=new pe(()=>new it,l=>l.reset());class it{constructor(){this.next=this.g=this.h=null}set(f,y){this.h=f,this.g=y,this.next=null}reset(){this.next=this.g=this.h=null}}let Le,Z=!1,ue=new Xe,ne=()=>{const l=m.Promise.resolve(void 0);Le=()=>{l.then(V)}};var V=()=>{for(var l;l=S();){try{l.h.call(l.g)}catch(y){D(y)}var f=yt;f.j(l),100>f.h&&(f.h++,l.next=f.g,f.g=l)}Z=!1};function H(){this.s=this.s,this.C=this.C}H.prototype.s=!1,H.prototype.ma=function(){this.s||(this.s=!0,this.N())},H.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function de(l,f){this.type=l,this.g=this.target=f,this.defaultPrevented=!1}de.prototype.h=function(){this.defaultPrevented=!0};var Ie=function(){if(!m.addEventListener||!Object.defineProperty)return!1;var l=!1,f=Object.defineProperty({},"passive",{get:function(){l=!0}});try{const y=()=>{};m.addEventListener("test",y,f),m.removeEventListener("test",y,f)}catch{}return l}();function Se(l,f){if(de.call(this,l?l.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,l){var y=this.type=l.type,E=l.changedTouches&&l.changedTouches.length?l.changedTouches[0]:null;if(this.target=l.target||l.srcElement,this.g=f,f=l.relatedTarget){if(Ne){e:{try{fe(f.nodeName);var O=!0;break e}catch{}O=!1}O||(f=null)}}else y=="mouseover"?f=l.fromElement:y=="mouseout"&&(f=l.toElement);this.relatedTarget=f,E?(this.clientX=E.clientX!==void 0?E.clientX:E.pageX,this.clientY=E.clientY!==void 0?E.clientY:E.pageY,this.screenX=E.screenX||0,this.screenY=E.screenY||0):(this.clientX=l.clientX!==void 0?l.clientX:l.pageX,this.clientY=l.clientY!==void 0?l.clientY:l.pageY,this.screenX=l.screenX||0,this.screenY=l.screenY||0),this.button=l.button,this.key=l.key||"",this.ctrlKey=l.ctrlKey,this.altKey=l.altKey,this.shiftKey=l.shiftKey,this.metaKey=l.metaKey,this.pointerId=l.pointerId||0,this.pointerType=typeof l.pointerType=="string"?l.pointerType:xe[l.pointerType]||"",this.state=l.state,this.i=l,l.defaultPrevented&&Se.aa.h.call(this)}}B(Se,de);var xe={2:"touch",3:"pen",4:"mouse"};Se.prototype.h=function(){Se.aa.h.call(this);var l=this.i;l.preventDefault?l.preventDefault():l.returnValue=!1};var be="closure_listenable_"+(1e6*Math.random()|0),Fe=0;function Be(l,f,y,E,O){this.listener=l,this.proxy=null,this.src=f,this.type=y,this.capture=!!E,this.ha=O,this.key=++Fe,this.da=this.fa=!1}function _t(l){l.da=!0,l.listener=null,l.proxy=null,l.src=null,l.ha=null}function er(l){this.src=l,this.g={},this.h=0}er.prototype.add=function(l,f,y,E,O){var U=l.toString();l=this.g[U],l||(l=this.g[U]=[],this.h++);var J=Cr(l,f,E,O);return-1<J?(f=l[J],y||(f.fa=!1)):(f=new Be(f,this.src,U,!!E,O),f.fa=y,l.push(f)),f};function es(l,f){var y=f.type;if(y in l.g){var E=l.g[y],O=Array.prototype.indexOf.call(E,f,void 0),U;(U=0<=O)&&Array.prototype.splice.call(E,O,1),U&&(_t(f),l.g[y].length==0&&(delete l.g[y],l.h--))}}function Cr(l,f,y,E){for(var O=0;O<l.length;++O){var U=l[O];if(!U.da&&U.listener==f&&U.capture==!!y&&U.ha==E)return O}return-1}var gi="closure_lm_"+(1e6*Math.random()|0),ts={};function vo(l,f,y,E,O){if(Array.isArray(f)){for(var U=0;U<f.length;U++)vo(l,f[U],y,E,O);return null}return y=To(y),l&&l[be]?l.K(f,y,v(E)?!!E.capture:!!E,O):Eo(l,f,y,!1,E,O)}function Eo(l,f,y,E,O,U){if(!f)throw Error("Invalid event type");var J=v(O)?!!O.capture:!!O,je=rs(l);if(je||(l[gi]=je=new er(l)),y=je.add(f,y,E,J,U),y.proxy)return y;if(E=za(),y.proxy=E,E.src=l,E.listener=y,l.addEventListener)Ie||(O=J),O===void 0&&(O=!1),l.addEventListener(f.toString(),E,O);else if(l.attachEvent)l.attachEvent(nr(f.toString()),E);else if(l.addListener&&l.removeListener)l.addListener(E);else throw Error("addEventListener and attachEvent are unavailable.");return y}function za(){function l(y){return f.call(l.src,l.listener,y)}const f=wo;return l}function ns(l,f,y,E,O){if(Array.isArray(f))for(var U=0;U<f.length;U++)ns(l,f[U],y,E,O);else E=v(E)?!!E.capture:!!E,y=To(y),l&&l[be]?(l=l.i,f=String(f).toString(),f in l.g&&(U=l.g[f],y=Cr(U,y,E,O),-1<y&&(_t(U[y]),Array.prototype.splice.call(U,y,1),U.length==0&&(delete l.g[f],l.h--)))):l&&(l=rs(l))&&(f=l.g[f.toString()],l=-1,f&&(l=Cr(f,y,E,O)),(y=-1<l?f[l]:null)&&tr(y))}function tr(l){if(typeof l!="number"&&l&&!l.da){var f=l.src;if(f&&f[be])es(f.i,l);else{var y=l.type,E=l.proxy;f.removeEventListener?f.removeEventListener(y,E,l.capture):f.detachEvent?f.detachEvent(nr(y),E):f.addListener&&f.removeListener&&f.removeListener(E),(y=rs(f))?(es(y,l),y.h==0&&(y.src=null,f[gi]=null)):_t(l)}}}function nr(l){return l in ts?ts[l]:ts[l]="on"+l}function wo(l,f){if(l.da)l=!0;else{f=new Se(f,this);var y=l.listener,E=l.ha||l.src;l.fa&&tr(l),l=y.call(E,f)}return l}function rs(l){return l=l[gi],l instanceof er?l:null}var is="__closure_events_fn_"+(1e9*Math.random()>>>0);function To(l){return typeof l=="function"?l:(l[is]||(l[is]=function(f){return l.handleEvent(f)}),l[is])}function ct(){H.call(this),this.i=new er(this),this.M=this,this.F=null}B(ct,H),ct.prototype[be]=!0,ct.prototype.removeEventListener=function(l,f,y,E){ns(this,l,f,y,E)};function ht(l,f){var y,E=l.F;if(E)for(y=[];E;E=E.F)y.push(E);if(l=l.M,E=f.type||f,typeof f=="string")f=new de(f,l);else if(f instanceof de)f.target=f.target||l;else{var O=f;f=new de(E,l),R(f,O)}if(O=!0,y)for(var U=y.length-1;0<=U;U--){var J=f.g=y[U];O=rr(J,E,!0,f)&&O}if(J=f.g=l,O=rr(J,E,!0,f)&&O,O=rr(J,E,!1,f)&&O,y)for(U=0;U<y.length;U++)J=f.g=y[U],O=rr(J,E,!1,f)&&O}ct.prototype.N=function(){if(ct.aa.N.call(this),this.i){var l=this.i,f;for(f in l.g){for(var y=l.g[f],E=0;E<y.length;E++)_t(y[E]);delete l.g[f],l.h--}}this.F=null},ct.prototype.K=function(l,f,y,E){return this.i.add(String(l),f,!1,y,E)},ct.prototype.L=function(l,f,y,E){return this.i.add(String(l),f,!0,y,E)};function rr(l,f,y,E){if(f=l.i.g[String(f)],!f)return!0;f=f.concat();for(var O=!0,U=0;U<f.length;++U){var J=f[U];if(J&&!J.da&&J.capture==y){var je=J.listener,dt=J.ha||J.src;J.fa&&es(l.i,J),O=je.call(dt,E)!==!1&&O}}return O&&!E.defaultPrevented}function Io(l,f,y){if(typeof l=="function")y&&(l=M(l,y));else if(l&&typeof l.handleEvent=="function")l=M(l.handleEvent,l);else throw Error("Invalid listener argument");return 2147483647<Number(f)?-1:m.setTimeout(l,f||0)}function kr(l){l.g=Io(()=>{l.g=null,l.i&&(l.i=!1,kr(l))},l.l);const f=l.h;l.h=null,l.m.apply(null,f)}class yi extends H{constructor(f,y){super(),this.m=f,this.l=y,this.h=null,this.i=!1,this.g=null}j(f){this.h=arguments,this.g?this.i=!0:kr(this)}N(){super.N(),this.g&&(m.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function _i(l){H.call(this),this.h=l,this.g={}}B(_i,H);var So=[];function Ao(l){he(l.g,function(f,y){this.g.hasOwnProperty(y)&&tr(f)},l),l.g={}}_i.prototype.N=function(){_i.aa.N.call(this),Ao(this)},_i.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ro=m.JSON.stringify,Co=m.JSON.parse,ko=class{stringify(l){return m.JSON.stringify(l,void 0)}parse(l){return m.JSON.parse(l,void 0)}};function vi(){}vi.prototype.h=null;function ss(l){return l.h||(l.h=l.i())}function os(){}var on={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Mn(){de.call(this,"d")}B(Mn,de);function as(){de.call(this,"c")}B(as,de);var bn={},Po=null;function Ei(){return Po=Po||new ct}bn.La="serverreachability";function No(l){de.call(this,bn.La,l)}B(No,de);function ir(l){const f=Ei();ht(f,new No(f))}bn.STAT_EVENT="statevent";function xo(l,f){de.call(this,bn.STAT_EVENT,l),this.stat=f}B(xo,de);function tt(l){const f=Ei();ht(f,new xo(f,l))}bn.Ma="timingevent";function ls(l,f){de.call(this,bn.Ma,l),this.size=f}B(ls,de);function vn(l,f){if(typeof l!="function")throw Error("Fn must not be null and must be a function");return m.setTimeout(function(){l()},f)}function wi(){this.g=!0}wi.prototype.xa=function(){this.g=!1};function Ti(l,f,y,E,O,U){l.info(function(){if(l.g)if(U)for(var J="",je=U.split("&"),dt=0;dt<je.length;dt++){var De=je[dt].split("=");if(1<De.length){var vt=De[0];De=De[1];var st=vt.split("_");J=2<=st.length&&st[1]=="type"?J+(vt+"="+De+"&"):J+(vt+"=redacted&")}}else J=null;else J=U;return"XMLHTTP REQ ("+E+") [attempt "+O+"]: "+f+`
`+y+`
`+J})}function us(l,f,y,E,O,U,J){l.info(function(){return"XMLHTTP RESP ("+E+") [ attempt "+O+"]: "+f+`
`+y+`
`+U+" "+J})}function En(l,f,y,E){l.info(function(){return"XMLHTTP TEXT ("+f+"): "+nc(l,y)+(E?" "+E:"")})}function Do(l,f){l.info(function(){return"TIMEOUT: "+f})}wi.prototype.info=function(){};function nc(l,f){if(!l.g)return f;if(!f)return null;try{var y=JSON.parse(f);if(y){for(l=0;l<y.length;l++)if(Array.isArray(y[l])){var E=y[l];if(!(2>E.length)){var O=E[1];if(Array.isArray(O)&&!(1>O.length)){var U=O[0];if(U!="noop"&&U!="stop"&&U!="close")for(var J=1;J<O.length;J++)O[J]=""}}}}return Ro(y)}catch{return f}}var cs={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Ba={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},wn;function Ii(){}B(Ii,vi),Ii.prototype.g=function(){return new XMLHttpRequest},Ii.prototype.i=function(){return{}},wn=new Ii;function Tn(l,f,y,E){this.j=l,this.i=f,this.l=y,this.R=E||1,this.U=new _i(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new $a}function $a(){this.i=null,this.g="",this.h=!1}var Vo={},hs={};function ds(l,f,y){l.L=1,l.v=Vr(Zt(f)),l.m=y,l.P=!0,Oo(l,null)}function Oo(l,f){l.F=Date.now(),$e(l),l.A=Zt(l.v);var y=l.A,E=l.R;Array.isArray(E)||(E=[String(E)]),Lr(y.i,"t",E),l.C=0,y=l.j.J,l.h=new $a,l.g=al(l.j,y?f:null,!l.m),0<l.O&&(l.M=new yi(M(l.Y,l,l.g),l.O)),f=l.U,y=l.g,E=l.ca;var O="readystatechange";Array.isArray(O)||(O&&(So[0]=O.toString()),O=So);for(var U=0;U<O.length;U++){var J=vo(y,O[U],E||f.handleEvent,!1,f.h||f);if(!J)break;f.g[J.key]=J}f=l.H?T(l.H):{},l.m?(l.u||(l.u="POST"),f["Content-Type"]="application/x-www-form-urlencoded",l.g.ea(l.A,l.u,l.m,f)):(l.u="GET",l.g.ea(l.A,l.u,null,f)),ir(),Ti(l.i,l.u,l.A,l.l,l.R,l.m)}Tn.prototype.ca=function(l){l=l.target;const f=this.M;f&&qt(l)==3?f.j():this.Y(l)},Tn.prototype.Y=function(l){try{if(l==this.g)e:{const st=qt(this.g);var f=this.g.Ba();const un=this.g.Z();if(!(3>st)&&(st!=3||this.g&&(this.h.h||this.g.oa()||jo(this.g)))){this.J||st!=4||f==7||(f==8||0>=un?ir(3):ir(2)),Si(this);var y=this.g.Z();this.X=y;t:if(qa(this)){var E=jo(this.g);l="";var O=E.length,U=qt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){an(this),Pr(this);var J="";break t}this.h.i=new m.TextDecoder}for(f=0;f<O;f++)this.h.h=!0,l+=this.h.i.decode(E[f],{stream:!(U&&f==O-1)});E.length=0,this.h.g+=l,this.C=0,J=this.h.g}else J=this.g.oa();if(this.o=y==200,us(this.i,this.u,this.A,this.l,this.R,st,y),this.o){if(this.T&&!this.K){t:{if(this.g){var je,dt=this.g;if((je=dt.g?dt.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!ce(je)){var De=je;break t}}De=null}if(y=De)En(this.i,this.l,y,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Lo(this,y);else{this.o=!1,this.s=3,tt(12),an(this),Pr(this);break e}}if(this.P){y=!0;let tn;for(;!this.J&&this.C<J.length;)if(tn=rc(this,J),tn==hs){st==4&&(this.s=4,tt(14),y=!1),En(this.i,this.l,null,"[Incomplete Response]");break}else if(tn==Vo){this.s=4,tt(15),En(this.i,this.l,J,"[Invalid Chunk]"),y=!1;break}else En(this.i,this.l,tn,null),Lo(this,tn);if(qa(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),st!=4||J.length!=0||this.h.h||(this.s=1,tt(16),y=!1),this.o=this.o&&y,!y)En(this.i,this.l,J,"[Invalid Chunked Response]"),an(this),Pr(this);else if(0<J.length&&!this.W){this.W=!0;var vt=this.j;vt.g==this&&vt.ba&&!vt.M&&(vt.j.info("Great, no buffering proxy detected. Bytes received: "+J.length),Bo(vt),vt.M=!0,tt(11))}}else En(this.i,this.l,J,null),Lo(this,J);st==4&&an(this),this.o&&!this.J&&(st==4?Is(this.j,this):(this.o=!1,$e(this)))}else _s(this.g),y==400&&0<J.indexOf("Unknown SID")?(this.s=3,tt(12)):(this.s=0,tt(13)),an(this),Pr(this)}}}catch{}finally{}};function qa(l){return l.g?l.u=="GET"&&l.L!=2&&l.j.Ca:!1}function rc(l,f){var y=l.C,E=f.indexOf(`
`,y);return E==-1?hs:(y=Number(f.substring(y,E)),isNaN(y)?Vo:(E+=1,E+y>f.length?hs:(f=f.slice(E,E+y),l.C=E+y,f)))}Tn.prototype.cancel=function(){this.J=!0,an(this)};function $e(l){l.S=Date.now()+l.I,Ha(l,l.I)}function Ha(l,f){if(l.B!=null)throw Error("WatchDog timer not null");l.B=vn(M(l.ba,l),f)}function Si(l){l.B&&(m.clearTimeout(l.B),l.B=null)}Tn.prototype.ba=function(){this.B=null;const l=Date.now();0<=l-this.S?(Do(this.i,this.A),this.L!=2&&(ir(),tt(17)),an(this),this.s=2,Pr(this)):Ha(this,this.S-l)};function Pr(l){l.j.G==0||l.J||Is(l.j,l)}function an(l){Si(l);var f=l.M;f&&typeof f.ma=="function"&&f.ma(),l.M=null,Ao(l.U),l.g&&(f=l.g,l.g=null,f.abort(),f.ma())}function Lo(l,f){try{var y=l.j;if(y.G!=0&&(y.g==l||Ut(y.h,l))){if(!l.K&&Ut(y.h,l)&&y.G==3){try{var E=y.Da.g.parse(f)}catch{E=null}if(Array.isArray(E)&&E.length==3){var O=E;if(O[0]==0){e:if(!y.u){if(y.g)if(y.g.F+3e3<l.F)Ts(y),Cn(y);else break e;ws(y),tt(18)}}else y.za=O[1],0<y.za-y.T&&37500>O[2]&&y.F&&y.v==0&&!y.C&&(y.C=vn(M(y.Za,y),6e3));if(1>=Ga(y.h)&&y.ca){try{y.ca()}catch{}y.ca=void 0}}else ur(y,11)}else if((l.K||y.g==l)&&Ts(y),!ce(f))for(O=y.Da.g.parse(f),f=0;f<O.length;f++){let De=O[f];if(y.T=De[0],De=De[1],y.G==2)if(De[0]=="c"){y.K=De[1],y.ia=De[2];const vt=De[3];vt!=null&&(y.la=vt,y.j.info("VER="+y.la));const st=De[4];st!=null&&(y.Aa=st,y.j.info("SVER="+y.Aa));const un=De[5];un!=null&&typeof un=="number"&&0<un&&(E=1.5*un,y.L=E,y.j.info("backChannelRequestTimeoutMs_="+E)),E=y;const tn=l.g;if(tn){const xi=tn.g?tn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(xi){var U=E.h;U.g||xi.indexOf("spdy")==-1&&xi.indexOf("quic")==-1&&xi.indexOf("h2")==-1||(U.j=U.l,U.g=new Set,U.h&&(Mo(U,U.h),U.h=null))}if(E.D){const As=tn.g?tn.g.getResponseHeader("X-HTTP-Session-Id"):null;As&&(E.ya=As,ze(E.I,E.D,As))}}y.G=3,y.l&&y.l.ua(),y.ba&&(y.R=Date.now()-l.F,y.j.info("Handshake RTT: "+y.R+"ms")),E=y;var J=l;if(E.qa=ol(E,E.J?E.ia:null,E.W),J.K){Ka(E.h,J);var je=J,dt=E.L;dt&&(je.I=dt),je.B&&(Si(je),$e(je)),E.g=J}else Ni(E);0<y.i.length&&zn(y)}else De[0]!="stop"&&De[0]!="close"||ur(y,7);else y.G==3&&(De[0]=="stop"||De[0]=="close"?De[0]=="stop"?ur(y,7):At(y):De[0]!="noop"&&y.l&&y.l.ta(De),y.v=0)}}ir(4)}catch{}}var Wa=class{constructor(l,f){this.g=l,this.map=f}};function Ai(l){this.l=l||10,m.PerformanceNavigationTiming?(l=m.performance.getEntriesByType("navigation"),l=0<l.length&&(l[0].nextHopProtocol=="hq"||l[0].nextHopProtocol=="h2")):l=!!(m.chrome&&m.chrome.loadTimes&&m.chrome.loadTimes()&&m.chrome.loadTimes().wasFetchedViaSpdy),this.j=l?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Jt(l){return l.h?!0:l.g?l.g.size>=l.j:!1}function Ga(l){return l.h?1:l.g?l.g.size:0}function Ut(l,f){return l.h?l.h==f:l.g?l.g.has(f):!1}function Mo(l,f){l.g?l.g.add(f):l.h=f}function Ka(l,f){l.h&&l.h==f?l.h=null:l.g&&l.g.has(f)&&l.g.delete(f)}Ai.prototype.cancel=function(){if(this.i=Qa(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const l of this.g.values())l.cancel();this.g.clear()}};function Qa(l){if(l.h!=null)return l.i.concat(l.h.D);if(l.g!=null&&l.g.size!==0){let f=l.i;for(const y of l.g.values())f=f.concat(y.D);return f}return G(l.i)}function fs(l){if(l.V&&typeof l.V=="function")return l.V();if(typeof Map<"u"&&l instanceof Map||typeof Set<"u"&&l instanceof Set)return Array.from(l.values());if(typeof l=="string")return l.split("");if(g(l)){for(var f=[],y=l.length,E=0;E<y;E++)f.push(l[E]);return f}f=[],y=0;for(E in l)f[y++]=l[E];return f}function ps(l){if(l.na&&typeof l.na=="function")return l.na();if(!l.V||typeof l.V!="function"){if(typeof Map<"u"&&l instanceof Map)return Array.from(l.keys());if(!(typeof Set<"u"&&l instanceof Set)){if(g(l)||typeof l=="string"){var f=[];l=l.length;for(var y=0;y<l;y++)f.push(y);return f}f=[],y=0;for(const E in l)f[y++]=E;return f}}}function Nr(l,f){if(l.forEach&&typeof l.forEach=="function")l.forEach(f,void 0);else if(g(l)||typeof l=="string")Array.prototype.forEach.call(l,f,void 0);else for(var y=ps(l),E=fs(l),O=E.length,U=0;U<O;U++)f.call(void 0,E[U],y&&y[U],l)}var Ri=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function ic(l,f){if(l){l=l.split("&");for(var y=0;y<l.length;y++){var E=l[y].indexOf("="),O=null;if(0<=E){var U=l[y].substring(0,E);O=l[y].substring(E+1)}else U=l[y];f(U,O?decodeURIComponent(O.replace(/\+/g," ")):"")}}}function sr(l){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,l instanceof sr){this.h=l.h,Ci(this,l.j),this.o=l.o,this.g=l.g,xr(this,l.s),this.l=l.l;var f=l.i,y=new Fn;y.i=f.i,f.g&&(y.g=new Map(f.g),y.h=f.h),Dr(this,y),this.m=l.m}else l&&(f=String(l).match(Ri))?(this.h=!1,Ci(this,f[1]||"",!0),this.o=ke(f[2]||""),this.g=ke(f[3]||"",!0),xr(this,f[4]),this.l=ke(f[5]||"",!0),Dr(this,f[6]||"",!0),this.m=ke(f[7]||"")):(this.h=!1,this.i=new Fn(null,this.h))}sr.prototype.toString=function(){var l=[],f=this.j;f&&l.push(Or(f,ms,!0),":");var y=this.g;return(y||f=="file")&&(l.push("//"),(f=this.o)&&l.push(Or(f,ms,!0),"@"),l.push(encodeURIComponent(String(y)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),y=this.s,y!=null&&l.push(":",String(y))),(y=this.l)&&(this.g&&y.charAt(0)!="/"&&l.push("/"),l.push(Or(y,y.charAt(0)=="/"?Ja:Ya,!0))),(y=this.i.toString())&&l.push("?",y),(y=this.m)&&l.push("#",Or(y,bo)),l.join("")};function Zt(l){return new sr(l)}function Ci(l,f,y){l.j=y?ke(f,!0):f,l.j&&(l.j=l.j.replace(/:$/,""))}function xr(l,f){if(f){if(f=Number(f),isNaN(f)||0>f)throw Error("Bad port number "+f);l.s=f}else l.s=null}function Dr(l,f,y){f instanceof Fn?(l.i=f,Un(l.i,l.h)):(y||(f=Or(f,Za)),l.i=new Fn(f,l.h))}function ze(l,f,y){l.i.set(f,y)}function Vr(l){return ze(l,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),l}function ke(l,f){return l?f?decodeURI(l.replace(/%25/g,"%2525")):decodeURIComponent(l):""}function Or(l,f,y){return typeof l=="string"?(l=encodeURI(l).replace(f,Xa),y&&(l=l.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l):null}function Xa(l){return l=l.charCodeAt(0),"%"+(l>>4&15).toString(16)+(l&15).toString(16)}var ms=/[#\/\?@]/g,Ya=/[#\?:]/g,Ja=/[#\?]/g,Za=/[#\?@]/g,bo=/#/g;function Fn(l,f){this.h=this.g=null,this.i=l||null,this.j=!!f}function St(l){l.g||(l.g=new Map,l.h=0,l.i&&ic(l.i,function(f,y){l.add(decodeURIComponent(f.replace(/\+/g," ")),y)}))}i=Fn.prototype,i.add=function(l,f){St(this),this.i=null,l=ln(this,l);var y=this.g.get(l);return y||this.g.set(l,y=[]),y.push(f),this.h+=1,this};function In(l,f){St(l),f=ln(l,f),l.g.has(f)&&(l.i=null,l.h-=l.g.get(f).length,l.g.delete(f))}function Sn(l,f){return St(l),f=ln(l,f),l.g.has(f)}i.forEach=function(l,f){St(this),this.g.forEach(function(y,E){y.forEach(function(O){l.call(f,O,E,this)},this)},this)},i.na=function(){St(this);const l=Array.from(this.g.values()),f=Array.from(this.g.keys()),y=[];for(let E=0;E<f.length;E++){const O=l[E];for(let U=0;U<O.length;U++)y.push(f[E])}return y},i.V=function(l){St(this);let f=[];if(typeof l=="string")Sn(this,l)&&(f=f.concat(this.g.get(ln(this,l))));else{l=Array.from(this.g.values());for(let y=0;y<l.length;y++)f=f.concat(l[y])}return f},i.set=function(l,f){return St(this),this.i=null,l=ln(this,l),Sn(this,l)&&(this.h-=this.g.get(l).length),this.g.set(l,[f]),this.h+=1,this},i.get=function(l,f){return l?(l=this.V(l),0<l.length?String(l[0]):f):f};function Lr(l,f,y){In(l,f),0<y.length&&(l.i=null,l.g.set(ln(l,f),G(y)),l.h+=y.length)}i.toString=function(){if(this.i)return this.i;if(!this.g)return"";const l=[],f=Array.from(this.g.keys());for(var y=0;y<f.length;y++){var E=f[y];const U=encodeURIComponent(String(E)),J=this.V(E);for(E=0;E<J.length;E++){var O=U;J[E]!==""&&(O+="="+encodeURIComponent(String(J[E]))),l.push(O)}}return this.i=l.join("&")};function ln(l,f){return f=String(f),l.j&&(f=f.toLowerCase()),f}function Un(l,f){f&&!l.j&&(St(l),l.i=null,l.g.forEach(function(y,E){var O=E.toLowerCase();E!=O&&(In(this,E),Lr(this,O,y))},l)),l.j=f}function sc(l,f){const y=new wi;if(m.Image){const E=new Image;E.onload=z($t,y,"TestLoadImage: loaded",!0,f,E),E.onerror=z($t,y,"TestLoadImage: error",!1,f,E),E.onabort=z($t,y,"TestLoadImage: abort",!1,f,E),E.ontimeout=z($t,y,"TestLoadImage: timeout",!1,f,E),m.setTimeout(function(){E.ontimeout&&E.ontimeout()},1e4),E.src=l}else f(!1)}function el(l,f){const y=new wi,E=new AbortController,O=setTimeout(()=>{E.abort(),$t(y,"TestPingServer: timeout",!1,f)},1e4);fetch(l,{signal:E.signal}).then(U=>{clearTimeout(O),U.ok?$t(y,"TestPingServer: ok",!0,f):$t(y,"TestPingServer: server error",!1,f)}).catch(()=>{clearTimeout(O),$t(y,"TestPingServer: error",!1,f)})}function $t(l,f,y,E,O){try{O&&(O.onload=null,O.onerror=null,O.onabort=null,O.ontimeout=null),E(y)}catch{}}function oc(){this.g=new ko}function tl(l,f,y){const E=y||"";try{Nr(l,function(O,U){let J=O;v(O)&&(J=Ro(O)),f.push(E+U+"="+encodeURIComponent(J))})}catch(O){throw f.push(E+"type="+encodeURIComponent("_badmap")),O}}function or(l){this.l=l.Ub||null,this.j=l.eb||!1}B(or,vi),or.prototype.g=function(){return new ki(this.l,this.j)},or.prototype.i=function(l){return function(){return l}}({});function ki(l,f){ct.call(this),this.D=l,this.o=f,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}B(ki,ct),i=ki.prototype,i.open=function(l,f){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=l,this.A=f,this.readyState=1,Rn(this)},i.send=function(l){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const f={headers:this.u,method:this.B,credentials:this.m,cache:void 0};l&&(f.body=l),(this.D||m).fetch(new Request(this.A,f)).then(this.Sa.bind(this),this.ga.bind(this))},i.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,An(this)),this.readyState=0},i.Sa=function(l){if(this.g&&(this.l=l,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=l.headers,this.readyState=2,Rn(this)),this.g&&(this.readyState=3,Rn(this),this.g)))if(this.responseType==="arraybuffer")l.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof m.ReadableStream<"u"&&"body"in l){if(this.j=l.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;nl(this)}else l.text().then(this.Ra.bind(this),this.ga.bind(this))};function nl(l){l.j.read().then(l.Pa.bind(l)).catch(l.ga.bind(l))}i.Pa=function(l){if(this.g){if(this.o&&l.value)this.response.push(l.value);else if(!this.o){var f=l.value?l.value:new Uint8Array(0);(f=this.v.decode(f,{stream:!l.done}))&&(this.response=this.responseText+=f)}l.done?An(this):Rn(this),this.readyState==3&&nl(this)}},i.Ra=function(l){this.g&&(this.response=this.responseText=l,An(this))},i.Qa=function(l){this.g&&(this.response=l,An(this))},i.ga=function(){this.g&&An(this)};function An(l){l.readyState=4,l.l=null,l.j=null,l.v=null,Rn(l)}i.setRequestHeader=function(l,f){this.u.append(l,f)},i.getResponseHeader=function(l){return this.h&&this.h.get(l.toLowerCase())||""},i.getAllResponseHeaders=function(){if(!this.h)return"";const l=[],f=this.h.entries();for(var y=f.next();!y.done;)y=y.value,l.push(y[0]+": "+y[1]),y=f.next();return l.join(`\r
...
`}),f}function Mr(l,f,y){e:{for(E in y){var E=!1;break e}E=!0}E||(y=ar(y),typeof l=="string"?y!=null&&encodeURIComponent(String(y)):ze(l,f,y))}function Ke(l){ct.call(this),this.headers=new Map,this.o=l||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}B(Ke,ct);var ac=/^https?$/i,Fo=["POST","PUT"];i=Ke.prototype,i.Ha=function(l){this.J=l},i.ea=function(l,f,y,E){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+l);f=f?f.toUpperCase():"GET",this.D=l,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():wn.g(),this.v=this.o?ss(this.o):ss(wn),this.g.onreadystatechange=M(this.Ea,this);try{this.B=!0,this.g.open(f,String(l),!0),this.B=!1}catch(U){Pi(this,U);return}if(l=y||"",y=new Map(this.headers),E)if(Object.getPrototypeOf(E)===Object.prototype)for(var O in E)y.set(O,E[O]);else if(typeof E.keys=="function"&&typeof E.get=="function")for(const U of E.keys())y.set(U,E.get(U));else throw Error("Unknown input type for opt_headers: "+String(E));E=Array.from(y.keys()).find(U=>U.toLowerCase()=="content-type"),O=m.FormData&&l instanceof m.FormData,!(0<=Array.prototype.indexOf.call(Fo,f,void 0))||E||O||y.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[U,J]of y)this.g.setRequestHeader(U,J);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{ys(this),this.u=!0,this.g.send(l),this.u=!1}catch(U){Pi(this,U)}};function Pi(l,f){l.h=!1,l.g&&(l.j=!0,l.g.abort(),l.j=!1),l.l=f,l.m=5,gs(l),en(l)}function gs(l){l.A||(l.A=!0,ht(l,"complete"),ht(l,"error"))}i.abort=function(l){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=l||7,ht(this,"complete"),ht(this,"abort"),en(this))},i.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),en(this,!0)),Ke.aa.N.call(this)},i.Ea=function(){this.s||(this.B||this.u||this.j?Uo(this):this.bb())},i.bb=function(){Uo(this)};function Uo(l){if(l.h&&typeof h<"u"&&(!l.v[1]||qt(l)!=4||l.Z()!=2)){if(l.u&&qt(l)==4)Io(l.Ea,0,l);else if(ht(l,"readystatechange"),qt(l)==4){l.h=!1;try{const J=l.Z();e:switch(J){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var f=!0;break e;default:f=!1}var y;if(!(y=f)){var E;if(E=J===0){var O=String(l.D).match(Ri)[1]||null;!O&&m.self&&m.self.location&&(O=m.self.location.protocol.slice(0,-1)),E=!ac.test(O?O.toLowerCase():"")}y=E}if(y)ht(l,"complete"),ht(l,"success");else{l.m=6;try{var U=2<qt(l)?l.g.statusText:""}catch{U=""}l.l=U+" ["+l.Z()+"]",gs(l)}}finally{en(l)}}}}function en(l,f){if(l.g){ys(l);const y=l.g,E=l.v[0]?()=>{}:null;l.g=null,l.v=null,f||ht(l,"ready");try{y.onreadystatechange=E}catch{}}}function ys(l){l.I&&(m.clearTimeout(l.I),l.I=null)}i.isActive=function(){return!!this.g};function qt(l){return l.g?l.g.readyState:0}i.Z=function(){try{return 2<qt(this)?this.g.status:-1}catch{return-1}},i.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},i.Oa=function(l){if(this.g){var f=this.g.responseText;return l&&f.indexOf(l)==0&&(f=f.substring(l.length)),Co(f)}};function jo(l){try{if(!l.g)return null;if("response"in l.g)return l.g.response;switch(l.H){case"":case"text":return l.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in l.g)return l.g.mozResponseArrayBuffer}return null}catch{return null}}function _s(l){const f={};l=(l.g&&2<=qt(l)&&l.g.getAllResponseHeaders()||"").split(`\r
`);for(let E=0;E<l.length;E++){if(ce(l[E]))continue;var y=x(l[E]);const O=y[0];if(y=y[1],typeof y!="string")continue;y=y.trim();const U=f[O]||[];f[O]=U,U.push(y)}k(f,function(E){return E.join(", ")})}i.Ba=function(){return this.m},i.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function jn(l,f,y){return y&&y.internalChannelParams&&y.internalChannelParams[l]||f}function zo(l){this.Aa=0,this.i=[],this.j=new wi,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=jn("failFast",!1,l),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=jn("baseRetryDelayMs",5e3,l),this.cb=jn("retryDelaySeedMs",1e4,l),this.Wa=jn("forwardChannelMaxRetries",2,l),this.wa=jn("forwardChannelRequestTimeoutMs",2e4,l),this.pa=l&&l.xmlHttpFactory||void 0,this.Xa=l&&l.Tb||void 0,this.Ca=l&&l.useFetchStreams||!1,this.L=void 0,this.J=l&&l.supportsCrossDomainXhr||!1,this.K="",this.h=new Ai(l&&l.concurrentRequestLimit),this.Da=new oc,this.P=l&&l.fastHandshake||!1,this.O=l&&l.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=l&&l.Rb||!1,l&&l.xa&&this.j.xa(),l&&l.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&l&&l.detectBufferingProxy||!1,this.ja=void 0,l&&l.longPollingTimeout&&0<l.longPollingTimeout&&(this.ja=l.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}i=zo.prototype,i.la=8,i.G=1,i.connect=function(l,f,y,E){tt(0),this.W=l,this.H=f||{},y&&E!==void 0&&(this.H.OSID=y,this.H.OAID=E),this.F=this.X,this.I=ol(this,null,this.W),zn(this)};function At(l){if(vs(l),l.G==3){var f=l.U++,y=Zt(l.I);if(ze(y,"SID",l.K),ze(y,"RID",f),ze(y,"TYPE","terminate"),lr(l,y),f=new Tn(l,l.j,f),f.L=2,f.v=Vr(Zt(y)),y=!1,m.navigator&&m.navigator.sendBeacon)try{y=m.navigator.sendBeacon(f.v.toString(),"")}catch{}!y&&m.Image&&(new Image().src=f.v,y=!0),y||(f.g=al(f.j,null),f.g.ea(f.v)),f.F=Date.now(),$e(f)}sl(l)}function Cn(l){l.g&&(Bo(l),l.g.cancel(),l.g=null)}function vs(l){Cn(l),l.u&&(m.clearTimeout(l.u),l.u=null),Ts(l),l.h.cancel(),l.s&&(typeof l.s=="number"&&m.clearTimeout(l.s),l.s=null)}function zn(l){if(!Jt(l.h)&&!l.s){l.s=!0;var f=l.Ga;Le||ne(),Z||(Le(),Z=!0),ue.add(f,l),l.B=0}}function lc(l,f){return Ga(l.h)>=l.h.j-(l.s?1:0)?!1:l.s?(l.i=f.D.concat(l.i),!0):l.G==1||l.G==2||l.B>=(l.Va?0:l.Wa)?!1:(l.s=vn(M(l.Ga,l,f),il(l,l.B)),l.B++,!0)}i.Ga=function(l){if(this.s)if(this.s=null,this.G==1){if(!l){this.U=Math.floor(1e5*Math.random()),l=this.U++;const O=new Tn(this,this.j,l);let U=this.o;if(this.S&&(U?(U=T(U),R(U,this.S)):U=this.S),this.m!==null||this.O||(O.H=U,U=null),this.P)e:{for(var f=0,y=0;y<this.i.length;y++){t:{var E=this.i[y];if("__data__"in E.map&&(E=E.map.__data__,typeof E=="string")){E=E.length;break t}E=void 0}if(E===void 0)break;if(f+=E,4096<f){f=y;break e}if(f===4096||y===this.i.length-1){f=y+1;break e}}f=1e3}else f=1e3;f=br(this,O,f),y=Zt(this.I),ze(y,"RID",l),ze(y,"CVER",22),this.D&&ze(y,"X-HTTP-Session-Id",this.D),lr(this,y),U&&(this.O?f="headers="+encodeURIComponent(String(ar(U)))+"&"+f:this.m&&Mr(y,this.m,U)),Mo(this.h,O),this.Ua&&ze(y,"TYPE","init"),this.P?(ze(y,"$req",f),ze(y,"SID","null"),O.T=!0,ds(O,y,null)):ds(O,y,f),this.G=2}}else this.G==3&&(l?Es(this,l):this.i.length==0||Jt(this.h)||Es(this))};function Es(l,f){var y;f?y=f.l:y=l.U++;const E=Zt(l.I);ze(E,"SID",l.K),ze(E,"RID",y),ze(E,"AID",l.T),lr(l,E),l.m&&l.o&&Mr(E,l.m,l.o),y=new Tn(l,l.j,y,l.B+1),l.m===null&&(y.H=l.o),f&&(l.i=f.D.concat(l.i)),f=br(l,y,1e3),y.I=Math.round(.5*l.wa)+Math.round(.5*l.wa*Math.random()),Mo(l.h,y),ds(y,E,f)}function lr(l,f){l.H&&he(l.H,function(y,E){ze(f,E,y)}),l.l&&Nr({},function(y,E){ze(f,E,y)})}function br(l,f,y){y=Math.min(l.i.length,y);var E=l.l?M(l.l.Na,l.l,l):null;e:{var O=l.i;let U=-1;for(;;){const J=["count="+y];U==-1?0<y?(U=O[0].g,J.push("ofs="+U)):U=0:J.push("ofs="+U);let je=!0;for(let dt=0;dt<y;dt++){let De=O[dt].g;const vt=O[dt].map;if(De-=U,0>De)U=Math.max(0,O[dt].g-100),je=!1;else try{tl(vt,J,"req"+De+"_")}catch{E&&E(vt)}}if(je){E=J.join("&");break e}}}return l=l.i.splice(0,y),f.D=l,E}function Ni(l){if(!l.g&&!l.u){l.Y=1;var f=l.Fa;Le||ne(),Z||(Le(),Z=!0),ue.add(f,l),l.v=0}}function ws(l){return l.g||l.u||3<=l.v?!1:(l.Y++,l.u=vn(M(l.Fa,l),il(l,l.v)),l.v++,!0)}i.Fa=function(){if(this.u=null,rl(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var l=2*this.R;this.j.info("BP detection timer enabled: "+l),this.A=vn(M(this.ab,this),l)}},i.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,tt(10),Cn(this),rl(this))};function Bo(l){l.A!=null&&(m.clearTimeout(l.A),l.A=null)}function rl(l){l.g=new Tn(l,l.j,"rpc",l.Y),l.m===null&&(l.g.H=l.o),l.g.O=0;var f=Zt(l.qa);ze(f,"RID","rpc"),ze(f,"SID",l.K),ze(f,"AID",l.T),ze(f,"CI",l.F?"0":"1"),!l.F&&l.ja&&ze(f,"TO",l.ja),ze(f,"TYPE","xmlhttp"),lr(l,f),l.m&&l.o&&Mr(f,l.m,l.o),l.L&&(l.g.I=l.L);var y=l.g;l=l.ia,y.L=1,y.v=Vr(Zt(f)),y.m=null,y.P=!0,Oo(y,l)}i.Za=function(){this.C!=null&&(this.C=null,Cn(this),ws(this),tt(19))};function Ts(l){l.C!=null&&(m.clearTimeout(l.C),l.C=null)}function Is(l,f){var y=null;if(l.g==f){Ts(l),Bo(l),l.g=null;var E=2}else if(Ut(l.h,f))y=f.D,Ka(l.h,f),E=1;else return;if(l.G!=0){if(f.o)if(E==1){y=f.m?f.m.length:0,f=Date.now()-f.F;var O=l.B;E=Ei(),ht(E,new ls(E,y)),zn(l)}else Ni(l);else if(O=f.s,O==3||O==0&&0<f.X||!(E==1&&lc(l,f)||E==2&&ws(l)))switch(y&&0<y.length&&(f=l.h,f.i=f.i.concat(y)),O){case 1:ur(l,5);break;case 4:ur(l,10);break;case 3:ur(l,6);break;default:ur(l,2)}}}function il(l,f){let y=l.Ta+Math.floor(Math.random()*l.cb);return l.isActive()||(y*=2),y*f}function ur(l,f){if(l.j.info("Error code "+f),f==2){var y=M(l.fb,l),E=l.Xa;const O=!E;E=new sr(E||"//www.google.com/images/cleardot.gif"),m.location&&m.location.protocol=="http"||Ci(E,"https"),Vr(E),O?sc(E.toString(),y):el(E.toString(),y)}else tt(2);l.G=0,l.l&&l.l.sa(f),sl(l),vs(l)}i.fb=function(l){l?(this.j.info("Successfully pinged google.com"),tt(2)):(this.j.info("Failed to ping google.com"),tt(1))};function sl(l){if(l.G=0,l.ka=[],l.l){const f=Qa(l.h);(f.length!=0||l.i.length!=0)&&($(l.ka,f),$(l.ka,l.i),l.h.i.length=0,G(l.i),l.i.length=0),l.l.ra()}}function ol(l,f,y){var E=y instanceof sr?Zt(y):new sr(y);if(E.g!="")f&&(E.g=f+"."+E.g),xr(E,E.s);else{var O=m.location;E=O.protocol,f=f?f+"."+O.hostname:O.hostname,O=+O.port;var U=new sr(null);E&&Ci(U,E),f&&(U.g=f),O&&xr(U,O),y&&(U.l=y),E=U}return y=l.D,f=l.ya,y&&f&&ze(E,y,f),ze(E,"VER",l.la),lr(l,E),E}function al(l,f,y){if(f&&!l.J)throw Error("Can't create secondary domain capable XhrIo object.");return f=l.Ca&&!l.pa?new Ke(new or({eb:y})):new Ke(l.pa),f.Ha(l.J),f}i.isActive=function(){return!!this.l&&this.l.isActive(this)};function $o(){}i=$o.prototype,i.ua=function(){},i.ta=function(){},i.sa=function(){},i.ra=function(){},i.isActive=function(){return!0},i.Na=function(){};function Ss(){}Ss.prototype.g=function(l,f){return new jt(l,f)};function jt(l,f){ct.call(this),this.g=new zo(f),this.l=l,this.h=f&&f.messageUrlParams||null,l=f&&f.messageHeaders||null,f&&f.clientProtocolHeaderRequired&&(l?l["X-Client-Protocol"]="webchannel":l={"X-Client-Protocol":"webchannel"}),this.g.o=l,l=f&&f.initMessageHeaders||null,f&&f.messageContentType&&(l?l["X-WebChannel-Content-Type"]=f.messageContentType:l={"X-WebChannel-Content-Type":f.messageContentType}),f&&f.va&&(l?l["X-WebChannel-Client-Profile"]=f.va:l={"X-WebChannel-Client-Profile":f.va}),this.g.S=l,(l=f&&f.Sb)&&!ce(l)&&(this.g.m=l),this.v=f&&f.supportsCrossDomainXhr||!1,this.u=f&&f.sendRawJson||!1,(f=f&&f.httpSessionIdParam)&&!ce(f)&&(this.g.D=f,l=this.h,l!==null&&f in l&&(l=this.h,f in l&&delete l[f])),this.j=new Bn(this)}B(jt,ct),jt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},jt.prototype.close=function(){At(this.g)},jt.prototype.o=function(l){var f=this.g;if(typeof l=="string"){var y={};y.__data__=l,l=y}else this.u&&(y={},y.__data__=Ro(l),l=y);f.i.push(new Wa(f.Ya++,l)),f.G==3&&zn(f)},jt.prototype.N=function(){this.g.l=null,delete this.j,At(this.g),delete this.g,jt.aa.N.call(this)};function ll(l){Mn.call(this),l.__headers__&&(this.headers=l.__headers__,this.statusCode=l.__status__,delete l.__headers__,delete l.__status__);var f=l.__sm__;if(f){e:{for(const y in f){l=y;break e}l=void 0}(this.i=l)&&(l=this.i,f=f!==null&&l in f?f[l]:void 0),this.data=f}else this.data=l}B(ll,Mn);function ul(){as.call(this),this.status=1}B(ul,as);function Bn(l){this.g=l}B(Bn,$o),Bn.prototype.ua=function(){ht(this.g,"a")},Bn.prototype.ta=function(l){ht(this.g,new ll(l))},Bn.prototype.sa=function(l){ht(this.g,new ul)},Bn.prototype.ra=function(){ht(this.g,"b")},Ss.prototype.createWebChannel=Ss.prototype.g,jt.prototype.send=jt.prototype.o,jt.prototype.open=jt.prototype.m,jt.prototype.close=jt.prototype.close,ty=function(){return new Ss},ey=function(){return Ei()},Zg=bn,Qh={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},cs.NO_ERROR=0,cs.TIMEOUT=8,cs.HTTP_ERROR=6,cu=cs,Ba.COMPLETE="complete",Jg=Ba,os.EventType=on,on.OPEN="a",on.CLOSE="b",on.ERROR="c",on.MESSAGE="d",ct.prototype.listen=ct.prototype.K,pa=os,Ke.prototype.listenOnce=Ke.prototype.L,Ke.prototype.getLastError=Ke.prototype.Ka,Ke.prototype.getLastErrorCode=Ke.prototype.Ba,Ke.prototype.getStatus=Ke.prototype.Z,Ke.prototype.getResponseJson=Ke.prototype.Oa,Ke.prototype.getResponseText=Ke.prototype.oa,Ke.prototype.send=Ke.prototype.ea,Ke.prototype.setWithCredentials=Ke.prototype.Ha,Yg=Ke}).apply(typeof ru<"u"?ru:typeof self<"u"?self:typeof window<"u"?window:{});const Dm="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ki=new pd("@firebase/firestore");function Ws(){return Ki.logLevel}function re(i,...e){if(Ki.logLevel<=Re.DEBUG){const t=e.map(yd);Ki.debug(`Firestore (${fo}): ${i}`,...t)}}function Tr(i,...e){if(Ki.logLevel<=Re.ERROR){const t=e.map(yd);Ki.error(`Firestore (${fo}): ${i}`,...t)}}function ro(i,...e){if(Ki.logLevel<=Re.WARN){const t=e.map(yd);Ki.warn(`Firestore (${fo}): ${i}`,...t)}}function yd(i){if(typeof i=="string")return i;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ve(i="Unexpected state"){const e=`FIRESTORE (${fo}) INTERNAL ASSERTION FAILED: `+i;throw Tr(e),new Error(e)}function Ue(i,e){i||ve()}function Te(i,e){return i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function po(i){if(i.code!==W.FAILED_PRECONDITION||i.message!==JE)throw i;re("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(o){try{return atob(o)}catch(u){throw typeof DOMException<"u"&&u instanceof DOMException?new sy("Invalid base64 string: "+u):u}}(e);return new Nt(t)}static fromUint8Array(e){const t=function(o){let u="";for(let h=0;h<o.length;++h)u+=String.fromCharCode(o[h]);return u}(e);return new Nt(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(t){return btoa(t)}(this.binaryString)}toUint8Array(){return function(t){const s=new Uint8Array(t.length);for(let o=0;o<t.length;o++)s[o]=t.charCodeAt(o);return s}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Pe(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}Nt.EMPTY_BYTE_STRING=new Nt("");const iw=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function di(i){if(Ue(!!i),typeof i=="string"){let e=0;const t=iw.exec(i);if(Ue(!!t),t[1]){let o=t[1];o=(o+"000000000").substr(0,9),e=Number(o)}const s=new Date(i);return{seconds:Math.floor(s.getTime()/1e3),nanos:e}}return{seconds:rt(i.seconds),nanos:rt(i.nanos)}}function rt(i){return typeof i=="number"?i:typeof i=="string"?Number(i):0}function fi(i){return typeof i=="string"?Nt.fromBase64String(i):Nt.fromUint8Array(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _d(i){var e,t;return((t=(((e=i==null?void 0:i.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function zu(i){const e=i.mapValue.fields.__previous_value__;return _d(e)?zu(e):e}function Ia(i){const e=di(i.mapValue.fields.__local_write_time__.timestampValue);return new mt(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gn{constructor(e){this.value=e}static empty(){return new gn({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let s=0;s<e.length-1;++s)if(t=(t.mapValue.fields||{})[e.get(s)],!du(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=ya(t)}setAll(e){let t=Pt.emptyPath(),s={},o=[];e.forEach((h,m)=>{if(!t.isImmediateParentOf(m)){const g=this.getFieldsMap(t);this.applyChanges(g,s,o),s={},o=[],t=m.popLast()}h?s[m.lastSegment()]=ya(h):o.push(m.lastSegment())});const u=this.getFieldsMap(t);this.applyChanges(u,s,o)}delete(e){const t=this.field(e.popLast());du(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return Zn(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let s=0;s<e.length;++s){let o=t.mapValue.fields[e.get(s)];du(o)&&o.mapValue.fields||(o={mapValue:{fields:{}}},t.mapValue.fields[e.get(s)]=o),t=o}return t.mapValue.fields}applyChanges(e,t,s){Xi(t,(o,u)=>e[o]=u);for(const o of s)delete e[o]}clone(){return new gn(ya(this.value))}}function oy(i){const e=[];return Xi(i.fields,(t,s)=>{const o=new Pt([t]);if(du(s)){const u=oy(s.mapValue).fields;if(u.length===0)e.push(o);else for(const h of u)e.push(o.child(h))}else e.push(o)}),new On(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tw=new Ze(me.comparator);function Ir(){return Tw}const yy=new Ze(me.comparator);function ma(...i){let e=yy;for(const t of i)e=e.insert(t.key,t);return e}function _y(i){let e=yy;return i.forEach((t,s)=>e=e.insert(t,s.overlayedDocument)),e}function Hi(){return va()}function vy(){return va()}function va(){return new Yi(i=>i.toString(),(i,e)=>i.isEqual(e))}const Iw=new Ze(me.comparator),Sw=new gt(me.comparator);function Ce(...i){let e=Sw;for(const t of i)e=e.add(t);return e}const Aw=new gt(Pe);function Rw(){return Aw}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pu{constructor(e,t,s,o){this.Re=e,this.removedTargetIds=t,this.key=s,this.Ve=o}}class ky{constructor(e,t){this.targetId=e,this.me=t}}class Py{constructor(e,t,s=Nt.EMPTY_BYTE_STRING,o=null){this.state=e,this.targetIds=t,this.resumeToken=s,this.cause=o}}class Ym{constructor(){this.fe=0,this.ge=Jm(),this.pe=Nt.EMPTY_BYTE_STRING,this.ye=!1,this.we=!0}get current(){return this.ye}get resumeToken(){return this.pe}get Se(){return this.fe!==0}get be(){return this.we}De(e){e.approximateByteSize()>0&&(this.we=!0,this.pe=e)}ve(){let e=Ce(),t=Ce(),s=Ce();return this.ge.forEach((o,u)=>{switch(u){case 0:e=e.add(o);break;case 2:t=t.add(o);break;case 1:s=s.add(o);break;default:ve()}}),new La(this.pe,this.ye,e,t,s)}Ce(){this.we=!1,this.ge=Jm()}Fe(e,t){this.we=!0,this.ge=this.ge.insert(e,t)}Me(e){this.we=!0,this.ge=this.ge.remove(e)}xe(){this.fe+=1}Oe(){this.fe-=1,Ue(this.fe>=0)}Ne(){this.we=!0,this.ye=!0}}class zw{constructor(e){this.Be=e,this.Le=new Map,this.ke=Ir(),this.qe=ou(),this.Qe=ou(),this.Ke=new Ze(Pe)}$e(e){for(const t of e.Re)e.Ve&&e.Ve.isFoundDocument()?this.Ue(t,e.Ve):this.We(t,e.key,e.Ve);for(const t of e.removedTargetIds)this.We(t,e.key,e.Ve)}Ge(e){this.forEachTarget(e,t=>{const s=this.ze(t);switch(e.state){case 0:this.je(t)&&s.De(e.resumeToken);break;case 1:s.Oe(),s.Se||s.Ce(),s.De(e.resumeToken);break;case 2:s.Oe(),s.Se||this.removeTarget(t);break;case 3:this.je(t)&&(s.Ne(),s.De(e.resumeToken));break;case 4:this.je(t)&&(this.He(t),s.De(e.resumeToken));break;default:ve()}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Le.forEach((s,o)=>{this.je(o)&&t(o)})}Je(e){const t=e.targetId,s=e.me.count,o=this.Ye(t);if(o){const u=o.target;if(Zh(u))if(s===0){const h=new me(u.path);this.We(t,h,bt.newNoDocument(h,we.min()))}else Ue(s===1);else{const h=this.Ze(t);if(h!==s){const m=this.Xe(e),g=m?this.et(m,e,h):1;if(g!==0){this.He(t);const v=g===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Ke=this.Ke.insert(t,v)}}}}}Xe(e){const t=e.me.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:s="",padding:o=0},hashCount:u=0}=t;let h,m;try{h=fi(s).toUint8Array()}catch(g){if(g instanceof sy)return ro("Decoding the base64 bloom filter in existence filter failed ("+g.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw g}try{m=new Ad(h,o,u)}catch(g){return ro(g instanceof ga?"BloomFilter error: ":"Applying bloom filter failed: ",g),null}return m.Te===0?null:m}et(e,t,s){return t.me.count===s-this.rt(e,t.targetId)?0:2}rt(e,t){const s=this.Be.getRemoteKeysForTarget(t);let o=0;return s.forEach(u=>{const h=this.Be.nt(),m=`projects/${h.projectId}/databases/${h.database}/documents/${u.path.canonicalString()}`;e.mightContain(m)||(this.We(t,u,null),o++)}),o}it(e){const t=new Map;this.Le.forEach((u,h)=>{const m=this.Ye(h);if(m){if(u.current&&Zh(m.target)){const g=new me(m.target.path);this.st(g).has(h)||this.ot(h,g)||this.We(h,g,bt.newNoDocument(g,e))}u.be&&(t.set(h,u.ve()),u.Ce())}});let s=Ce();this.Qe.forEach((u,h)=>{let m=!0;h.forEachWhile(g=>{const v=this.Ye(g);return!v||v.purpose==="TargetPurposeLimboResolution"||(m=!1,!1)}),m&&(s=s.add(u))}),this.ke.forEach((u,h)=>h.setReadTime(e));const o=new Wu(e,t,this.Ke,this.ke,s);return this.ke=Ir(),this.qe=ou(),this.Qe=ou(),this.Ke=new Ze(Pe),o}Ue(e,t){if(!this.je(e))return;const s=this.ot(e,t.key)?2:0;this.ze(e).Fe(t.key,s),this.ke=this.ke.insert(t.key,t),this.qe=this.qe.insert(t.key,this.st(t.key).add(e)),this.Qe=this.Qe.insert(t.key,this._t(t.key).add(e))}We(e,t,s){if(!this.je(e))return;const o=this.ze(e);this.ot(e,t)?o.Fe(t,1):o.Me(t),this.Qe=this.Qe.insert(t,this._t(t).delete(e)),this.Qe=this.Qe.insert(t,this._t(t).add(e)),s&&(this.ke=this.ke.insert(t,s))}removeTarget(e){this.Le.delete(e)}Ze(e){const t=this.ze(e).ve();return this.Be.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}xe(e){this.ze(e).xe()}ze(e){let t=this.Le.get(e);return t||(t=new Ym,this.Le.set(e,t)),t}_t(e){let t=this.Qe.get(e);return t||(t=new gt(Pe),this.Qe=this.Qe.insert(e,t)),t}st(e){let t=this.qe.get(e);return t||(t=new gt(Pe),this.qe=this.qe.insert(e,t)),t}je(e){const t=this.Ye(e)!==null;return t||re("WatchChangeAggregator","Detected inactive target",e),t}Ye(e){const t=this.Le.get(e);return t&&t.Se?null:this.Be.ut(e)}He(e){this.Le.set(e,new Ym),this.Be.getRemoteKeysForTarget(e).forEach(t=>{this.We(e,t,null)})}ot(e,t){return this.Be.getRemoteKeysForTarget(e).has(t)}}function ou(){return new Ze(me.comparator)}function Jm(){return new Ze(me.comparator)}const Bw={asc:"ASCENDING",desc:"DESCENDING"},$w={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},qw={and:"AND",or:"OR"};class Hw{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function nd(i,e){return i.useProto3Json||ju(e)?e:{value:e}}function ku(i,e){return i.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function Ny(i,e){return i.useProto3Json?e.toBase64():e.toUint8Array()}function Ww(i,e){return ku(i,e.toTimestamp())}function Xn(i){return Ue(!!i),we.fromTimestamp(function(t){const s=di(t);return new mt(s.seconds,s.nanos)}(i))}function Rd(i,e){return rd(i,e).canonicalString()}function rd(i,e){const t=function(o){return new Ge(["projects",o.projectId,"databases",o.database])}(i).child("documents");return e===void 0?t:t.child(e)}function xy(i){const e=Ge.fromString(i);return Ue(My(e)),e}function id(i,e){return Rd(i.databaseId,e.path)}function Fh(i,e){const t=xy(e);if(t.get(1)!==i.databaseId.projectId)throw new oe(W.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+i.databaseId.projectId);if(t.get(3)!==i.databaseId.database)throw new oe(W.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+i.databaseId.database);return new me(Vy(t))}function Dy(i,e){return Rd(i.databaseId,e)}function Gw(i){const e=xy(i);return e.length===4?Ge.emptyPath():Vy(e)}function sd(i){return new Ge(["projects",i.databaseId.projectId,"databases",i.databaseId.database]).canonicalString()}function Vy(i){return Ue(i.length>4&&i.get(4)==="documents"),i.popFirst(5)}function Zm(i,e,t){return{name:id(i,e),fields:t.value.mapValue.fields}}function Kw(i,e){let t;if("targetChange"in e){e.targetChange;const s=function(v){return v==="NO_CHANGE"?0:v==="ADD"?1:v==="REMOVE"?2:v==="CURRENT"?3:v==="RESET"?4:ve()}(e.targetChange.targetChangeType||"NO_CHANGE"),o=e.targetChange.targetIds||[],u=function(v,w){return v.useProto3Json?(Ue(w===void 0||typeof w=="string"),Nt.fromBase64String(w||"")):(Ue(w===void 0||w instanceof Buffer||w instanceof Uint8Array),Nt.fromUint8Array(w||new Uint8Array))}(i,e.targetChange.resumeToken),h=e.targetChange.cause,m=h&&function(v){const w=v.code===void 0?W.UNKNOWN:Cy(v.code);return new oe(w,v.message||"")}(h);t=new Py(s,o,u,m||null)}else if("documentChange"in e){e.documentChange;const s=e.documentChange;s.document,s.document.name,s.document.updateTime;const o=Fh(i,s.document.name),u=Xn(s.document.updateTime),h=s.document.createTime?Xn(s.document.createTime):we.min(),m=new gn({mapValue:{fields:s.document.fields}}),g=bt.newFoundDocument(o,u,h,m),v=s.targetIds||[],w=s.removedTargetIds||[];t=new pu(v,w,g.key,g)}else if("documentDelete"in e){e.documentDelete;const s=e.documentDelete;s.document;const o=Fh(i,s.document),u=s.readTime?Xn(s.readTime):we.min(),h=bt.newNoDocument(o,u),m=s.removedTargetIds||[];t=new pu([],m,h.key,h)}else if("documentRemove"in e){e.documentRemove;const s=e.documentRemove;s.document;const o=Fh(i,s.document),u=s.removedTargetIds||[];t=new pu([],u,o,null)}else{if(!("filter"in e))return ve();{e.filter;const s=e.filter;s.targetId;const{count:o=0,unchangedNames:u}=s,h=new bw(o,u),m=s.targetId;t=new ky(m,h)}}return t}function Qw(i,e){let t;if(e instanceof Oa)t={update:Zm(i,e.key,e.value)};else if(e instanceof Id)t={delete:id(i,e.key)};else if(e instanceof Ji)t={update:Zm(i,e.key,e.data),updateMask:iT(e.fieldMask)};else{if(!(e instanceof Ow))return ve();t={verify:id(i,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(s=>function(u,h){const m=h.transform;if(m instanceof Ru)return{fieldPath:h.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(m instanceof Ra)return{fieldPath:h.field.canonicalString(),appendMissingElements:{values:m.elements}};if(m instanceof Ca)return{fieldPath:h.field.canonicalString(),removeAllFromArray:{values:m.elements}};if(m instanceof Cu)return{fieldPath:h.field.canonicalString(),increment:m.Pe};throw ve()}(0,s))),e.precondition.isNone||(t.currentDocument=function(o,u){return u.updateTime!==void 0?{updateTime:Ww(o,u.updateTime)}:u.exists!==void 0?{exists:u.exists}:ve()}(i,e.precondition)),t}function Xw(i,e){return i&&i.length>0?(Ue(e!==void 0),i.map(t=>function(o,u){let h=o.updateTime?Xn(o.updateTime):Xn(u);return h.isEqual(we.min())&&(h=Xn(u)),new xw(h,o.transformResults||[])}(t,e))):[]}function Yw(i,e){return{documents:[Dy(i,e.path)]}}function Jw(i,e){const t={structuredQuery:{}},s=e.path;let o;e.collectionGroup!==null?(o=s,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(o=s.popLast(),t.structuredQuery.from=[{collectionId:s.lastSegment()}]),t.parent=Dy(i,o);const u=function(v){if(v.length!==0)return Ly(Ln.create(v,"and"))}(e.filters);u&&(t.structuredQuery.where=u);const h=function(v){if(v.length!==0)return v.map(w=>function(M){return{field:Ks(M.field),direction:tT(M.dir)}}(w))}(e.orderBy);h&&(t.structuredQuery.orderBy=h);const m=nd(i,e.limit);return m!==null&&(t.structuredQuery.limit=m),e.startAt&&(t.structuredQuery.startAt=function(v){return{before:v.inclusive,values:v.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(v){return{before:!v.inclusive,values:v.position}}(e.endAt)),{ct:t,parent:o}}function Zw(i){let e=Gw(i.parent);const t=i.structuredQuery,s=t.from?t.from.length:0;let o=null;if(s>0){Ue(s===1);const w=t.from[0];w.allDescendants?o=w.collectionId:e=e.child(w.collectionId)}let u=[];t.where&&(u=function(P){const M=Oy(P);return M instanceof Ln&&uy(M)?M.getFilters():[M]}(t.where));let h=[];t.orderBy&&(h=function(P){return P.map(M=>function(B){return new Au(Qs(B.field),function($){switch($){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(B.direction))}(M))}(t.orderBy));let m=null;t.limit&&(m=function(P){let M;return M=typeof P=="object"?P.value:P,ju(M)?null:M}(t.limit));let g=null;t.startAt&&(g=function(P){const M=!!P.before,z=P.values||[];return new Su(z,M)}(t.startAt));let v=null;return t.endAt&&(v=function(P){const M=!P.before,z=P.values||[];return new Su(z,M)}(t.endAt)),_w(e,o,h,u,m,"F",g,v)}function eT(i,e){const t=function(o){switch(o){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return ve()}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function Oy(i){return i.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const s=Qs(t.unaryFilter.field);return ut.create(s,"==",{doubleValue:NaN});case"IS_NULL":const o=Qs(t.unaryFilter.field);return ut.create(o,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const u=Qs(t.unaryFilter.field);return ut.create(u,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const h=Qs(t.unaryFilter.field);return ut.create(h,"!=",{nullValue:"NULL_VALUE"});default:return ve()}}(i):i.fieldFilter!==void 0?function(t){return ut.create(Qs(t.fieldFilter.field),function(o){switch(o){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return ve()}}(t.fieldFilter.op),t.fieldFilter.value)}(i):i.compositeFilter!==void 0?function(t){return Ln.create(t.compositeFilter.filters.map(s=>Oy(s)),function(o){switch(o){case"AND":return"and";case"OR":return"or";default:return ve()}}(t.compositeFilter.op))}(i):ve()}function tT(i){return Bw[i]}function nT(i){return $w[i]}function rT(i){return qw[i]}function Ks(i){return{fieldPath:i.canonicalString()}}function Qs(i){return Pt.fromServerFormat(i.fieldPath)}function Ly(i){return i instanceof ut?function(t){if(t.op==="=="){if(jm(t.value))return{unaryFilter:{field:Ks(t.field),op:"IS_NAN"}};if(Um(t.value))return{unaryFilter:{field:Ks(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(jm(t.value))return{unaryFilter:{field:Ks(t.field),op:"IS_NOT_NAN"}};if(Um(t.value))return{unaryFilter:{field:Ks(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:Ks(t.field),op:nT(t.op),value:t.value}}}(i):i instanceof Ln?function(t){const s=t.getFilters().map(o=>Ly(o));return s.length===1?s[0]:{compositeFilter:{op:rT(t.op),filters:s}}}(i):ve()}function iT(i){const e=[];return i.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function My(i){return i.length>=4&&i.get(0)==="projects"&&i.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fT{constructor(){this.changes=new Yi(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,bt.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const s=this.changes.get(t);return s!==void 0?q.resolve(s):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mT{constructor(e,t,s,o){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=s,this.indexManager=o}getDocument(e,t){let s=null;return this.documentOverlayCache.getOverlay(e,t).next(o=>(s=o,this.remoteDocumentCache.getEntry(e,t))).next(o=>(s!==null&&Ea(s.mutation,o,On.empty(),mt.now()),o))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(s=>this.getLocalViewOfDocuments(e,s,Ce()).next(()=>s))}getLocalViewOfDocuments(e,t,s=Ce()){const o=Hi();return this.populateOverlays(e,o,t).next(()=>this.computeViews(e,t,o,s).next(u=>{let h=ma();return u.forEach((m,g)=>{h=h.insert(m,g.overlayedDocument)}),h}))}getOverlayedDocuments(e,t){const s=Hi();return this.populateOverlays(e,s,t).next(()=>this.computeViews(e,t,s,Ce()))}populateOverlays(e,t,s){const o=[];return s.forEach(u=>{t.has(u)||o.push(u)}),this.documentOverlayCache.getOverlays(e,o).next(u=>{u.forEach((h,m)=>{t.set(h,m)})})}computeViews(e,t,s,o){let u=Ir();const h=va(),m=function(){return va()}();return t.forEach((g,v)=>{const w=s.get(v.key);o.has(v.key)&&(w===void 0||w.mutation instanceof Ji)?u=u.insert(v.key,v):w!==void 0?(h.set(v.key,w.mutation.getFieldMask()),Ea(w.mutation,v,w.mutation.getFieldMask(),mt.now())):h.set(v.key,On.empty())}),this.recalculateAndSaveOverlays(e,u).next(g=>(g.forEach((v,w)=>h.set(v,w)),t.forEach((v,w)=>{var P;return m.set(v,new pT(w,(P=h.get(v))!==null&&P!==void 0?P:null))}),m))}recalculateAndSaveOverlays(e,t){const s=va();let o=new Ze((h,m)=>h-m),u=Ce();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(h=>{for(const m of h)m.keys().forEach(g=>{const v=t.get(g);if(v===null)return;let w=s.get(g)||On.empty();w=m.applyToLocalView(v,w),s.set(g,w);const P=(o.get(m.batchId)||Ce()).add(g);o=o.insert(m.batchId,P)})}).next(()=>{const h=[],m=o.getReverseIterator();for(;m.hasNext();){const g=m.getNext(),v=g.key,w=g.value,P=vy();w.forEach(M=>{if(!u.has(M)){const z=Ay(t.get(M),s.get(M));z!==null&&P.set(M,z),u=u.add(M)}}),h.push(this.documentOverlayCache.saveOverlays(e,v,P))}return q.waitFor(h)}).next(()=>s)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(s=>this.recalculateAndSaveOverlays(e,s))}getDocumentsMatchingQuery(e,t,s,o){return function(h){return me.isDocumentKey(h.path)&&h.collectionGroup===null&&h.filters.length===0}(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):py(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,s,o):this.getDocumentsMatchingCollectionQuery(e,t,s,o)}getNextDocuments(e,t,s,o){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,s,o).next(u=>{const h=o-u.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,s.largestBatchId,o-u.size):q.resolve(Hi());let m=-1,g=u;return h.next(v=>q.forEach(v,(w,P)=>(m<P.largestBatchId&&(m=P.largestBatchId),u.get(w)?q.resolve():this.remoteDocumentCache.getEntry(e,w).next(M=>{g=g.insert(w,M)}))).next(()=>this.populateOverlays(e,v,u)).next(()=>this.computeViews(e,g,v,Ce())).next(w=>({batchId:m,changes:_y(w)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new me(t)).next(s=>{let o=ma();return s.isFoundDocument()&&(o=o.insert(s.key,s)),o})}getDocumentsMatchingCollectionGroupQuery(e,t,s,o){const u=t.collectionGroup;let h=ma();return this.indexManager.getCollectionParents(e,u).next(m=>q.forEach(m,g=>{const v=function(P,M){return new Va(M,null,P.explicitOrderBy.slice(),P.filters.slice(),P.limit,P.limitType,P.startAt,P.endAt)}(t,g.child(u));return this.getDocumentsMatchingCollectionQuery(e,v,s,o).next(w=>{w.forEach((P,M)=>{h=h.insert(P,M)})})}).next(()=>h))}getDocumentsMatchingCollectionQuery(e,t,s,o){let u;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,s.largestBatchId).next(h=>(u=h,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,s,u,o))).next(h=>{u.forEach((g,v)=>{const w=v.getKey();h.get(w)===null&&(h=h.insert(w,bt.newInvalidDocument(w)))});let m=ma();return h.forEach((g,v)=>{const w=u.get(g);w!==void 0&&Ea(w.mutation,v,On.empty(),mt.now()),$u(t,v)&&(m=m.insert(g,v))}),m})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yT{constructor(){this.overlays=new Ze(me.comparator),this.dr=new Map}getOverlay(e,t){return q.resolve(this.overlays.get(t))}getOverlays(e,t){const s=Hi();return q.forEach(t,o=>this.getOverlay(e,o).next(u=>{u!==null&&s.set(o,u)})).next(()=>s)}saveOverlays(e,t,s){return s.forEach((o,u)=>{this.Tt(e,t,u)}),q.resolve()}removeOverlaysForBatchId(e,t,s){const o=this.dr.get(s);return o!==void 0&&(o.forEach(u=>this.overlays=this.overlays.remove(u)),this.dr.delete(s)),q.resolve()}getOverlaysForCollection(e,t,s){const o=Hi(),u=t.length+1,h=new me(t.child("")),m=this.overlays.getIteratorFrom(h);for(;m.hasNext();){const g=m.getNext().value,v=g.getKey();if(!t.isPrefixOf(v.path))break;v.path.length===u&&g.largestBatchId>s&&o.set(g.getKey(),g)}return q.resolve(o)}getOverlaysForCollectionGroup(e,t,s,o){let u=new Ze((v,w)=>v-w);const h=this.overlays.getIterator();for(;h.hasNext();){const v=h.getNext().value;if(v.getKey().getCollectionGroup()===t&&v.largestBatchId>s){let w=u.get(v.largestBatchId);w===null&&(w=Hi(),u=u.insert(v.largestBatchId,w)),w.set(v.getKey(),v)}}const m=Hi(),g=u.getIterator();for(;g.hasNext()&&(g.getNext().value.forEach((v,w)=>m.set(v,w)),!(m.size()>=o)););return q.resolve(m)}Tt(e,t,s){const o=this.overlays.get(s.key);if(o!==null){const h=this.dr.get(o.largestBatchId).delete(s.key);this.dr.set(o.largestBatchId,h)}this.overlays=this.overlays.insert(s.key,new Mw(t,s));let u=this.dr.get(t);u===void 0&&(u=Ce(),this.dr.set(t,u)),this.dr.set(t,u.add(s.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cd{constructor(){this.Er=new gt(It.Ar),this.Rr=new gt(It.Vr)}isEmpty(){return this.Er.isEmpty()}addReference(e,t){const s=new It(e,t);this.Er=this.Er.add(s),this.Rr=this.Rr.add(s)}mr(e,t){e.forEach(s=>this.addReference(s,t))}removeReference(e,t){this.gr(new It(e,t))}pr(e,t){e.forEach(s=>this.removeReference(s,t))}yr(e){const t=new me(new Ge([])),s=new It(t,e),o=new It(t,e+1),u=[];return this.Rr.forEachInRange([s,o],h=>{this.gr(h),u.push(h.key)}),u}wr(){this.Er.forEach(e=>this.gr(e))}gr(e){this.Er=this.Er.delete(e),this.Rr=this.Rr.delete(e)}Sr(e){const t=new me(new Ge([])),s=new It(t,e),o=new It(t,e+1);let u=Ce();return this.Rr.forEachInRange([s,o],h=>{u=u.add(h.key)}),u}containsKey(e){const t=new It(e,0),s=this.Er.firstAfterOrEqual(t);return s!==null&&e.isEqual(s.key)}}class It{constructor(e,t){this.key=e,this.br=t}static Ar(e,t){return me.comparator(e.key,t.key)||Pe(e.br,t.br)}static Vr(e,t){return Pe(e.br,t.br)||me.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class AT{constructor(){this.ji=!1,this.Hi=!1,this.Ji=100,this.Yi=function(){return I0()?8:ew(Ft())>0?6:4}()}initialize(e,t){this.Zi=e,this.indexManager=t,this.ji=!0}getDocumentsMatchingQuery(e,t,s,o){const u={result:null};return this.Xi(e,t).next(h=>{u.result=h}).next(()=>{if(!u.result)return this.es(e,t,o,s).next(h=>{u.result=h})}).next(()=>{if(u.result)return;const h=new ST;return this.ts(e,t,h).next(m=>{if(u.result=m,this.Hi)return this.ns(e,t,h,m.size)})}).next(()=>u.result)}ns(e,t,s,o){return s.documentReadCount<this.Ji?(Ws()<=Re.DEBUG&&re("QueryEngine","SDK will not create cache indexes for query:",Gs(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Ji,"documents"),q.resolve()):(Ws()<=Re.DEBUG&&re("QueryEngine","Query:",Gs(t),"scans",s.documentReadCount,"local documents and returns",o,"documents as results."),s.documentReadCount>this.Yi*o?(Ws()<=Re.DEBUG&&re("QueryEngine","The SDK decides to create cache indexes for query:",Gs(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Kn(t))):q.resolve())}Xi(e,t){if(qm(t))return q.resolve(null);let s=Kn(t);return this.indexManager.getIndexType(e,s).next(o=>o===0?null:(t.limit!==null&&o===1&&(t=td(t,null,"F"),s=Kn(t)),this.indexManager.getDocumentsMatchingTarget(e,s).next(u=>{const h=Ce(...u);return this.Zi.getDocuments(e,h).next(m=>this.indexManager.getMinOffset(e,s).next(g=>{const v=this.rs(t,m);return this.ss(t,v,h,g.readTime)?this.Xi(e,td(t,null,"F")):this.os(e,v,t,g)}))})))}es(e,t,s,o){return qm(t)||o.isEqual(we.min())?q.resolve(null):this.Zi.getDocuments(e,s).next(u=>{const h=this.rs(t,u);return this.ss(t,h,s,o)?q.resolve(null):(Ws()<=Re.DEBUG&&re("QueryEngine","Re-using previous result from %s to execute query: %s",o.toString(),Gs(t)),this.os(e,h,t,QE(o,-1)).next(m=>m))})}rs(e,t){let s=new gt(gy(e));return t.forEach((o,u)=>{$u(e,u)&&(s=s.add(u))}),s}ss(e,t,s,o){if(e.limit===null)return!1;if(s.size!==t.size)return!0;const u=e.limitType==="F"?t.last():t.first();return!!u&&(u.hasPendingWrites||u.version.compareTo(o)>0)}ts(e,t,s){return Ws()<=Re.DEBUG&&re("QueryEngine","Using full collection scan to execute query:",Gs(t)),this.Zi.getDocumentsMatchingQuery(e,t,hi.min(),s)}os(e,t,s,o){return this.Zi.getDocumentsMatchingQuery(e,s,o).next(u=>(t.forEach(h=>{u=u.insert(h.key,h)}),u))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lt="WebChannelConnection";class FT extends class{get Co(){return!1}constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const s=t.ssl?"https":"http",o=encodeURIComponent(this.databaseId.projectId),u=encodeURIComponent(this.databaseId.database);this.Fo=s+"://"+t.host,this.Mo=`projects/${o}/databases/${u}`,this.xo=this.databaseId.database==="(default)"?`project_id=${o}`:`project_id=${o}&database_id=${u}`}Oo(t,s,o,u,h){const m=Uh(),g=this.No(t,s.toUriEncodedString());re("RestConnection",`Sending RPC '${t}' ${m}:`,g,o);const v={"google-cloud-resource-prefix":this.Mo,"x-goog-request-params":this.xo};return this.Bo(v,u,h),this.Lo(t,g,v,o).then(w=>(re("RestConnection",`Received RPC '${t}' ${m}: `,w),w),w=>{throw ro("RestConnection",`RPC '${t}' ${m} failed with error: `,w,"url: ",g,"request:",o),w})}ko(t,s,o,u,h,m){return this.Oo(t,s,o,u,h)}Bo(t,s,o){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+fo}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),s&&s.headers.forEach((u,h)=>t[h]=u),o&&o.headers.forEach((u,h)=>t[h]=u)}No(t,s){const o=MT[t];return`${this.Fo}/v1/${s}:${o}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Lo(e,t,s,o){const u=Uh();return new Promise((h,m)=>{const g=new Yg;g.setWithCredentials(!0),g.listenOnce(Jg.COMPLETE,()=>{try{switch(g.getLastErrorCode()){case cu.NO_ERROR:const w=g.getResponseJson();re(Lt,`XHR for RPC '${e}' ${u} received:`,JSON.stringify(w)),h(w);break;case cu.TIMEOUT:re(Lt,`RPC '${e}' ${u} timed out`),m(new oe(W.DEADLINE_EXCEEDED,"Request time out"));break;case cu.HTTP_ERROR:const P=g.getStatus();if(re(Lt,`RPC '${e}' ${u} failed with status:`,P,"response text:",g.getResponseText()),P>0){let M=g.getResponseJson();Array.isArray(M)&&(M=M[0]);const z=M==null?void 0:M.error;if(z&&z.status&&z.message){const B=function($){const pe=$.toLowerCase().replace(/_/g,"-");return Object.values(W).indexOf(pe)>=0?pe:W.UNKNOWN}(z.status);m(new oe(B,z.message))}else m(new oe(W.UNKNOWN,"Server responded with status "+g.getStatus()))}else m(new oe(W.UNAVAILABLE,"Connection failed."));break;default:ve()}}finally{re(Lt,`RPC '${e}' ${u} completed.`)}});const v=JSON.stringify(o);re(Lt,`RPC '${e}' ${u} sending request:`,o),g.send(t,"POST",v,s,15)})}qo(e,t,s){const o=Uh(),u=[this.Fo,"/","google.firestore.v1.Firestore","/",e,"/channel"],h=ty(),m=ey(),g={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},v=this.longPollingOptions.timeoutSeconds;v!==void 0&&(g.longPollingTimeout=Math.round(1e3*v)),this.useFetchStreams&&(g.useFetchStreams=!0),this.Bo(g.initMessageHeaders,t,s),g.encodeInitMessageHeaders=!0;const w=u.join("");re(Lt,`Creating RPC '${e}' stream ${o}: ${w}`,g);const P=h.createWebChannel(w,g);let M=!1,z=!1;const B=new bT({Eo:$=>{z?re(Lt,`Not sending because RPC '${e}' stream ${o} is closed:`,$):(M||(re(Lt,`Opening RPC '${e}' stream ${o} transport.`),P.open(),M=!0),re(Lt,`RPC '${e}' stream ${o} sending:`,$),P.send($))},Ao:()=>P.close()}),G=($,pe,ce)=>{$.listen(pe,te=>{try{ce(te)}catch(fe){setTimeout(()=>{throw fe},0)}})};return G(P,pa.EventType.OPEN,()=>{z||(re(Lt,`RPC '${e}' stream ${o} transport opened.`),B.So())}),G(P,pa.EventType.CLOSE,()=>{z||(z=!0,re(Lt,`RPC '${e}' stream ${o} transport closed`),B.Do())}),G(P,pa.EventType.ERROR,$=>{z||(z=!0,ro(Lt,`RPC '${e}' stream ${o} transport errored:`,$),B.Do(new oe(W.UNAVAILABLE,"The operation could not be completed")))}),G(P,pa.EventType.MESSAGE,$=>{var pe;if(!z){const ce=$.data[0];Ue(!!ce);const te=ce,fe=(te==null?void 0:te.error)||((pe=te[0])===null||pe===void 0?void 0:pe.error);if(fe){re(Lt,`RPC '${e}' stream ${o} received error:`,fe);const Ne=fe.status;let he=function(A){const R=at[A];if(R!==void 0)return Cy(R)}(Ne),k=fe.message;he===void 0&&(he=W.INTERNAL,k="Unknown error status: "+Ne+" with message "+fe.message),z=!0,B.Do(new oe(he,k)),P.close()}else re(Lt,`RPC '${e}' stream ${o} received:`,ce),B.vo(ce)}}),G(m,Zg.STAT_EVENT,$=>{$.stat===Qh.PROXY?re(Lt,`RPC '${e}' stream ${o} detected buffering proxy`):$.stat===Qh.NOPROXY&&re(Lt,`RPC '${e}' stream ${o} detected no buffering proxy`)}),setTimeout(()=>{B.bo()},0),B}}function jh(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ky{constructor(e){this.key=e}}class Qy{constructor(e){this.key=e}}class lI{constructor(e,t){this.query=e,this.Ea=t,this.Aa=null,this.hasCachedResults=!1,this.current=!1,this.Ra=Ce(),this.mutatedKeys=Ce(),this.Va=gy(e),this.ma=new Ys(this.Va)}get fa(){return this.Ea}ga(e,t){const s=t?t.pa:new og,o=t?t.ma:this.ma;let u=t?t.mutatedKeys:this.mutatedKeys,h=o,m=!1;const g=this.query.limitType==="F"&&o.size===this.query.limit?o.last():null,v=this.query.limitType==="L"&&o.size===this.query.limit?o.first():null;if(e.inorderTraversal((w,P)=>{const M=o.get(w),z=$u(this.query,P)?P:null,B=!!M&&this.mutatedKeys.has(M.key),G=!!z&&(z.hasLocalMutations||this.mutatedKeys.has(z.key)&&z.hasCommittedMutations);let $=!1;M&&z?M.data.isEqual(z.data)?B!==G&&(s.track({type:3,doc:z}),$=!0):this.ya(M,z)||(s.track({type:2,doc:z}),$=!0,(g&&this.Va(z,g)>0||v&&this.Va(z,v)<0)&&(m=!0)):!M&&z?(s.track({type:0,doc:z}),$=!0):M&&!z&&(s.track({type:1,doc:M}),$=!0,(g||v)&&(m=!0)),$&&(z?(h=h.add(z),u=G?u.add(w):u.delete(w)):(h=h.delete(w),u=u.delete(w)))}),this.query.limit!==null)for(;h.size>this.query.limit;){const w=this.query.limitType==="F"?h.last():h.first();h=h.delete(w.key),u=u.delete(w.key),s.track({type:1,doc:w})}return{ma:h,pa:s,ss:m,mutatedKeys:u}}ya(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,s,o){const u=this.ma;this.ma=e.ma,this.mutatedKeys=e.mutatedKeys;const h=e.pa.j_();h.sort((w,P)=>function(z,B){const G=$=>{switch($){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return ve()}};return G(z)-G(B)}(w.type,P.type)||this.Va(w.doc,P.doc)),this.wa(s),o=o!=null&&o;const m=t&&!o?this.Sa():[],g=this.Ra.size===0&&this.current&&!o?1:0,v=g!==this.Aa;return this.Aa=g,h.length!==0||v?{snapshot:new lo(this.query,e.ma,u,h,e.mutatedKeys,g===0,v,!1,!!s&&s.resumeToken.approximateByteSize()>0),ba:m}:{ba:m}}ea(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({ma:this.ma,pa:new og,mutatedKeys:this.mutatedKeys,ss:!1},!1)):{ba:[]}}Da(e){return!this.Ea.has(e)&&!!this.ma.has(e)&&!this.ma.get(e).hasLocalMutations}wa(e){e&&(e.addedDocuments.forEach(t=>this.Ea=this.Ea.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ea=this.Ea.delete(t)),this.current=e.current)}Sa(){if(!this.current)return[];const e=this.Ra;this.Ra=Ce(),this.ma.forEach(s=>{this.Da(s.key)&&(this.Ra=this.Ra.add(s.key))});const t=[];return e.forEach(s=>{this.Ra.has(s)||t.push(new Qy(s))}),this.Ra.forEach(s=>{e.has(s)||t.push(new Ky(s))}),t}va(e){this.Ea=e.Es,this.Ra=Ce();const t=this.ga(e.documents);return this.applyChanges(t,!0)}Ca(){return lo.fromInitialDocuments(this.query,this.ma,this.mutatedKeys,this.Aa===0,this.hasCachedResults)}}class uI{constructor(e,t,s){this.query=e,this.targetId=t,this.view=s}}class cI{constructor(e){this.key=e,this.Fa=!1}}class hI{constructor(e,t,s,o,u,h){this.localStore=e,this.remoteStore=t,this.eventManager=s,this.sharedClientState=o,this.currentUser=u,this.maxConcurrentLimboResolutions=h,this.Ma={},this.xa=new Yi(m=>my(m),Bu),this.Oa=new Map,this.Na=new Set,this.Ba=new Ze(me.comparator),this.La=new Map,this.ka=new Cd,this.qa={},this.Qa=new Map,this.Ka=ao.Qn(),this.onlineState="Unknown",this.$a=void 0}get isPrimaryClient(){return this.$a===!0}}async function dI(i,e,t=!0){const s=t_(i);let o;const u=s.xa.get(e);return u?(s.sharedClientState.addLocalQueryTarget(u.targetId),o=u.view.Ca()):o=await Xy(s,e,t,!0),o}async function fI(i,e){const t=t_(i);await Xy(t,e,!0,!1)}async function Xy(i,e,t,s){const o=await DT(i.localStore,Kn(e)),u=o.targetId,h=i.sharedClientState.addLocalQueryTarget(u,t);let m;return s&&(m=await pI(i,e,u,h==="current",o.resumeToken)),i.isPrimaryClient&&t&&By(i.remoteStore,o),m}async function pI(i,e,t,s,o){i.Ua=(P,M,z)=>async function(G,$,pe,ce){let te=$.view.ga(pe);te.ss&&(te=await ng(G.localStore,$.query,!1).then(({documents:k})=>$.view.ga(k,te)));const fe=ce&&ce.targetChanges.get($.targetId),Ne=ce&&ce.targetMismatches.get($.targetId)!=null,he=$.view.applyChanges(te,G.isPrimaryClient,fe,Ne);return cg(G,$.targetId,he.ba),he.snapshot}(i,P,M,z);const u=await ng(i.localStore,e,!0),h=new lI(e,u.Es),m=h.ga(u.documents),g=La.createSynthesizedTargetChangeForCurrentChange(t,s&&i.onlineState!=="Offline",o),v=h.applyChanges(m,i.isPrimaryClient,g);cg(i,t,v.ba);const w=new uI(e,t,h);return i.xa.set(e,w),i.Oa.has(t)?i.Oa.get(t).push(e):i.Oa.set(t,[e]),v.snapshot}async function mI(i,e,t){const s=Te(i),o=s.xa.get(e),u=s.Oa.get(o.targetId);if(u.length>1)return s.Oa.set(o.targetId,u.filter(h=>!Bu(h,e))),void s.xa.delete(e);s.isPrimaryClient?(s.sharedClientState.removeLocalQueryTarget(o.targetId),s.sharedClientState.isActiveQueryTarget(o.targetId)||await od(s.localStore,o.targetId,!1).then(()=>{s.sharedClientState.clearQueryState(o.targetId),t&&Nd(s.remoteStore,o.targetId),ld(s,o.targetId)}).catch(po)):(ld(s,o.targetId),await od(s.localStore,o.targetId,!0))}async function gI(i,e){const t=Te(i),s=t.xa.get(e),o=t.Oa.get(s.targetId);t.isPrimaryClient&&o.length===1&&(t.sharedClientState.removeLocalQueryTarget(s.targetId),Nd(t.remoteStore,s.targetId))}async function yI(i,e,t){const s=SI(i);try{const o=await function(h,m){const g=Te(h),v=mt.now(),w=m.reduce((z,B)=>z.add(B.key),Ce());let P,M;return g.persistence.runTransaction("Locally write mutations","readwrite",z=>{let B=Ir(),G=Ce();return g.hs.getEntries(z,w).next($=>{B=$,B.forEach((pe,ce)=>{ce.isValidDocument()||(G=G.add(pe))})}).next(()=>g.localDocuments.getOverlayedDocuments(z,B)).next($=>{P=$;const pe=[];for(const ce of m){const te=Vw(ce,P.get(ce.key).overlayedDocument);te!=null&&pe.push(new Ji(ce.key,te,oy(te.value.mapValue),Qn.exists(!0)))}return g.mutationQueue.addMutationBatch(z,v,pe,m)}).next($=>{M=$;const pe=$.applyToLocalDocumentSet(P,G);return g.documentOverlayCache.saveOverlays(z,$.batchId,pe)})}).then(()=>({batchId:M.batchId,changes:_y(P)}))}(s.localStore,e);s.sharedClientState.addPendingMutation(o.batchId),function(h,m,g){let v=h.qa[h.currentUser.toKey()];v||(v=new Ze(Pe)),v=v.insert(m,g),h.qa[h.currentUser.toKey()]=v}(s,o.batchId,t),await ba(s,o.changes),await Qu(s.remoteStore)}catch(o){const u=Ld(o,"Failed to persist write");t.reject(u)}}async function Yy(i,e){const t=Te(i);try{const s=await PT(t.localStore,e);e.targetChanges.forEach((o,u)=>{const h=t.La.get(u);h&&(Ue(o.addedDocuments.size+o.modifiedDocuments.size+o.removedDocuments.size<=1),o.addedDocuments.size>0?h.Fa=!0:o.modifiedDocuments.size>0?Ue(h.Fa):o.removedDocuments.size>0&&(Ue(h.Fa),h.Fa=!1))}),await ba(t,s,e)}catch(s){await po(s)}}function ug(i,e,t){const s=Te(i);if(s.isPrimaryClient&&t===0||!s.isPrimaryClient&&t===1){const o=[];s.xa.forEach((u,h)=>{const m=h.view.ea(e);m.snapshot&&o.push(m.snapshot)}),function(h,m){const g=Te(h);g.onlineState=m;let v=!1;g.queries.forEach((w,P)=>{for(const M of P.J_)M.ea(m)&&(v=!0)}),v&&Md(g)}(s.eventManager,e),o.length&&s.Ma.R_(o),s.onlineState=e,s.isPrimaryClient&&s.sharedClientState.setOnlineState(e)}}async function _I(i,e,t){const s=Te(i);s.sharedClientState.updateQueryState(e,"rejected",t);const o=s.La.get(e),u=o&&o.key;if(u){let h=new Ze(me.comparator);h=h.insert(u,bt.newNoDocument(u,we.min()));const m=Ce().add(u),g=new Wu(we.min(),new Map,new Ze(Pe),h,m);await Yy(s,g),s.Ba=s.Ba.remove(u),s.La.delete(e),bd(s)}else await od(s.localStore,e,!1).then(()=>ld(s,e,t)).catch(po)}async function vI(i,e){const t=Te(i),s=e.batch.batchId;try{const o=await kT(t.localStore,e);Zy(t,s,null),Jy(t,s),t.sharedClientState.updateMutationState(s,"acknowledged"),await ba(t,o)}catch(o){await po(o)}}async function EI(i,e,t){const s=Te(i);try{const o=await function(h,m){const g=Te(h);return g.persistence.runTransaction("Reject batch","readwrite-primary",v=>{let w;return g.mutationQueue.lookupMutationBatch(v,m).next(P=>(Ue(P!==null),w=P.keys(),g.mutationQueue.removeMutationBatch(v,P))).next(()=>g.mutationQueue.performConsistencyCheck(v)).next(()=>g.documentOverlayCache.removeOverlaysForBatchId(v,w,m)).next(()=>g.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(v,w)).next(()=>g.localDocuments.getDocuments(v,w))})}(s.localStore,e);Zy(s,e,t),Jy(s,e),s.sharedClientState.updateMutationState(e,"rejected",t),await ba(s,o)}catch(o){await po(o)}}function Jy(i,e){(i.Qa.get(e)||[]).forEach(t=>{t.resolve()}),i.Qa.delete(e)}function Zy(i,e,t){const s=Te(i);let o=s.qa[s.currentUser.toKey()];if(o){const u=o.get(e);u&&(t?u.reject(t):u.resolve(),o=o.remove(e)),s.qa[s.currentUser.toKey()]=o}}function ld(i,e,t=null){i.sharedClientState.removeLocalQueryTarget(e);for(const s of i.Oa.get(e))i.xa.delete(s),t&&i.Ma.Wa(s,t);i.Oa.delete(e),i.isPrimaryClient&&i.ka.yr(e).forEach(s=>{i.ka.containsKey(s)||e_(i,s)})}function e_(i,e){i.Na.delete(e.path.canonicalString());const t=i.Ba.get(e);t!==null&&(Nd(i.remoteStore,t),i.Ba=i.Ba.remove(e),i.La.delete(t),bd(i))}function cg(i,e,t){for(const s of t)s instanceof Ky?(i.ka.addReference(s.key,e),wI(i,s)):s instanceof Qy?(re("SyncEngine","Document no longer in limbo: "+s.key),i.ka.removeReference(s.key,e),i.ka.containsKey(s.key)||e_(i,s.key)):ve()}function wI(i,e){const t=e.key,s=t.path.canonicalString();i.Ba.get(t)||i.Na.has(s)||(re("SyncEngine","New document in limbo: "+t),i.Na.add(s),bd(i))}function bd(i){for(;i.Na.size>0&&i.Ba.size<i.maxConcurrentLimboResolutions;){const e=i.Na.values().next().value;i.Na.delete(e);const t=new me(Ge.fromString(e)),s=i.Ka.next();i.La.set(s,new cI(t)),i.Ba=i.Ba.insert(t,s),By(i.remoteStore,new ii(Kn(fy(t.path)),s,"TargetPurposeLimboResolution",Uu.oe))}}async function ba(i,e,t){const s=Te(i),o=[],u=[],h=[];s.xa.isEmpty()||(s.xa.forEach((m,g)=>{h.push(s.Ua(g,e,t).then(v=>{var w;if((v||t)&&s.isPrimaryClient){const P=v?!v.fromCache:(w=t==null?void 0:t.targetChanges.get(g.targetId))===null||w===void 0?void 0:w.current;s.sharedClientState.updateQueryState(g.targetId,P?"current":"not-current")}if(v){o.push(v);const P=Pd.zi(g.targetId,v);u.push(P)}}))}),await Promise.all(h),s.Ma.R_(o),await async function(g,v){const w=Te(g);try{await w.persistence.runTransaction("notifyLocalViewChanges","readwrite",P=>q.forEach(v,M=>q.forEach(M.Wi,z=>w.persistence.referenceDelegate.addReference(P,M.targetId,z)).next(()=>q.forEach(M.Gi,z=>w.persistence.referenceDelegate.removeReference(P,M.targetId,z)))))}catch(P){if(!mo(P))throw P;re("LocalStore","Failed to update sequence numbers: "+P)}for(const P of v){const M=P.targetId;if(!P.fromCache){const z=w.us.get(M),B=z.snapshotVersion,G=z.withLastLimboFreeSnapshotVersion(B);w.us=w.us.insert(M,G)}}}(s.localStore,u))}async function TI(i,e){const t=Te(i);if(!t.currentUser.isEqual(e)){re("SyncEngine","User change. New user:",e.toKey());const s=await Fy(t.localStore,e);t.currentUser=e,function(u,h){u.Qa.forEach(m=>{m.forEach(g=>{g.reject(new oe(W.CANCELLED,h))})}),u.Qa.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,s.removedBatchIds,s.addedBatchIds),await ba(t,s.Ts)}}function II(i,e){const t=Te(i),s=t.La.get(e);if(s&&s.Fa)return Ce().add(s.key);{let o=Ce();const u=t.Oa.get(e);if(!u)return o;for(const h of u){const m=t.xa.get(h);o=o.unionWith(m.view.fa)}return o}}function t_(i){const e=Te(i);return e.remoteStore.remoteSyncer.applyRemoteEvent=Yy.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=II.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=_I.bind(null,e),e.Ma.R_=sI.bind(null,e.eventManager),e.Ma.Wa=oI.bind(null,e.eventManager),e}function SI(i){const e=Te(i);return e.remoteStore.remoteSyncer.applySuccessfulWrite=vI.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=EI.bind(null,e),e}class xu{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Gu(e.databaseInfo.databaseId),this.sharedClientState=this.za(e),this.persistence=this.ja(e),await this.persistence.start(),this.localStore=this.Ha(e),this.gcScheduler=this.Ja(e,this.localStore),this.indexBackfillerScheduler=this.Ya(e,this.localStore)}Ja(e,t){return null}Ya(e,t){return null}Ha(e){return CT(this.persistence,new AT,e.initialUser,this.serializer)}ja(e){return new by(kd.ei,this.serializer)}za(e){return new OT}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}xu.provider={build:()=>new xu};class AI extends xu{constructor(e){super(),this.cacheSizeBytes=e}Ja(e,t){Ue(this.persistence.referenceDelegate instanceof Pu);const s=this.persistence.referenceDelegate.garbageCollector;return new cT(s,e.asyncQueue,t)}ja(e){const t=this.cacheSizeBytes!==void 0?Yt.withCacheSize(this.cacheSizeBytes):Yt.DEFAULT;return new by(s=>Pu.ei(s,t),this.serializer)}}class ud{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=s=>ug(this.syncEngine,s,1),this.remoteStore.remoteSyncer.handleCredentialChange=TI.bind(null,this.syncEngine),await eI(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new nI}()}createDatastore(e){const t=Gu(e.databaseInfo.databaseId),s=function(u){return new FT(u)}(e.databaseInfo);return function(u,h,m,g){return new zT(u,h,m,g)}(e.authCredentials,e.appCheckCredentials,s,t)}createRemoteStore(e){return function(s,o,u,h,m){return new $T(s,o,u,h,m)}(this.localStore,this.datastore,e.asyncQueue,t=>ug(this.syncEngine,t,0),function(){return ig.p()?new ig:new LT}())}createSyncEngine(e,t){return function(o,u,h,m,g,v,w){const P=new hI(o,u,h,m,g,v);return w&&(P.$a=!0),P}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(o){const u=Te(o);re("RemoteStore","RemoteStore shutting down."),u.k_.add(5),await Ma(u),u.Q_.shutdown(),u.K_.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}ud.provider={build:()=>new ud};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function i_(i,e,t){if(!t)throw new oe(W.INVALID_ARGUMENT,`Function ${i}() cannot be called with an empty ${e}.`)}function DI(i,e,t,s){if(e===!0&&s===!0)throw new oe(W.INVALID_ARGUMENT,`${i} and ${t} cannot be used together.`)}function fg(i){if(!me.isDocumentKey(i))throw new oe(W.INVALID_ARGUMENT,`Invalid document reference. Document references must have an even number of segments, but ${i} has ${i.length}.`)}function pg(i){if(me.isDocumentKey(i))throw new oe(W.INVALID_ARGUMENT,`Invalid collection reference. Collection references must have an odd number of segments, but ${i} has ${i.length}.`)}function Xu(i){if(i===void 0)return"undefined";if(i===null)return"null";if(typeof i=="string")return i.length>20&&(i=`${i.substring(0,20)}...`),JSON.stringify(i);if(typeof i=="number"||typeof i=="boolean")return""+i;if(typeof i=="object"){if(i instanceof Array)return"an array";{const e=function(s){return s.constructor?s.constructor.name:null}(i);return e?`a custom ${e} object`:"an object"}}return typeof i=="function"?"a function":ve()}function ka(i,e){if("_delegate"in i&&(i=i._delegate),!(i instanceof e)){if(e.name===i.constructor.name)throw new oe(W.INVALID_ARGUMENT,"Type does not match the expected instance. Did you pass a reference from a different Firestore SDK?");{const t=Xu(i);throw new oe(W.INVALID_ARGUMENT,`Expected type '${e.name}', but it was: ${t}`)}}return i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mg{constructor(e){var t,s;if(e.host===void 0){if(e.ssl!==void 0)throw new oe(W.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set");this.host="firestore.googleapis.com",this.ssl=!0}else this.host=e.host,this.ssl=(t=e.ssl)===null||t===void 0||t;if(this.credentials=e.credentials,this.ignoreUndefinedProperties=!!e.ignoreUndefinedProperties,this.localCache=e.localCache,e.cacheSizeBytes===void 0)this.cacheSizeBytes=41943040;else{if(e.cacheSizeBytes!==-1&&e.cacheSizeBytes<1048576)throw new oe(W.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");this.cacheSizeBytes=e.cacheSizeBytes}DI("experimentalForceLongPolling",e.experimentalForceLongPolling,"experimentalAutoDetectLongPolling",e.experimentalAutoDetectLongPolling),this.experimentalForceLongPolling=!!e.experimentalForceLongPolling,this.experimentalForceLongPolling?this.experimentalAutoDetectLongPolling=!1:e.experimentalAutoDetectLongPolling===void 0?this.experimentalAutoDetectLongPolling=!0:this.experimentalAutoDetectLongPolling=!!e.experimentalAutoDetectLongPolling,this.experimentalLongPollingOptions=r_((s=e.experimentalLongPollingOptions)!==null&&s!==void 0?s:{}),function(u){if(u.timeoutSeconds!==void 0){if(isNaN(u.timeoutSeconds))throw new oe(W.INVALID_ARGUMENT,`invalid long polling timeout: ${u.timeoutSeconds} (must not be NaN)`);if(u.timeoutSeconds<5)throw new oe(W.INVALID_ARGUMENT,`invalid long polling timeout: ${u.timeoutSeconds} (minimum allowed value is 5)`);if(u.timeoutSeconds>30)throw new oe(W.INVALID_ARGUMENT,`invalid long polling timeout: ${u.timeoutSeconds} (maximum allowed value is 30)`)}}(this.experimentalLongPollingOptions),this.useFetchStreams=!!e.useFetchStreams}isEqual(e){return this.host===e.host&&this.ssl===e.ssl&&this.credentials===e.credentials&&this.cacheSizeBytes===e.cacheSizeBytes&&this.experimentalForceLongPolling===e.experimentalForceLongPolling&&this.experimentalAutoDetectLongPolling===e.experimentalAutoDetectLongPolling&&function(s,o){return s.timeoutSeconds===o.timeoutSeconds}(this.experimentalLongPollingOptions,e.experimentalLongPollingOptions)&&this.ignoreUndefinedProperties===e.ignoreUndefinedProperties&&this.useFetchStreams===e.useFetchStreams}}class Yu{constructor(e,t,s,o){this._authCredentials=e,this._appCheckCredentials=t,this._databaseId=s,this._app=o,this.type="firestore-lite",this._persistenceKey="(lite)",this._settings=new mg({}),this._settingsFrozen=!1,this._terminateTask="notTerminated"}get app(){if(!this._app)throw new oe(W.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available");return this._app}get _initialized(){return this._settingsFrozen}get _terminated(){return this._terminateTask!=="notTerminated"}_setSettings(e){if(this._settingsFrozen)throw new oe(W.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only modify settings before calling any other methods on a Firestore object.");this._settings=new mg(e),e.credentials!==void 0&&(this._authCredentials=function(s){if(!s)return new jE;switch(s.type){case"firstParty":return new qE(s.sessionIndex||"0",s.iamToken||null,s.authTokenFactory||null);case"provider":return s.client;default:throw new oe(W.INVALID_ARGUMENT,"makeAuthCredentialsProvider failed due to invalid credential type")}}(e.credentials))}_getSettings(){return this._settings}_freezeSettings(){return this._settingsFrozen=!0,this._settings}_delete(){return this._terminateTask==="notTerminated"&&(this._terminateTask=this._terminate()),this._terminateTask}async _restart(){this._terminateTask==="notTerminated"?await this._terminate():this._terminateTask="notTerminated"}toJSON(){return{app:this._app,databaseId:this._databaseId,settings:this._settings}}_terminate(){return function(t){const s=dg.get(t);s&&(re("ComponentProvider","Removing Datastore"),dg.delete(t),s.terminate())}(this),Promise.resolve()}}function VI(i,e,t,s={}){var o;const u=(i=ka(i,Yu))._getSettings(),h=`${e}:${t}`;if(u.host!=="firestore.googleapis.com"&&u.host!==h&&ro("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),i._setSettings(Object.assign(Object.assign({},u),{host:h,ssl:!1})),s.mockUserToken){let m,g;if(typeof s.mockUserToken=="string")m=s.mockUserToken,g=Mt.MOCK_USER;else{m=g0(s.mockUserToken,(o=i._app)===null||o===void 0?void 0:o.options.projectId);const v=s.mockUserToken.sub||s.mockUserToken.user_id;if(!v)throw new oe(W.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");g=new Mt(v)}i._authCredentials=new zE(new ny(m,g))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yo{constructor(e,t,s){this.converter=t,this._query=s,this.type="query",this.firestore=e}withConverter(e){return new yo(this.firestore,e,this._query)}}class yn{constructor(e,t,s){this.converter=t,this._key=s,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new ci(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new yn(this.firestore,e,this._key)}}class ci extends yo{constructor(e,t,s){super(e,t,fy(s)),this._path=s,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new yn(this.firestore,null,new me(e))}withConverter(e){return new ci(this.firestore,e,this._path)}}function Pa(i,e,...t){if(i=_n(i),i_("collection","path",e),i instanceof Yu){const s=Ge.fromString(e,...t);return pg(s),new ci(i,null,s)}{if(!(i instanceof yn||i instanceof ci))throw new oe(W.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=i._path.child(Ge.fromString(e,...t));return pg(s),new ci(i.firestore,null,s)}}function s_(i,e,...t){if(i=_n(i),arguments.length===1&&(e=ry.newId()),i_("doc","path",e),i instanceof Yu){const s=Ge.fromString(e,...t);return fg(s),new yn(i,null,new me(s))}{if(!(i instanceof yn||i instanceof ci))throw new oe(W.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const s=i._path.child(Ge.fromString(e,...t));return fg(s),new yn(i.firestore,i instanceof ci?i.converter:null,new me(s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uo{constructor(e){this._byteString=e}static fromBase64String(e){try{return new uo(Nt.fromBase64String(e))}catch(t){throw new oe(W.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new uo(Nt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fd{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new oe(W.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Pt(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ud{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new oe(W.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new oe(W.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return Pe(this._lat,e._lat)||Pe(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function HI(i){if(i.limitType==="L"&&i.explicitOrderBy.length===0)throw new oe(W.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class qd{}class WI extends qd{}function Hd(i,e,...t){let s=[];e instanceof qd&&s.push(e),s=s.concat(t),function(u){const h=u.filter(g=>g instanceof Gd).length,m=u.filter(g=>g instanceof Zu).length;if(h>1||h>0&&m>0)throw new oe(W.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(s);for(const o of s)i=o._apply(i);return i}class Zu extends WI{constructor(e,t,s){super(),this._field=e,this._op=t,this._value=s,this.type="where"}static _create(e,t,s){return new Zu(e,t,s)}_apply(e){const t=this._parse(e);return m_(e._query,t),new yo(e.firestore,e.converter,ed(e._query,t))}_parse(e){const t=u_(e.firestore);return function(u,h,m,g,v,w,P){let M;if(v.isKeyField()){if(w==="array-contains"||w==="array-contains-any")throw new oe(W.INVALID_ARGUMENT,`Invalid Query. You can't perform '${w}' queries on documentId().`);if(w==="in"||w==="not-in"){_g(P,w);const z=[];for(const B of P)z.push(yg(g,u,B));M={arrayValue:{values:z}}}else M=yg(g,u,P)}else w!=="in"&&w!=="not-in"&&w!=="array-contains-any"||_g(P,w),M=jI(m,h,P,w==="in"||w==="not-in");return ut.create(v,w,M)}(e._query,"where",t,e.firestore._databaseId,this._field,this._op,this._value)}}function Wd(i,e,t){const s=e,o=$d("where",i);return Zu._create(o,s,t)}class Gd extends qd{constructor(e,t){super(),this.type=e,this._queryConstraints=t}static _create(e,t){return new Gd(e,t)}_parse(e){const t=this._queryConstraints.map(s=>s._parse(e)).filter(s=>s.getFilters().length>0);return t.length===1?t[0]:Ln.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return t.getFilters().length===0?e:(function(o,u){let h=o;const m=u.getFlattenedFilters();for(const g of m)m_(h,g),h=ed(h,g)}(e._query,t),new yo(e.firestore,e.converter,ed(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}function yg(i,e,t){if(typeof(t=_n(t))=="string"){if(t==="")throw new oe(W.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!py(e)&&t.indexOf("/")!==-1)throw new oe(W.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${t}' contains a '/' character.`);const s=e.path.child(Ge.fromString(t));if(!me.isDocumentKey(s))throw new oe(W.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);return Fm(i,new me(s))}if(t instanceof yn)return Fm(i,t._key);throw new oe(W.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Xu(t)}.`)}function _g(i,e){if(!Array.isArray(i)||i.length===0)throw new oe(W.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`)}function m_(i,e){const t=function(o,u){for(const h of o)for(const m of h.getFlattenedFilters())if(u.indexOf(m.op)>=0)return m.op;return null}(i.filters,function(o){switch(o){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(e.op));if(t!==null)throw t===e.op?new oe(W.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new oe(W.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${t.toString()}' filters.`)}class GI{convertValue(e,t="none"){switch(pi(e)){case 0:return null;case 1:return e.booleanValue;case 2:return rt(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes(fi(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 11:return this.convertObject(e.mapValue,t);case 10:return this.convertVectorValue(e.mapValue);default:throw ve()}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){const s={};return Xi(e,(o,u)=>{s[o]=this.convertValue(u,t)}),s}convertVectorValue(e){var t,s,o;const u=(o=(s=(t=e.fields)===null||t===void 0?void 0:t.value.arrayValue)===null||s===void 0?void 0:s.values)===null||o===void 0?void 0:o.map(h=>rt(h.doubleValue));return new jd(u)}convertGeoPoint(e){return new Ud(rt(e.latitude),rt(e.longitude))}convertArray(e,t){return(e.values||[]).map(s=>this.convertValue(s,t))}convertServerTimestamp(e,t){switch(t){case"previous":const s=zu(e);return s==null?null:this.convertValue(s,t);case"estimate":return this.convertTimestamp(Ia(e));default:return null}}convertTimestamp(e){const t=di(e);return new mt(t.seconds,t.nanos)}convertDocumentKey(e,t){const s=Ge.fromString(e);Ue(My(s));const o=new Sa(s.get(1),s.get(3)),u=new me(s.popFirst(5));return o.isEqual(t)||Tr(`Document ${u} contains a document reference within a different database (${o.projectId}/${o.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),u}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yu(i,e,t){return`firebase:${i}:${e}:${t}`}class Zs{constructor(e,t,s){this.persistence=e,this.auth=t,this.userKey=s;const{config:o,name:u}=this.auth;this.fullUserKey=yu(this.userKey,o.apiKey,u),this.fullPersistenceKey=yu("persistence",o.apiKey,u),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?vr._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,s="authUser"){if(!t.length)return new Zs(Er(Tg),e,s);const o=(await Promise.all(t.map(async v=>{if(await v._isAvailable())return v}))).filter(v=>v);let u=o[0]||Er(Tg);const h=yu(s,e.config.apiKey,e.name);let m=null;for(const v of t)try{const w=await v._get(h);if(w){const P=vr._fromJSON(e,w);v!==u&&(m=P),u=v;break}}catch{}const g=o.filter(v=>v._shouldAllowMigration);return!u._shouldAllowMigration||!g.length?new Zs(u,e,s):(u=g[0],m&&await u._set(h,m.toJSON()),await Promise.all(t.map(async v=>{if(v!==u)try{await v._remove(h)}catch{}})),new Zs(u,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KS=5*60,QS=$g("authIdTokenMaxAge")||KS;let Lg=null;const XS=i=>async e=>{const t=e&&await e.getIdTokenResult(),s=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(s&&s>QS)return;const o=t==null?void 0:t.token;Lg!==o&&(Lg=o,await fetch(i,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function YS(i=Gg()){const e=gd(i,"auth");if(e.isInitialized())return e.getImmediate();const t=N1(i,{popupRedirectResolver:qS,persistence:[tS,$1,$_]}),s=$g("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const u=new URL(s,location.origin);if(location.origin===u.origin){const h=XS(u.toString());j1(t,h,()=>h(t.currentUser)),U1(t,m=>h(m))}}const o=zg("auth");return o&&D1(t,`http://${o}`),t}function JS(){var i,e;return(e=(i=document.getElementsByTagName("head"))===null||i===void 0?void 0:i[0])!==null&&e!==void 0?e:document}R1({loadJS(i){return new Promise((e,t)=>{const s=document.createElement("script");s.setAttribute("src",i),s.onload=e,s.onerror=o=>{const u=Yn("internal-error");u.customData=o,t(u)},s.type="text/javascript",s.charset="UTF-8",JS().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});GS("Browser");const ZS={apiKey:"AIzaSyC70tn1M08W6TSHahhfTIuPBw-lUUtj-EU",authDomain:"calculadora-horarios-v2.firebaseapp.com",projectId:"calculadora-horarios-v2",storageBucket:"calculadora-horarios-v2.firebasestorage.app",messagingSenderId:"217559594958",appId:"1:217559594958:web:9293409f4f344a7201dd9f",measurementId:"G-Y5XBNRSB4Z"},eA=Wg(ZS);YS();const to=OI(eA);function tA(i){const[e,t]=lt.useState(!1),[s,o]=lt.useState(!1),u=async h=>{h.preventDefault();const m=document.querySelector("#login-email"),g=document.querySelector("#login-senha"),v=Hd(Pa(to,"usuario"),Wd("email","==",m.value)),w=await Kd(v);if(w.empty){t(!0);return}else t(!1);for(const P of w.docs){if(P.data().senha!==g.value){o(!0);return}else o(!1);const M=P.data().nome;i.getUsuNome(M),i.getEmail(m.value)}i.onConfirm()};return j.jsx(j.Fragment,{children:j.jsx("div",{className:"modal show d-block",tabIndex:-1,style:{backgroundColor:"rgba(0, 0, 0, 0.5)"},children:j.jsx("form",{onSubmit:u,children:j.jsx("div",{className:"modal-dialog",children:j.jsxs("div",{className:"modal-content",children:[j.jsxs("div",{className:"modal-header",children:[j.jsx("h5",{className:"modal-title",children:"Login"}),e&&j.jsxs("div",{className:"warning",children:[j.jsx("img",{src:"/assets/warning-sign-9769.svg"}),j.jsx("p",{style:{paddingRight:"5px",paddingLeft:"5px",display:"flex",alignContent:"center",margin:"auto"},children:"Email não cadastrado!"})]}),!e&&s&&j.jsxs("div",{className:"warning",children:[j.jsx("img",{src:"/assets/warning-sign-9769.svg"}),j.jsx("p",{style:{paddingLeft:"5px",display:"flex",alignContent:"center",margin:"auto"},children:"Senha incorreta!"})]}),j.jsx("button",{type:"button",className:"btn-close","aria-label":"Close",onClick:i.onClose})]}),j.jsxs("div",{className:"modal-body",style:{display:"grid"},children:[j.jsxs("div",{style:{display:"grid"},children:[j.jsx("label",{htmlFor:"email",className:"mb-2",children:"Digite seu email:"}),j.jsx("input",{id:"login-email",name:"email",type:"email",placeholder:"Email",className:"form-control mb-3",required:!0})]}),j.jsxs("div",{style:{display:"grid"},children:[j.jsx("label",{htmlFor:"senha",className:"mb-2",children:"Digite sua senha:"}),j.jsx("input",{id:"login-senha",name:"senha",type:"password",placeholder:"Senha",className:"form-control mb-3",required:!0})]})]}),j.jsxs("div",{className:"modal-footer",children:[j.jsx("button",{type:"button",className:"btn btn-secondary",onClick:i.onClose,children:"Cancelar"}),j.jsx("button",{type:"submit",className:"btn btn-primary",children:"Fazer Login"})]})]})})})})})}function nA(i){const[e,t]=lt.useState(!1),[s,o]=lt.useState(!1),u=async h=>{h.preventDefault();const m=document.querySelector("#cadastro-nome"),g=document.querySelector("#cadastro-email"),v=document.querySelector("#cadastro-senha"),w=document.querySelector("#cadastro-confSenha"),P=Hd(Pa(to,"usuario"),Wd("email","==",g.value));if((await Kd(P)).empty)o(!1);else{o(!0);return}if(w.value!==v.value){t(!0);return}else t(!1);try{await g_(Pa(to,"usuario"),{nome:(m==null?void 0:m.value)??"",email:(g==null?void 0:g.value)??"",senha:(v==null?void 0:v.value)??""})}catch(z){console.log(z)}i.onConfirm()};return j.jsx(j.Fragment,{children:j.jsx("div",{className:"modal show d-block",tabIndex:-1,style:{backgroundColor:"rgba(0, 0, 0, 0.5)"},children:j.jsx("form",{onSubmit:u,children:j.jsx("div",{className:"modal-dialog",children:j.jsxs("div",{className:"modal-content",children:[j.jsxs("div",{className:"modal-header",children:[j.jsx("h5",{className:"modal-title",children:"Cadastro"}),e&&j.jsxs("div",{className:"warning",children:[j.jsx("img",{src:"/assets/warning-sign-9769.svg"}),j.jsx("p",{style:{paddingRight:"5px",paddingLeft:"5px",display:"flex",alignContent:"center",margin:"auto"},children:"Senhas diferentes!"})]}),s&&j.jsxs("div",{className:"warning",children:[j.jsx("img",{src:"/assets/warning-sign-9769.svg"}),j.jsx("p",{style:{paddingRight:"5px",paddingLeft:"5px",display:"flex",alignContent:"center",margin:"auto"},children:"Email já cadastrado!"})]}),j.jsx("button",{type:"button",className:"btn-close","aria-label":"Close",onClick:i.onClose})]}),j.jsxs("div",{className:"modal-body",style:{display:"grid"},children:[j.jsxs("div",{style:{display:"grid"},children:[j.jsx("label",{htmlFor:"Nome",className:"mb-2",children:"Digite seu Nome:"}),j.jsx("input",{id:"cadastro-nome",name:"nome",type:"name",placeholder:"Nome de Usuário",className:"form-control mb-3",required:!0,minLength:3})]}),j.jsxs("div",{style:{display:"grid"},children:[j.jsx("label",{htmlFor:"email",className:"mb-2",children:"Digite seu email:"}),j.jsx("input",{id:"cadastro-email",name:"email",type:"email",placeholder:"Email",className:"form-control mb-3",required:!0})]}),j.jsxs("div",{style:{display:"grid"},children:[j.jsx("label",{htmlFor:"senha",className:"mb-2",children:"Digite sua senha:"}),j.jsx("input",{id:"cadastro-senha",name:"senha",type:"password",placeholder:"Senha",className:"form-control mb-3",required:!0,minLength:8})]}),j.jsxs("div",{style:{display:"grid"},children:[j.jsx("label",{htmlFor:"confSenha",className:"mb-2",children:"Confirme sua senha:"}),j.jsx("input",{id:"cadastro-confSenha",name:"confSenha",type:"password",placeholder:"Confirme sua Senha",className:"form-control mb-3",required:!0,minLength:8})]})]}),j.jsxs("div",{className:"modal-footer",children:[j.jsx("button",{type:"button",className:"btn btn-secondary",onClick:i.onClose,children:"Cancelar"}),j.jsx("button",{type:"submit",className:"btn btn-primary",children:"Fazer Cadastro"})]})]})})})})})}function rA(i){let e=0;for(let s=0;s<i.length;s++)e=i.charCodeAt(s)+((e<<5)-e);let t="#";for(let s=0;s<3;s++){const o=e>>s*8&255;t+=("00"+o.toString(16)).substr(-2)}return t}function iA(i){var h;const e=`${((h=i.nome[0])==null?void 0:h.toUpperCase())??""}`,t=rA(i.nome),s=()=>{u(!o)};let[o,u]=lt.useState(!1);return j.jsxs(j.Fragment,{children:[j.jsx("div",{className:"profile-image",style:{backgroundColor:t},onClick:s,children:e}),o&&j.jsxs("div",{style:{backgroundColor:"white",width:"200px",borderRadius:"5px",zIndex:"1",position:"absolute",border:"1px solid #333"},children:[j.jsx("div",{style:{borderBottom:"2px solid #ccc",paddingBottom:"5px"},children:j.jsxs("p",{style:{color:"black",paddingLeft:"12px",paddingTop:"5px",marginBottom:"0",overflow:"hidden"},children:["Olá, ",i.nome]})}),j.jsxs("button",{className:"btn",type:"button",onClick:i.isLogado,style:{display:"flex",width:"100%",justifyContent:"space-between",color:"black",border:"none"},children:["Sair",j.jsx("img",{src:"/assets/exit-svgrepo-com.svg"})]})]})]})}function sA(i){let[e,t]=lt.useState("00:00"),[s,o]=lt.useState(""),[u,h]=lt.useState(!1);const m=()=>h(!0),g=()=>h(!1);let[v,w]=lt.useState(!1);const P=()=>{i.onLogin(he),w(!0),h(!1)};let[M,z]=lt.useState(!1);const B=()=>z(!0),G=()=>z(!1),$=()=>{i.onCadastro(),z(!1)},pe=R=>{t(R.target.value)},ce=R=>{o(R.target.value)},te=()=>{w(!1),k(""),i.getEmail(""),i.setTotalHoras("0"),i.setTotalMinutos("0")};let[fe,Ne]=lt.useState(""),[he,k]=lt.useState("");function T(R){Ne(R)}function A(R){k(R),i.getEmail(R)}return j.jsxs(j.Fragment,{children:[j.jsxs("div",{className:"text-bg-success p-4",style:{display:"grid",gridTemplateColumns:"1fr auto 1fr",margin:"auto",justifyContent:"space-between",alignItems:"center",position:"relative"},children:[j.jsx("div",{children:v&&j.jsx("div",{style:{alignContent:"center"},children:j.jsx(iA,{nome:fe,isLogado:te})})}),j.jsx("h2",{style:{padding:"20px",textAlign:"center",justifySelf:"center"},children:"Calculadora de Horários:"}),j.jsxs("div",{style:{display:"flex",gap:"10px",alignItems:"flex-end",flexDirection:"column"},children:[!v&&j.jsx("button",{type:"button",className:"btn btn-light",style:{width:"100px"},onClick:m,children:"Login"}),!v&&j.jsx("button",{type:"button",className:"btn btn-primary",style:{width:"100px"},onClick:B,children:"Cadastro"})]})]}),j.jsxs("form",{onSubmit:R=>{R.preventDefault();let x=new Date,D=document.querySelector("#observacao"),S=(D==null?void 0:D.value)??"",Xe=x.toLocaleDateString(),yt=x.toLocaleTimeString(),it=parseInt(e.slice(0,e.indexOf(":"))),Le=parseInt(e.slice(e.indexOf(":")+1)),Z="",ue="";it<10?Z="0"+String(it):Z=String(it),Le<10?ue="0"+String(Le):ue=String(Le),i.onButtonClick(S,he,Xe,yt,Z,ue),t("00:00"),o("")},children:[j.jsx("div",{className:"d-block",style:{width:"300px",margin:"auto"},children:j.jsxs("div",{className:"text-center input-group my-3",children:[j.jsx("span",{className:"input-group-text",id:"basic-addon1",children:"Descrição:"}),j.jsx("input",{type:"text",className:"form-control",id:"observacao",placeholder:"Descrição",value:s,onChange:ce})]})}),j.jsxs("div",{className:"d-block mb-5",style:{width:"300px",margin:"auto"},children:[j.jsxs("div",{className:"text-center input-group my-3",children:[j.jsx("span",{className:"input-group-text",id:"basic-addon1",children:"Digite o tempo:"}),j.jsx("input",{type:"time",className:"form-control",id:"EntradaHorario",onChange:pe,value:e,required:!0})]}),j.jsx("div",{children:j.jsx("button",{type:"submit",className:" btn text-bg-primary",style:{width:"300px",margin:"auto"},children:"Enviar"})})]})]}),u&&j.jsx(tA,{getEmail:A,getUsuNome:T,onClose:g,onConfirm:P}),M&&j.jsx(nA,{onClose:G,onConfirm:$})]})}function oA(i){return j.jsx("div",{className:"modal show d-block",tabIndex:-1,style:{backgroundColor:"rgba(0, 0, 0, 0.5)"},children:j.jsx("div",{className:"modal-dialog",children:j.jsxs("div",{className:"modal-content",children:[j.jsxs("div",{className:"modal-header",children:[j.jsx("h5",{className:"modal-title",children:"Confirma Exclusão?"}),j.jsx("button",{type:"button",className:"btn-close","aria-label":"Close",onClick:i.onClose})]}),j.jsx("div",{className:"modal-body",children:j.jsx("p",{children:"Certeza que quer excluir este horário?"})}),j.jsxs("div",{className:"modal-footer",children:[j.jsx("button",{type:"button",className:"btn btn-secondary",onClick:i.onClose,children:"Fechar"}),j.jsx("button",{type:"button",className:"btn btn-primary",onClick:i.onConfirm,children:"Excluir"})]})]})})})}function Mg(i){const[e,t]=lt.useState(!1),s=()=>t(!0),o=()=>t(!1),u=()=>{i.onRemove(),t(!1)};return j.jsxs(j.Fragment,{children:[j.jsxs("div",{className:"rounded d-block",style:{width:"300px",margin:"auto",marginBottom:"20px"},children:[j.jsxs("div",{className:"rounded-top p-2 d-flex text-bg-primary justify-content-between",style:{width:"300px",margin:"auto"},children:[j.jsx("p",{style:{marginBottom:"0px"},children:String(i.observacaoAdicionada).length>0?`${i.observacaoAdicionada}:`:"Horário adicionado:"}),j.jsx("button",{type:"button",className:"btn-close","aria-label":"Close",onClick:s})]}),j.jsxs("div",{className:"px-2  rounded-bottom border border-primary",children:[j.jsxs("span",{children:[i.newHora,":",i.newMinuto]}),j.jsxs("p",{style:{fontSize:"12px",marginBottom:"2px"},children:["Data: ",i.addedDate]}),j.jsxs("p",{style:{fontSize:"12px",marginBottom:"2px"},children:["Hora: ",i.addedTime]})]})]}),e&&j.jsx(oA,{onClose:o,onConfirm:u})]})}function bg(i){return j.jsx(j.Fragment,{children:j.jsxs("div",{className:"text-center rounded border border-success",style:{width:"300px",margin:"auto"},children:[j.jsx("h3",{className:"text-bg-success p-3 rounded-top",children:"Total de horas:"}),j.jsxs("p",{children:[parseInt(i.totalHoras)<10?"0"+i.totalHoras:i.totalHoras,":",parseInt(i.totalMinutos)<10?"0"+i.totalMinutos:i.totalMinutos]})]})})}function aA(){const[i,e]=lt.useState([]),[t,s]=lt.useState(""),[o,u]=lt.useState(""),[h,m]=lt.useState(""),g=window.innerWidth,v=B=>{m(B)};lt.useEffect(()=>{e([])},[h]);const w=async B=>{if(B){s("0"),u("0");try{const G=Hd(Pa(to,"horario"),Wd("email","==",B)),$=await Kd(G),pe=new Date,ce=$.docs.map(he=>{const k=he.data();return{id:he.id,email:B,observacao:k.observacao??"",date:k.date??"",time:k.time??"",hora:k.hora??"",minuto:k.minuto??""}}).filter(he=>{if(!he.date)return!1;const[k,T,A]=he.date.split("/"),R=`${A}-${T}-${k}`,x=new Date(R);return x.getFullYear()===pe.getFullYear()&&x.getMonth()===pe.getMonth()});e(ce);let te=0,fe=0;ce.forEach(he=>{te+=parseInt(he.minuto),fe+=parseInt(he.hora)});const Ne=Math.floor(te/60);fe+=Ne,te=te%60,s(String(fe)),u(String(te))}catch(G){console.error("Erro ao buscar horários:",G)}}};lt.useEffect(()=>{w(h)},[h]);const P=async(B,G,$,pe,ce,te)=>{if((ce!=="00"||te!=="00")&&!isNaN(parseInt(ce))&&!isNaN(parseInt(te)))try{if(G){const x=await g_(Pa(to,"horario"),{observacao:B??"",email:G??"",date:$??"",time:pe??"",hora:ce??"",minuto:te??""});e(D=>[...D,{id:x.id,observacao:B,email:G,date:$,time:pe,hora:ce,minuto:te}])}else e(x=>[...x,{id:"",observacao:B,email:G,date:$,time:pe,hora:ce,minuto:te}]);const fe=o===""?0:parseInt(o),Ne=t===""?0:parseInt(t),he=parseInt(te),k=parseInt(ce);let T=fe+he,A=Ne+k;const R=Math.floor(T/60);A+=R,T=T%60,u(String(T)),s(String(A))}catch(fe){console.error("Erro ao adicionar horário:",fe)}},M=()=>{},z=async B=>{try{const G=i[B];if(!G||!G.id){e(he=>he.filter((k,T)=>T!==B));let te=0,fe=0;i.forEach((he,k)=>{k!==B&&(te+=parseInt(he.minuto),fe+=parseInt(he.hora))});const Ne=Math.floor(te/60);fe+=Ne,te=te%60,s(String(fe)),u(String(te));return}await ZI(s_(to,"horario",G.id)),e(te=>te.filter((fe,Ne)=>Ne!==B));let $=0,pe=0;i.forEach((te,fe)=>{fe!==B&&($+=parseInt(te.minuto),pe+=parseInt(te.hora))});const ce=Math.floor($/60);pe+=ce,$=$%60,s(String(pe)),u(String($))}catch(G){console.error("Erro ao remover horário:",G)}};return j.jsxs(j.Fragment,{children:[j.jsx(sA,{getEmail:v,onButtonClick:P,onLogin:w,onCadastro:M,setTotalHoras:s,setTotalMinutos:u}),g>=700&&i.length>0?j.jsxs("div",{className:"row",children:[j.jsx("div",{className:"col",children:i.map((B,G)=>j.jsx(Mg,{observacaoAdicionada:B.observacao,addedDate:B.date,addedTime:B.time,newHora:B.hora,newMinuto:B.minuto,onRemove:()=>z(G)},G))}),j.jsx("div",{className:"col",children:j.jsx(bg,{totalHoras:t===""?"0":t,totalMinutos:o===""?"0":o})})]}):j.jsxs("div",{children:[i.map((B,G)=>j.jsx(Mg,{observacaoAdicionada:B.observacao,addedDate:B.date,addedTime:B.time,newHora:B.hora,newMinuto:B.minuto,onRemove:()=>z(G)},G)),j.jsx(bg,{totalHoras:t===""?"0":t,totalMinutos:o===""?"0":o})]})]})}o0.createRoot(document.getElementById("root")).render(j.jsx(lt.StrictMode,{children:j.jsx(aA,{})}));
