 ...
 */var fm;function Jv(){if(fm)return Re;fm=1;var i=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),h=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),k=Symbol.iterator;function M(V){return V===null||typeof V!="object"?null:(V=k&&V[k]||V["@@iterator"],typeof V=="function"?V:null)}var B={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Q=Object.assign,Y={};function z(V,q,fe){this.props=V,this.context=q,this.refs=Y,this.updater=fe||B}z.prototype.isReactComponent={},z.prototype.setState=function(V,q){if(typeof V!="object"&&typeof V!="function"&&V!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,V,q,"setState")},z.prototype.forceUpdate=function(V){this.updater.enqueueForceUpdate(this,V,"forceUpdate")};function ee(){}ee.prototype=z.prototype;function le(V,q,fe){this.props=V,this.context=q,this.refs=Y,this.updater=fe||B}var he=le.prototype=new ee;he.constructor=le,Q(he,z.prototype),he.isPureReactComponent=!0;var pe=Array.isArray,me=Object.prototype.hasOwnProperty,ue={current:null},P={key:!0,ref:!0,__self:!0,__source:!0};function T(V,q,fe){var Se,Ae={},xe=null,be=null;if(q!=null)for(Se in q.ref!==void 0&&(be=q.ref),q.key!==void 0&&(xe=""+q.key),q)me.call(q,Se)&&!P.hasOwnProperty(Se)&&(Ae[Se]=q[Se]);var Fe=arguments.length-2;if(Fe===1)Ae.children=fe;else if(1<Fe){for(var Be=Array(Fe),_t=0;_t<Fe;_t++)Be[_t]=arguments[_t+2];Ae.children=Be}if(V&&V.defaultProps)for(Se in Fe=V.defaultProps,Fe)Ae[Se]===void 0&&(Ae[Se]=Fe[Se]);return{$$typeof:i,type:V,key:xe,ref:be,props:Ae,_owner:ue.current}}function S(V,q){return{$$typeof:i,type:V.type,key:q,ref:V.ref,props:V.props,_owner:V._owner}}function R(V){return typeof V=="object"&&V!==null&&V.$$typeof===i}function x(V){var q={"=":"=0",":":"=2"};return"$"+V.replace(/[=:]/g,function(fe){return q[fe]})}var D=/\/+/g;function A(V,q){return typeof V=="object"&&V!==null&&V.key!=null?x(""+V.key):q.toString(36)}function We(V,q,fe,Se,Ae){var xe=typeof V;(xe==="undefined"||xe==="boolean")&&(V=null);var be=!1;if(V===null)be=!0;else switch(xe){case"string":case"number":be=!0;break;case"object":switch(V.$$typeof){case i:case e:be=!0}}if(be)return be=V,Ae=Ae(be),V=Se===""?"."+A(be,0):Se,pe(Ae)?(fe="",V!=null&&(fe=V.replace(D,"$&/")+"/"),We(Ae,q,fe,"",function(_t){return _t})):Ae!=null&&(R(Ae)&&(Ae=S(Ae,fe+(!Ae.key||be&&be.key===Ae.key?"":(""+Ae.key).replace(D,"$&/")+"/")+V)),q.push(Ae)),1;if(be=0,Se=Se===""?".":Se+":",pe(V))for(var Fe=0;Fe<V.length;Fe++){xe=V[Fe];var Be=Se+A(xe,Fe);be+=We(xe,q,fe,Be,Ae)}else if(Be=M(V),typeof Be=="function")for(V=Be.call(V),Fe=0;!(xe=V.next()).done;)xe=xe.value,Be=Se+A(xe,Fe++),be+=We(xe,q,fe,Be,Ae);else if(xe==="object")throw q=String(V),Error("Objects are not valid as a React child (found: "+(q==="[object Object]"?"object with keys {"+Object.keys(V).join(", ")+"}":q)+"). If you meant to render a collection of children, use an array instead.");return be}function yt(V,q,fe){if(V==null)return V;var Se=[],Ae=0;return We(V,Se,"","",function(xe){return q.call(fe,xe,Ae++)}),Se}function st(V){if(V._status===-1){var q=V._result;q=q(),q.then(function(fe){(V._status===0||V._status===-1)&&(V._status=1,V._result=fe)},function(fe){(V._status===0||V._status===-1)&&(V._status=2,V._result=fe)}),V._status===-1&&(V._status=0,V._result=q)}if(V._status===1)return V._result.default;throw V._result}var Le={current:null},Z={transition:null},de={ReactCurrentDispatcher:Le,ReactCurrentBatchConfig:Z,ReactCurrentOwner:ue};function ne(){throw Error("act(...) is not supported in production builds of React.")}return Re.Children={map:yt,forEach:function(V,q,fe){yt(V,function(){q.apply(this,arguments)},fe)},count:function(V){var q=0;return yt(V,function(){q++}),q},toArray:function(V){return yt(V,function(q){return q})||[]},only:function(V){if(!R(V))throw Error("React.Children.only expected to receive a single React element child.");return V}},Re.Component=z,Re.Fragment=t,Re.Profiler=o,Re.PureComponent=le,Re.StrictMode=s,Re.Suspense=g,Re.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=de,Re.act=ne,Re.cloneElement=function(V,q,fe){if(V==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+V+".");var Se=Q({},V.props),Ae=V.key,xe=V.ref,be=V._owner;if(q!=null){if(q.ref!==void 0&&(xe=q.ref,be=ue.current),q.key!==void 0&&(Ae=""+q.key),V.type&&V.type.defaultProps)var Fe=V.type.defaultProps;for(Be in q)me.call(q,Be)&&!P.hasOwnProperty(Be)&&(Se[Be]=q[Be]===void 0&&Fe!==void 0?Fe[Be]:q[Be])}var Be=arguments.length-2;if(Be===1)Se.children=fe;else if(1<Be){Fe=Array(Be);for(var _t=0;_t<Be;_t++)Fe[_t]=arguments[_t+2];Se.children=Fe}return{$$typeof:i,type:V.type,key:Ae,ref:xe,props:Se,_owner:be}},Re.createContext=function(V){return V={$$typeof:h,_currentValue:V,_currentValue2:V,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},V.Provider={$$typeof:u,_context:V},V.Consumer=V},Re.createElement=T,Re.createFactory=function(V){var q=T.bind(null,V);return q.type=V,q},Re.createRef=function(){return{current:null}},Re.forwardRef=function(V){return{$$typeof:m,render:V}},Re.isValidElement=R,Re.lazy=function(V){return{$$typeof:w,_payload:{_status:-1,_result:V},_init:st}},Re.memo=function(V,q){return{$$typeof:v,type:V,compare:q===void 0?null:q}},Re.startTransition=function(V){var q=Z.transition;Z.transition={};try{V()}finally{Z.transition=q}},Re.unstable_act=ne,Re.useCallback=function(V,q){return Le.current.useCallback(V,q)},Re.useContext=function(V){return Le.current.useContext(V)},Re.useDebugValue=function(){},Re.useDeferredValue=function(V){return Le.current.useDeferredValue(V)},Re.useEffect=function(V,q){return Le.current.useEffect(V,q)},Re.useId=function(){return Le.current.useId()},Re.useImperativeHandle=function(V,q,fe){return Le.current.useImperativeHandle(V,q,fe)},Re.useInsertionEffect=function(V,q){return Le.current.useInsertionEffect(V,q)},Re.useLayoutEffect=function(V,q){return Le.current.useLayoutEffect(V,q)},Re.useMemo=function(V,q){return Le.current.useMemo(V,q)},Re.useReducer=function(V,q,fe){return Le.current.useReducer(V,q,fe)},Re.useRef=function(V){return Le.current.useRef(V)},Re.useState=function(V){return Le.current.useState(V)},Re.useSyncExternalStore=function(V,q,fe){return Le.current.useSyncExternalStore(V,q,fe)},Re.useTransition=function(){return Le.current.useTransition()},Re.version="18.3.1",Re}var pm;function yd(){return pm||(pm=1,Dh.exports=Jv()),Dh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var mm;function Zv(){if(mm)return pa;mm=1;var i=yd(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,o=i.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,u={key:!0,ref:!0,__self:!0,__source:!0};function h(m,g,v){var w,k={},M=null,B=null;v!==void 0&&(M=""+v),g.key!==void 0&&(M=""+g.key),g.ref!==void 0&&(B=g.ref);for(w in g)s.call(g,w)&&!u.hasOwnProperty(w)&&(k[w]=g[w]);if(m&&m.defaultProps)for(w in g=m.defaultProps,g)k[w]===void 0&&(k[w]=g[w]);return{$$typeof:e,type:m,key:M,ref:B,props:k,_owner:o.current}}return pa.Fragment=t,pa.jsx=h,pa.jsxs=h,pa}var gm;function e0(){return gm||(gm=1,xh.exports=Zv()),xh.exports}var b=e0(),He=yd(),nu={},Vh={exports:{}},Xt={},Oh={exports:{}},Lh={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ym;function t0(){return ym||(ym=1,function(i){function e(Z,de){var ne=Z.length;Z.push(de);e:for(;0<ne;){var V=ne-1>>>1,q=Z[V];if(0<o(q,de))Z[V]=de,Z[ne]=q,ne=V;else break e}}function t(Z){return Z.length===0?null:Z[0]}function s(Z){if(Z.length===0)return null;var de=Z[0],ne=Z.pop();if(ne!==de){Z[0]=ne;e:for(var V=0,q=Z.length,fe=q>>>1;V<fe;){var Se=2*(V+1)-1,Ae=Z[Se],xe=Se+1,be=Z[xe];if(0>o(Ae,ne))xe<q&&0>o(be,Ae)?(Z[V]=be,Z[xe]=ne,V=xe):(Z[V]=Ae,Z[Se]=ne,V=Se);else if(xe<q&&0>o(be,ne))Z[V]=be,Z[xe]=ne,V=xe;else break e}}return de}function o(Z,de){var ne=Z.sortIndex-de.sortIndex;return ne!==0?ne:Z.id-de.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;i.unstable_now=function(){return u.now()}}else{var h=Date,m=h.now();i.unstable_now=function(){return h.now()-m}}var g=[],v=[],w=1,k=null,M=3,B=!1,Q=!1,Y=!1,z=typeof setTimeout=="function"?setTimeout:null,ee=typeof clearTimeout=="function"?clearTimeout:null,le=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function he(Z){for(var de=t(v);de!==null;){if(de.callback===null)s(v);else if(de.startTime<=Z)s(v),de.sortIndex=de.expirationTime,e(g,de);else break;de=t(v)}}function pe(Z){if(Y=!1,he(Z),!Q)if(t(g)!==null)Q=!0,st(me);else{var de=t(v);de!==null&&Le(pe,de.startTime-Z)}}function me(Z,de){Q=!1,Y&&(Y=!1,ee(T),T=-1),B=!0;var ne=M;try{for(he(de),k=t(g);k!==null&&(!(k.expirationTime>de)||Z&&!x());){var V=k.callback;if(typeof V=="function"){k.callback=null,M=k.priorityLevel;var q=V(k.expirationTime<=de);de=i.unstable_now(),typeof q=="function"?k.callback=q:k===t(g)&&s(g),he(de)}else s(g);k=t(g)}if(k!==null)var fe=!0;else{var Se=t(v);Se!==null&&Le(pe,Se.startTime-de),fe=!1}return fe}finally{k=null,M=ne,B=!1}}var ue=!1,P=null,T=-1,S=5,R=-1;function x(){return!(i.unstable_now()-R<S)}function D(){if(P!==null){var Z=i.unstable_now();R=Z;var de=!0;try{de=P(!0,Z)}finally{de?A():(ue=!1,P=null)}}else ue=!1}var A;if(typeof le=="function")A=function(){le(D)};else if(typeof MessageChannel<"u"){var We=new MessageChannel,yt=We.port2;We.port1.onmessage=D,A=function(){yt.postMessage(null)}}else A=function(){z(D,0)};function st(Z){P=Z,ue||(ue=!0,A())}function Le(Z,de){T=z(function(){Z(i.unstable_now())},de)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(Z){Z.callback=null},i.unstable_continueExecution=function(){Q||B||(Q=!0,st(me))},i.unstable_forceFrameRate=function(Z){0>Z||125<Z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<Z?Math.floor(1e3/Z):5},i.unstable_getCurrentPriorityLevel=function(){return M},i.unstable_getFirstCallbackNode=function(){return t(g)},i.unstable_next=function(Z){switch(M){case 1:case 2:case 3:var de=3;break;default:de=M}var ne=M;M=de;try{return Z()}finally{M=ne}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(Z,de){switch(Z){case 1:case 2:case 3:case 4:case 5:break;default:Z=3}var ne=M;M=Z;try{return de()}finally{M=ne}},i.unstable_scheduleCallback=function(Z,de,ne){var V=i.unstable_now();switch(typeof ne=="object"&&ne!==null?(ne=ne.delay,ne=typeof ne=="number"&&0<ne?V+ne:V):ne=V,Z){case 1:var q=-1;break;case 2:q=250;break;case 5:q=1073741823;break;case 4:q=1e4;break;default:q=5e3}return q=ne+q,Z={id:w++,callback:de,priorityLevel:Z,startTime:ne,expirationTime:q,sortIndex:-1},ne>V?(Z.sortIndex=ne,e(v,Z),t(g)===null&&Z===t(v)&&(Y?(ee(T),T=-1):Y=!0,Le(pe,ne-V))):(Z.sortIndex=q,e(g,Z),Q||B||(Q=!0,st(me))),Z},i.unstable_shouldYield=x,i.unstable_wrapCallback=function(Z){var de=M;return function(){var ne=M;M=de;try{return Z.apply(this,arguments)}finally{M=ne}}}}(Lh)),Lh}var _m;function n0(){return _m||(_m=1,Oh.exports=t0()),Oh.exports}/**
 * @license React
...
*/var li,Xg;(function(){var i;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(P,T){function S(){}S.prototype=T.prototype,P.D=T.prototype,P.prototype=new S,P.prototype.constructor=P,P.C=function(R,x,D){for(var A=Array(arguments.length-2),We=2;We<arguments.length;We++)A[We-2]=arguments[We];return T.prototype[x].apply(R,A)}}function t(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(s,t),s.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(P,T,S){S||(S=0);var R=Array(16);if(typeof T=="string")for(var x=0;16>x;++x)R[x]=T.charCodeAt(S++)|T.charCodeAt(S++)<<8|T.charCodeAt(S++)<<16|T.charCodeAt(S++)<<24;else for(x=0;16>x;++x)R[x]=T[S++]|T[S++]<<8|T[S++]<<16|T[S++]<<24;T=P.g[0],S=P.g[1],x=P.g[2];var D=P.g[3],A=T+(D^S&(x^D))+R[0]+3614090360&4294967295;T=S+(A<<7&4294967295|A>>>25),A=D+(x^T&(S^x))+R[1]+3905402710&4294967295,D=T+(A<<12&4294967295|A>>>20),A=x+(S^D&(T^S))+R[2]+606105819&4294967295,x=D+(A<<17&4294967295|A>>>15),A=S+(T^x&(D^T))+R[3]+3250441966&4294967295,S=x+(A<<22&4294967295|A>>>10),A=T+(D^S&(x^D))+R[4]+4118548399&4294967295,T=S+(A<<7&4294967295|A>>>25),A=D+(x^T&(S^x))+R[5]+1200080426&4294967295,D=T+(A<<12&4294967295|A>>>20),A=x+(S^D&(T^S))+R[6]+2821735955&4294967295,x=D+(A<<17&4294967295|A>>>15),A=S+(T^x&(D^T))+R[7]+4249261313&4294967295,S=x+(A<<22&4294967295|A>>>10),A=T+(D^S&(x^D))+R[8]+1770035416&4294967295,T=S+(A<<7&4294967295|A>>>25),A=D+(x^T&(S^x))+R[9]+2336552879&4294967295,D=T+(A<<12&4294967295|A>>>20),A=x+(S^D&(T^S))+R[10]+4294925233&4294967295,x=D+(A<<17&4294967295|A>>>15),A=S+(T^x&(D^T))+R[11]+2304563134&4294967295,S=x+(A<<22&4294967295|A>>>10),A=T+(D^S&(x^D))+R[12]+1804603682&4294967295,T=S+(A<<7&4294967295|A>>>25),A=D+(x^T&(S^x))+R[13]+4254626195&4294967295,D=T+(A<<12&4294967295|A>>>20),A=x+(S^D&(T^S))+R[14]+2792965006&4294967295,x=D+(A<<17&4294967295|A>>>15),A=S+(T^x&(D^T))+R[15]+1236535329&4294967295,S=x+(A<<22&4294967295|A>>>10),A=T+(x^D&(S^x))+R[1]+4129170786&4294967295,T=S+(A<<5&4294967295|A>>>27),A=D+(S^x&(T^S))+R[6]+3225465664&4294967295,D=T+(A<<9&4294967295|A>>>23),A=x+(T^S&(D^T))+R[11]+643717713&4294967295,x=D+(A<<14&4294967295|A>>>18),A=S+(D^T&(x^D))+R[0]+3921069994&4294967295,S=x+(A<<20&4294967295|A>>>12),A=T+(x^D&(S^x))+R[5]+3593408605&4294967295,T=S+(A<<5&4294967295|A>>>27),A=D+(S^x&(T^S))+R[10]+38016083&4294967295,D=T+(A<<9&4294967295|A>>>23),A=x+(T^S&(D^T))+R[15]+3634488961&4294967295,x=D+(A<<14&4294967295|A>>>18),A=S+(D^T&(x^D))+R[4]+3889429448&4294967295,S=x+(A<<20&4294967295|A>>>12),A=T+(x^D&(S^x))+R[9]+568446438&4294967295,T=S+(A<<5&4294967295|A>>>27),A=D+(S^x&(T^S))+R[14]+3275163606&4294967295,D=T+(A<<9&4294967295|A>>>23),A=x+(T^S&(D^T))+R[3]+4107603335&4294967295,x=D+(A<<14&4294967295|A>>>18),A=S+(D^T&(x^D))+R[8]+1163531501&4294967295,S=x+(A<<20&4294967295|A>>>12),A=T+(x^D&(S^x))+R[13]+2850285829&4294967295,T=S+(A<<5&4294967295|A>>>27),A=D+(S^x&(T^S))+R[2]+4243563512&4294967295,D=T+(A<<9&4294967295|A>>>23),A=x+(T^S&(D^T))+R[7]+1735328473&4294967295,x=D+(A<<14&4294967295|A>>>18),A=S+(D^T&(x^D))+R[12]+2368359562&4294967295,S=x+(A<<20&4294967295|A>>>12),A=T+(S^x^D)+R[5]+4294588738&4294967295,T=S+(A<<4&4294967295|A>>>28),A=D+(T^S^x)+R[8]+2272392833&4294967295,D=T+(A<<11&4294967295|A>>>21),A=x+(D^T^S)+R[11]+1839030562&4294967295,x=D+(A<<16&4294967295|A>>>16),A=S+(x^D^T)+R[14]+4259657740&4294967295,S=x+(A<<23&4294967295|A>>>9),A=T+(S^x^D)+R[1]+2763975236&4294967295,T=S+(A<<4&4294967295|A>>>28),A=D+(T^S^x)+R[4]+1272893353&4294967295,D=T+(A<<11&4294967295|A>>>21),A=x+(D^T^S)+R[7]+4139469664&4294967295,x=D+(A<<16&4294967295|A>>>16),A=S+(x^D^T)+R[10]+3200236656&4294967295,S=x+(A<<23&4294967295|A>>>9),A=T+(S^x^D)+R[13]+681279174&4294967295,T=S+(A<<4&4294967295|A>>>28),A=D+(T^S^x)+R[0]+3936430074&4294967295,D=T+(A<<11&4294967295|A>>>21),A=x+(D^T^S)+R[3]+3572445317&4294967295,x=D+(A<<16&4294967295|A>>>16),A=S+(x^D^T)+R[6]+76029189&4294967295,S=x+(A<<23&4294967295|A>>>9),A=T+(S^x^D)+R[9]+3654602809&4294967295,T=S+(A<<4&4294967295|A>>>28),A=D+(T^S^x)+R[12]+3873151461&4294967295,D=T+(A<<11&4294967295|A>>>21),A=x+(D^T^S)+R[15]+530742520&4294967295,x=D+(A<<16&4294967295|A>>>16),A=S+(x^D^T)+R[2]+3299628645&4294967295,S=x+(A<<23&4294967295|A>>>9),A=T+(x^(S|~D))+R[0]+4096336452&4294967295,T=S+(A<<6&4294967295|A>>>26),A=D+(S^(T|~x))+R[7]+1126891415&4294967295,D=T+(A<<10&4294967295|A>>>22),A=x+(T^(D|~S))+R[14]+2878612391&4294967295,x=D+(A<<15&4294967295|A>>>17),A=S+(D^(x|~T))+R[5]+4237533241&4294967295,S=x+(A<<21&4294967295|A>>>11),A=T+(x^(S|~D))+R[12]+1700485571&4294967295,T=S+(A<<6&4294967295|A>>>26),A=D+(S^(T|~x))+R[3]+2399980690&4294967295,D=T+(A<<10&4294967295|A>>>22),A=x+(T^(D|~S))+R[10]+4293915773&4294967295,x=D+(A<<15&4294967295|A>>>17),A=S+(D^(x|~T))+R[1]+2240044497&4294967295,S=x+(A<<21&4294967295|A>>>11),A=T+(x^(S|~D))+R[8]+1873313359&4294967295,T=S+(A<<6&4294967295|A>>>26),A=D+(S^(T|~x))+R[15]+4264355552&4294967295,D=T+(A<<10&4294967295|A>>>22),A=x+(T^(D|~S))+R[6]+2734768916&4294967295,x=D+(A<<15&4294967295|A>>>17),A=S+(D^(x|~T))+R[13]+1309151649&4294967295,S=x+(A<<21&4294967295|A>>>11),A=T+(x^(S|~D))+R[4]+4149444226&4294967295,T=S+(A<<6&4294967295|A>>>26),A=D+(S^(T|~x))+R[11]+3174756917&4294967295,D=T+(A<<10&4294967295|A>>>22),A=x+(T^(D|~S))+R[2]+718787259&4294967295,x=D+(A<<15&4294967295|A>>>17),A=S+(D^(x|~T))+R[9]+3951481745&4294967295,P.g[0]=P.g[0]+T&4294967295,P.g[1]=P.g[1]+(x+(A<<21&4294967295|A>>>11))&4294967295,P.g[2]=P.g[2]+x&4294967295,P.g[3]=P.g[3]+D&4294967295}s.prototype.u=function(P,T){T===void 0&&(T=P.length);for(var S=T-this.blockSize,R=this.B,x=this.h,D=0;D<T;){if(x==0)for(;D<=S;)o(this,P,D),D+=this.blockSize;if(typeof P=="string"){for(;D<T;)if(R[x++]=P.charCodeAt(D++),x==this.blockSize){o(this,R),x=0;break}}else for(;D<T;)if(R[x++]=P[D++],x==this.blockSize){o(this,R),x=0;break}}this.h=x,this.o+=T},s.prototype.v=function(){var P=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);P[0]=128;for(var T=1;T<P.length-8;++T)P[T]=0;var S=8*this.o;for(T=P.length-8;T<P.length;++T)P[T]=S&255,S/=256;for(this.u(P),P=Array(16),T=S=0;4>T;++T)for(var R=0;32>R;R+=8)P[S++]=this.g[T]>>>R&255;return P};function u(P,T){var S=m;return Object.prototype.hasOwnProperty.call(S,P)?S[P]:S[P]=T(P)}function h(P,T){this.h=T;for(var S=[],R=!0,x=P.length-1;0<=x;x--){var D=P[x]|0;R&&D==T||(S[x]=D,R=!1)}this.g=S}var m={};function g(P){return-128<=P&&128>P?u(P,function(T){return new h([T|0],0>T?-1:0)}):new h([P|0],0>P?-1:0)}function v(P){if(isNaN(P)||!isFinite(P))return k;if(0>P)return z(v(-P));for(var T=[],S=1,R=0;P>=S;R++)T[R]=P/S|0,S*=4294967296;return new h(T,0)}function w(P,T){if(P.length==0)throw Error("number format error: empty string");if(T=T||10,2>T||36<T)throw Error("radix out of range: "+T);if(P.charAt(0)=="-")return z(w(P.substring(1),T));if(0<=P.indexOf("-"))throw Error('number format error: interior "-" character');for(var S=v(Math.pow(T,8)),R=k,x=0;x<P.length;x+=8){var D=Math.min(8,P.length-x),A=parseInt(P.substring(x,x+D),T);8>D?(D=v(Math.pow(T,D)),R=R.j(D).add(v(A))):(R=R.j(S),R=R.add(v(A)))}return R}var k=g(0),M=g(1),B=g(16777216);i=h.prototype,i.m=function(){if(Y(this))return-z(this).m();for(var P=0,T=1,S=0;S<this.g.length;S++){var R=this.i(S);P+=(0<=R?R:4294967296+R)*T,T*=4294967296}return P},i.toString=function(P){if(P=P||10,2>P||36<P)throw Error("radix out of range: "+P);if(Q(this))return"0";if(Y(this))return"-"+z(this).toString(P);for(var T=v(Math.pow(P,6)),S=this,R="";;){var x=pe(S,T).g;S=ee(S,x.j(T));var D=((0<S.g.length?S.g[0]:S.h)>>>0).toString(P);if(S=x,Q(S))return D+R;for(;6>D.length;)D="0"+D;R=D+R}},i.i=function(P){return 0>P?0:P<this.g.length?this.g[P]:this.h};function Q(P){if(P.h!=0)return!1;for(var T=0;T<P.g.length;T++)if(P.g[T]!=0)return!1;return!0}function Y(P){return P.h==-1}i.l=function(P){return P=ee(this,P),Y(P)?-1:Q(P)?0:1};function z(P){for(var T=P.g.length,S=[],R=0;R<T;R++)S[R]=~P.g[R];return new h(S,~P.h).add(M)}i.abs=function(){return Y(this)?z(this):this},i.add=function(P){for(var T=Math.max(this.g.length,P.g.length),S=[],R=0,x=0;x<=T;x++){var D=R+(this.i(x)&65535)+(P.i(x)&65535),A=(D>>>16)+(this.i(x)>>>16)+(P.i(x)>>>16);R=A>>>16,D&=65535,A&=65535,S[x]=A<<16|D}return new h(S,S[S.length-1]&-2147483648?-1:0)};function ee(P,T){return P.add(z(T))}i.j=function(P){if(Q(this)||Q(P))return k;if(Y(this))return Y(P)?z(this).j(z(P)):z(z(this).j(P));if(Y(P))return z(this.j(z(P)));if(0>this.l(B)&&0>P.l(B))return v(this.m()*P.m());for(var T=this.g.length+P.g.length,S=[],R=0;R<2*T;R++)S[R]=0;for(R=0;R<this.g.length;R++)for(var x=0;x<P.g.length;x++){var D=this.i(R)>>>16,A=this.i(R)&65535,We=P.i(x)>>>16,yt=P.i(x)&65535;S[2*R+2*x]+=A*yt,le(S,2*R+2*x),S[2*R+2*x+1]+=D*yt,le(S,2*R+2*x+1),S[2*R+2*x+1]+=A*We,le(S,2*R+2*x+1),S[2*R+2*x+2]+=D*We,le(S,2*R+2*x+2)}for(R=0;R<T;R++)S[R]=S[2*R+1]<<16|S[2*R];for(R=T;R<2*T;R++)S[R]=0;return new h(S,0)};function le(P,T){for(;(P[T]&65535)!=P[T];)P[T+1]+=P[T]>>>16,P[T]&=65535,T++}function he(P,T){this.g=P,this.h=T}function pe(P,T){if(Q(T))throw Error("division by zero");if(Q(P))return new he(k,k);if(Y(P))return T=pe(z(P),T),new he(z(T.g),z(T.h));if(Y(T))return T=pe(P,z(T)),new he(z(T.g),T.h);if(30<P.g.length){if(Y(P)||Y(T))throw Error("slowDivide_ only works with positive integers.");for(var S=M,R=T;0>=R.l(P);)S=me(S),R=me(R);var x=ue(S,1),D=ue(R,1);for(R=ue(R,2),S=ue(S,2);!Q(R);){var A=D.add(R);0>=A.l(P)&&(x=x.add(S),D=A),R=ue(R,1),S=ue(S,1)}return T=ee(P,x.j(T)),new he(x,T)}for(x=k;0<=P.l(T);){for(S=Math.max(1,Math.floor(P.m()/T.m())),R=Math.ceil(Math.log(S)/Math.LN2),R=48>=R?1:Math.pow(2,R-48),D=v(S),A=D.j(T);Y(A)||0<A.l(P);)S-=R,D=v(S),A=D.j(T);Q(D)&&(D=M),x=x.add(D),P=ee(P,A)}return new he(x,P)}i.A=function(P){return pe(this,P).h},i.and=function(P){for(var T=Math.max(this.g.length,P.g.length),S=[],R=0;R<T;R++)S[R]=this.i(R)&P.i(R);return new h(S,this.h&P.h)},i.or=function(P){for(var T=Math.max(this.g.length,P.g.length),S=[],R=0;R<T;R++)S[R]=this.i(R)|P.i(R);return new h(S,this.h|P.h)},i.xor=function(P){for(var T=Math.max(this.g.length,P.g.length),S=[],R=0;R<T;R++)S[R]=this.i(R)^P.i(R);return new h(S,this.h^P.h)};function me(P){for(var T=P.g.length+1,S=[],R=0;R<T;R++)S[R]=P.i(R)<<1|P.i(R-1)>>>31;return new h(S,P.h)}function ue(P,T){var S=T>>5;T%=32;for(var R=P.g.length-S,x=[],D=0;D<R;D++)x[D]=0<T?P.i(D+S)>>>T|P.i(D+S+1)<<32-T:P.i(D+S);return new h(x,P.h)}s.prototype.digest=s.prototype.v,s.prototype.reset=s.prototype.s,s.prototype.update=s.prototype.u,Xg=s,h.prototype.add=h.prototype.add,h.prototype.multiply=h.prototype.j,h.prototype.modulo=h.prototype.A,h.prototype.compare=h.prototype.l,h.prototype.toNumber=h.prototype.m,h.prototype.toString=h.prototype.toString,h.prototype.getBits=h.prototype.i,h.fromNumber=v,h.fromString=w,li=h}).apply(typeof Dm<"u"?Dm:typeof self<"u"?self:typeof window<"u"?window:{});var ru=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Yg,ma,Jg,cu,Jh,Zg,ey,ty;(function(){var i,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(l,f,y){return l==Array.prototype||l==Object.prototype||(l[f]=y.value),l};function t(l){l=[typeof globalThis=="object"&&globalThis,l,typeof window=="object"&&window,typeof self=="object"&&self,typeof ru=="object"&&ru];for(var f=0;f<l.length;++f){var y=l[f];if(y&&y.Math==Math)return y}throw Error("Cannot find global object")}var s=t(this);function o(l,f){if(f)e:{var y=s;l=l.split(".");for(var E=0;E<l.length-1;E++){var O=l[E];if(!(O in y))break e;y=y[O]}l=l[l.length-1],E=y[l],f=f(E),f!=E&&f!=null&&e(y,l,{configurable:!0,writable:!0,value:f})}}function u(l,f){l instanceof String&&(l+="");var y=0,E=!1,O={next:function(){if(!E&&y<l.length){var j=y++;return{value:f(j,l[j]),done:!1}}return E=!0,{done:!0,value:void 0}}};return O[Symbol.iterator]=function(){return O},O}o("Array.prototype.values",function(l){return l||function(){return u(this,function(f,y){return y})}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var h=h||{},m=this||self;function g(l){var f=typeof l;return f=f!="object"?f:l?Array.isArray(l)?"array":f:"null",f=="array"||f=="object"&&typeof l.length=="number"}function v(l){var f=typeof l;return f=="object"&&l!=null||f=="function"}function w(l,f,y){return l.call.apply(l.bind,arguments)}function k(l,f,y){if(!l)throw Error();if(2<arguments.length){var E=Array.prototype.slice.call(arguments,2);return function(){var O=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(O,E),l.apply(f,O)}}return function(){return l.apply(f,arguments)}}function M(l,f,y){return M=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?w:k,M.apply(null,arguments)}function B(l,f){var y=Array.prototype.slice.call(arguments,1);return function(){var E=y.slice();return E.push.apply(E,arguments),l.apply(this,E)}}function Q(l,f){function y(){}y.prototype=f.prototype,l.aa=f.prototype,l.prototype=new y,l.prototype.constructor=l,l.Qb=function(E,O,j){for(var J=Array(arguments.length-2),je=2;je<arguments.length;je++)J[je-2]=arguments[je];return f.prototype[O].apply(E,J)}}function Y(l){const f=l.length;if(0<f){const y=Array(f);for(let E=0;E<f;E++)y[E]=l[E];return y}return[]}function z(l,f){for(let y=1;y<arguments.length;y++){const E=arguments[y];if(g(E)){const O=l.length||0,j=E.length||0;l.length=O+j;for(let J=0;J<j;J++)l[O+J]=E[J]}else l.push(E)}}class ee{constructor(f,y){this.i=f,this.j=y,this.h=0,this.g=null}get(){let f;return 0<this.h?(this.h--,f=this.g,this.g=f.next,f.next=null):f=this.i(),f}}function le(l){return/^[\s\xa0]*$/.test(l)}function he(){var l=m.navigator;return l&&(l=l.userAgent)?l:""}function pe(l){return pe[" "](l),l}pe[" "]=function(){};var me=he().indexOf("Gecko")!=-1&&!(he().toLowerCase().indexOf("webkit")!=-1&&he().indexOf("Edge")==-1)&&!(he().indexOf("Trident")!=-1||he().indexOf("MSIE")!=-1)&&he().indexOf("Edge")==-1;function ue(l,f,y){for(const E in l)f.call(y,l[E],E,l)}function P(l,f){for(const y in l)f.call(void 0,l[y],y,l)}function T(l){const f={};for(const y in l)f[y]=l[y];return f}const S="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function R(l,f){let y,E;for(let O=1;O<arguments.length;O++){E=arguments[O];for(y in E)l[y]=E[y];for(let j=0;j<S.length;j++)y=S[j],Object.prototype.hasOwnProperty.call(E,y)&&(l[y]=E[y])}}function x(l){var f=1;l=l.split(":");const y=[];for(;0<f&&l.length;)y.push(l.shift()),f--;return l.length&&y.push(l.join(":")),y}function D(l){m.setTimeout(()=>{throw l},0)}function A(){var l=de;let f=null;return l.g&&(f=l.g,l.g=l.g.next,l.g||(l.h=null),f.next=null),f}class We{constructor(){this.h=this.g=null}add(f,y){const E=yt.get();E.set(f,y),this.h?this.h.next=E:this.g=E,this.h=E}}var yt=new ee(()=>new st,l=>l.reset());class st{constructor(){this.next=this.g=this.h=null}set(f,y){this.h=f,this.g=y,this.next=null}reset(){this.next=this.g=this.h=null}}let Le,Z=!1,de=new We,ne=()=>{const l=m.Promise.resolve(void 0);Le=()=>{l.then(V)}};var V=()=>{for(var l;l=A();){try{l.h.call(l.g)}catch(y){D(y)}var f=yt;f.j(l),100>f.h&&(f.h++,l.next=f.g,f.g=l)}Z=!1};function q(){this.s=this.s,this.C=this.C}q.prototype.s=!1,q.prototype.ma=function(){this.s||(this.s=!0,this.N())},q.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function fe(l,f){this.type=l,this.g=this.target=f,this.defaultPrevented=!1}fe.prototype.h=function(){this.defaultPrevented=!0};var Se=function(){if(!m.addEventListener||!Object.defineProperty)return!1;var l=!1,f=Object.defineProperty({},"passive",{get:function(){l=!0}});try{const y=()=>{};m.addEventListener("test",y,f),m.removeEventListener("test",y,f)}catch{}return l}();function Ae(l,f){if(fe.call(this,l?l.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,l){var y=this.type=l.type,E=l.changedTouches&&l.changedTouches.length?l.changedTouches[0]:null;if(this.target=l.target||l.srcElement,this.g=f,f=l.relatedTarget){if(me){e:{try{pe(f.nodeName);var O=!0;break e}catch{}O=!1}O||(f=null)}}else y=="mouseover"?f=l.fromElement:y=="mouseout"&&(f=l.toElement);this.relatedTarget=f,E?(this.clientX=E.clientX!==void 0?E.clientX:E.pageX,this.clientY=E.clientY!==void 0?E.clientY:E.pageY,this.screenX=E.screenX||0,this.screenY=E.screenY||0):(this.clientX=l.clientX!==void 0?l.clientX:l.pageX,this.clientY=l.clientY!==void 0?l.clientY:l.pageY,this.screenX=l.screenX||0,this.screenY=l.screenY||0),this.button=l.button,this.key=l.key||"",this.ctrlKey=l.ctrlKey,this.altKey=l.altKey,this.shiftKey=l.shiftKey,this.metaKey=l.metaKey,this.pointerId=l.pointerId||0,this.pointerType=typeof l.pointerType=="string"?l.pointerType:xe[l.pointerType]||"",this.state=l.state,this.i=l,l.defaultPrevented&&Ae.aa.h.call(this)}}Q(Ae,fe);var xe={2:"touch",3:"pen",4:"mouse"};Ae.prototype.h=function(){Ae.aa.h.call(this);var l=this.i;l.preventDefault?l.preventDefault():l.returnValue=!1};var be="closure_listenable_"+(1e6*Math.random()|0),Fe=0;function Be(l,f,y,E,O){this.listener=l,this.proxy=null,this.src=f,this.type=y,this.capture=!!E,this.ha=O,this.key=++Fe,this.da=this.fa=!1}function _t(l){l.da=!0,l.listener=null,l.proxy=null,l.src=null,l.ha=null}function er(l){this.src=l,this.g={},this.h=0}er.prototype.add=function(l,f,y,E,O){var j=l.toString();l=this.g[j],l||(l=this.g[j]=[],this.h++);var J=Cr(l,f,E,O);return-1<J?(f=l[J],y||(f.fa=!1)):(f=new Be(f,this.src,j,!!E,O),f.fa=y,l.push(f)),f};function ts(l,f){var y=f.type;if(y in l.g){var E=l.g[y],O=Array.prototype.indexOf.call(E,f,void 0),j;(j=0<=O)&&Array.prototype.splice.call(E,O,1),j&&(_t(f),l.g[y].length==0&&(delete l.g[y],l.h--))}}function Cr(l,f,y,E){for(var O=0;O<l.length;++O){var j=l[O];if(!j.da&&j.listener==f&&j.capture==!!y&&j.ha==E)return O}return-1}var gi="closure_lm_"+(1e6*Math.random()|0),ns={};function Eo(l,f,y,E,O){if(Array.isArray(f)){for(var j=0;j<f.length;j++)Eo(l,f[j],y,E,O);return null}return y=Io(y),l&&l[be]?l.K(f,y,v(E)?!!E.capture:!!E,O):wo(l,f,y,!1,E,O)}function wo(l,f,y,E,O,j){if(!f)throw Error("Invalid event type");var J=v(O)?!!O.capture:!!O,je=is(l);if(je||(l[gi]=je=new er(l)),y=je.add(f,y,E,J,j),y.proxy)return y;if(E=za(),y.proxy=E,E.src=l,E.listener=y,l.addEventListener)Se||(O=J),O===void 0&&(O=!1),l.addEventListener(f.toString(),E,O);else if(l.attachEvent)l.attachEvent(nr(f.toString()),E);else if(l.addListener&&l.removeListener)l.addListener(E);else throw Error("addEventListener and attachEvent are unavailable.");return y}function za(){function l(y){return f.call(l.src,l.listener,y)}const f=To;return l}function rs(l,f,y,E,O){if(Array.isArray(f))for(var j=0;j<f.length;j++)rs(l,f[j],y,E,O);else E=v(E)?!!E.capture:!!E,y=Io(y),l&&l[be]?(l=l.i,f=String(f).toString(),f in l.g&&(j=l.g[f],y=Cr(j,y,E,O),-1<y&&(_t(j[y]),Array.prototype.splice.call(j,y,1),j.length==0&&(delete l.g[f],l.h--)))):l&&(l=is(l))&&(f=l.g[f.toString()],l=-1,f&&(l=Cr(f,y,E,O)),(y=-1<l?f[l]:null)&&tr(y))}function tr(l){if(typeof l!="number"&&l&&!l.da){var f=l.src;if(f&&f[be])ts(f.i,l);else{var y=l.type,E=l.proxy;f.removeEventListener?f.removeEventListener(y,E,l.capture):f.detachEvent?f.detachEvent(nr(y),E):f.addListener&&f.removeListener&&f.removeListener(E),(y=is(f))?(ts(y,l),y.h==0&&(y.src=null,f[gi]=null)):_t(l)}}}function nr(l){return l in ns?ns[l]:ns[l]="on"+l}function To(l,f){if(l.da)l=!0;else{f=new Ae(f,this);var y=l.listener,E=l.ha||l.src;l.fa&&tr(l),l=y.call(E,f)}return l}function is(l){return l=l[gi],l instanceof er?l:null}var ss="__closure_events_fn_"+(1e9*Math.random()>>>0);function Io(l){return typeof l=="function"?l:(l[ss]||(l[ss]=function(f){return l.handleEvent(f)}),l[ss])}function ct(){q.call(this),this.i=new er(this),this.M=this,this.F=null}Q(ct,q),ct.prototype[be]=!0,ct.prototype.removeEventListener=function(l,f,y,E){rs(this,l,f,y,E)};function ht(l,f){var y,E=l.F;if(E)for(y=[];E;E=E.F)y.push(E);if(l=l.M,E=f.type||f,typeof f=="string")f=new fe(f,l);else if(f instanceof fe)f.target=f.target||l;else{var O=f;f=new fe(E,l),R(f,O)}if(O=!0,y)for(var j=y.length-1;0<=j;j--){var J=f.g=y[j];O=rr(J,E,!0,f)&&O}if(J=f.g=l,O=rr(J,E,!0,f)&&O,O=rr(J,E,!1,f)&&O,y)for(j=0;j<y.length;j++)J=f.g=y[j],O=rr(J,E,!1,f)&&O}ct.prototype.N=function(){if(ct.aa.N.call(this),this.i){var l=this.i,f;for(f in l.g){for(var y=l.g[f],E=0;E<y.length;E++)_t(y[E]);delete l.g[f],l.h--}}this.F=null},ct.prototype.K=function(l,f,y,E){return this.i.add(String(l),f,!1,y,E)},ct.prototype.L=function(l,f,y,E){return this.i.add(String(l),f,!0,y,E)};function rr(l,f,y,E){if(f=l.i.g[String(f)],!f)return!0;f=f.concat();for(var O=!0,j=0;j<f.length;++j){var J=f[j];if(J&&!J.da&&J.capture==y){var je=J.listener,dt=J.ha||J.src;J.fa&&ts(l.i,J),O=je.call(dt,E)!==!1&&O}}return O&&!E.defaultPrevented}function So(l,f,y){if(typeof l=="function")y&&(l=M(l,y));else if(l&&typeof l.handleEvent=="function")l=M(l.handleEvent,l);else throw Error("Invalid listener argument");return 2147483647<Number(f)?-1:m.setTimeout(l,f||0)}function kr(l){l.g=So(()=>{l.g=null,l.i&&(l.i=!1,kr(l))},l.l);const f=l.h;l.h=null,l.m.apply(null,f)}class yi extends q{constructor(f,y){super(),this.m=f,this.l=y,this.h=null,this.i=!1,this.g=null}j(f){this.h=arguments,this.g?this.i=!0:kr(this)}N(){super.N(),this.g&&(m.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function _i(l){q.call(this),this.h=l,this.g={}}Q(_i,q);var Ao=[];function Ro(l){ue(l.g,function(f,y){this.g.hasOwnProperty(y)&&tr(f)},l),l.g={}}_i.prototype.N=function(){_i.aa.N.call(this),Ro(this)},_i.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Co=m.JSON.stringify,ko=m.JSON.parse,Po=class{stringify(l){return m.JSON.stringify(l,void 0)}parse(l){return m.JSON.parse(l,void 0)}};function vi(){}vi.prototype.h=null;function os(l){return l.h||(l.h=l.i())}function as(){}var on={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function Mn(){fe.call(this,"d")}Q(Mn,fe);function ls(){fe.call(this,"c")}Q(ls,fe);var bn={},No=null;function Ei(){return No=No||new ct}bn.La="serverreachability";function xo(l){fe.call(this,bn.La,l)}Q(xo,fe);function ir(l){const f=Ei();ht(f,new xo(f))}bn.STAT_EVENT="statevent";function Do(l,f){fe.call(this,bn.STAT_EVENT,l),this.stat=f}Q(Do,fe);function nt(l){const f=Ei();ht(f,new Do(f,l))}bn.Ma="timingevent";function us(l,f){fe.call(this,bn.Ma,l),this.size=f}Q(us,fe);function vn(l,f){if(typeof l!="function")throw Error("Fn must not be null and must be a function");return m.setTimeout(function(){l()},f)}function wi(){this.g=!0}wi.prototype.xa=function(){this.g=!1};function Ti(l,f,y,E,O,j){l.info(function(){if(l.g)if(j)for(var J="",je=j.split("&"),dt=0;dt<je.length;dt++){var De=je[dt].split("=");if(1<De.length){var vt=De[0];De=De[1];var ot=vt.split("_");J=2<=ot.length&&ot[1]=="type"?J+(vt+"="+De+"&"):J+(vt+"=redacted&")}}else J=null;else J=j;return"XMLHTTP REQ ("+E+") [attempt "+O+"]: "+f+`
`+y+`
`+J})}function cs(l,f,y,E,O,j,J){l.info(function(){return"XMLHTTP RESP ("+E+") [ attempt "+O+"]: "+f+`
`+y+`
`+j+" "+J})}function En(l,f,y,E){l.info(function(){return"XMLHTTP TEXT ("+f+"): "+sc(l,y)+(E?" "+E:"")})}function Vo(l,f){l.info(function(){return"TIMEOUT: "+f})}wi.prototype.info=function(){};function sc(l,f){if(!l.g)return f;if(!f)return null;try{var y=JSON.parse(f);if(y){for(l=0;l<y.length;l++)if(Array.isArray(y[l])){var E=y[l];if(!(2>E.length)){var O=E[1];if(Array.isArray(O)&&!(1>O.length)){var j=O[0];if(j!="noop"&&j!="stop"&&j!="close")for(var J=1;J<O.length;J++)O[J]=""}}}}return Co(y)}catch{return f}}var hs={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Ba={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},wn;function Ii(){}Q(Ii,vi),Ii.prototype.g=function(){return new XMLHttpRequest},Ii.prototype.i=function(){return{}},wn=new Ii;function Tn(l,f,y,E){this.j=l,this.i=f,this.l=y,this.R=E||1,this.U=new _i(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new $a}function $a(){this.i=null,this.g="",this.h=!1}var Oo={},ds={};function fs(l,f,y){l.L=1,l.v=Vr(Zt(f)),l.m=y,l.P=!0,Lo(l,null)}function Lo(l,f){l.F=Date.now(),$e(l),l.A=Zt(l.v);var y=l.A,E=l.R;Array.isArray(E)||(E=[String(E)]),Lr(y.i,"t",E),l.C=0,y=l.j.J,l.h=new $a,l.g=al(l.j,y?f:null,!l.m),0<l.O&&(l.M=new yi(M(l.Y,l,l.g),l.O)),f=l.U,y=l.g,E=l.ca;var O="readystatechange";Array.isArray(O)||(O&&(Ao[0]=O.toString()),O=Ao);for(var j=0;j<O.length;j++){var J=Eo(y,O[j],E||f.handleEvent,!1,f.h||f);if(!J)break;f.g[J.key]=J}f=l.H?T(l.H):{},l.m?(l.u||(l.u="POST"),f["Content-Type"]="application/x-www-form-urlencoded",l.g.ea(l.A,l.u,l.m,f)):(l.u="GET",l.g.ea(l.A,l.u,null,f)),ir(),Ti(l.i,l.u,l.A,l.l,l.R,l.m)}Tn.prototype.ca=function(l){l=l.target;const f=this.M;f&&qt(l)==3?f.j():this.Y(l)},Tn.prototype.Y=function(l){try{if(l==this.g)e:{const ot=qt(this.g);var f=this.g.Ba();const un=this.g.Z();if(!(3>ot)&&(ot!=3||this.g&&(this.h.h||this.g.oa()||zo(this.g)))){this.J||ot!=4||f==7||(f==8||0>=un?ir(3):ir(2)),Si(this);var y=this.g.Z();this.X=y;t:if(qa(this)){var E=zo(this.g);l="";var O=E.length,j=qt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){an(this),Pr(this);var J="";break t}this.h.i=new m.TextDecoder}for(f=0;f<O;f++)this.h.h=!0,l+=this.h.i.decode(E[f],{stream:!(j&&f==O-1)});E.length=0,this.h.g+=l,this.C=0,J=this.h.g}else J=this.g.oa();if(this.o=y==200,cs(this.i,this.u,this.A,this.l,this.R,ot,y),this.o){if(this.T&&!this.K){t:{if(this.g){var je,dt=this.g;if((je=dt.g?dt.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!le(je)){var De=je;break t}}De=null}if(y=De)En(this.i,this.l,y,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Mo(this,y);else{this.o=!1,this.s=3,nt(12),an(this),Pr(this);break e}}if(this.P){y=!0;let tn;for(;!this.J&&this.C<J.length;)if(tn=oc(this,J),tn==ds){ot==4&&(this.s=4,nt(14),y=!1),En(this.i,this.l,null,"[Incomplete Response]");break}else if(tn==Oo){this.s=4,nt(15),En(this.i,this.l,J,"[Invalid Chunk]"),y=!1;break}else En(this.i,this.l,tn,null),Mo(this,tn);if(qa(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ot!=4||J.length!=0||this.h.h||(this.s=1,nt(16),y=!1),this.o=this.o&&y,!y)En(this.i,this.l,J,"[Invalid Chunked Response]"),an(this),Pr(this);else if(0<J.length&&!this.W){this.W=!0;var vt=this.j;vt.g==this&&vt.ba&&!vt.M&&(vt.j.info("Great, no buffering proxy detected. Bytes received: "+J.length),$o(vt),vt.M=!0,nt(11))}}else En(this.i,this.l,J,null),Mo(this,J);ot==4&&an(this),this.o&&!this.J&&(ot==4?Ss(this.j,this):(this.o=!1,$e(this)))}else vs(this.g),y==400&&0<J.indexOf("Unknown SID")?(this.s=3,nt(12)):(this.s=0,nt(13)),an(this),Pr(this)}}}catch{}finally{}};function qa(l){return l.g?l.u=="GET"&&l.L!=2&&l.j.Ca:!1}function oc(l,f){var y=l.C,E=f.indexOf(`
`,y);return E==-1?ds:(y=Number(f.substring(y,E)),isNaN(y)?Oo:(E+=1,E+y>f.length?ds:(f=f.slice(E,E+y),l.C=E+y,f)))}Tn.prototype.cancel=function(){this.J=!0,an(this)};function $e(l){l.S=Date.now()+l.I,Ha(l,l.I)}function Ha(l,f){if(l.B!=null)throw Error("WatchDog timer not null");l.B=vn(M(l.ba,l),f)}function Si(l){l.B&&(m.clearTimeout(l.B),l.B=null)}Tn.prototype.ba=function(){this.B=null;const l=Date.now();0<=l-this.S?(Vo(this.i,this.A),this.L!=2&&(ir(),nt(17)),an(this),this.s=2,Pr(this)):Ha(this,this.S-l)};function Pr(l){l.j.G==0||l.J||Ss(l.j,l)}function an(l){Si(l);var f=l.M;f&&typeof f.ma=="function"&&f.ma(),l.M=null,Ro(l.U),l.g&&(f=l.g,l.g=null,f.abort(),f.ma())}function Mo(l,f){try{var y=l.j;if(y.G!=0&&(y.g==l||Ut(y.h,l))){if(!l.K&&Ut(y.h,l)&&y.G==3){try{var E=y.Da.g.parse(f)}catch{E=null}if(Array.isArray(E)&&E.length==3){var O=E;if(O[0]==0){e:if(!y.u){if(y.g)if(y.g.F+3e3<l.F)Is(y),Cn(y);else break e;Ts(y),nt(18)}}else y.za=O[1],0<y.za-y.T&&37500>O[2]&&y.F&&y.v==0&&!y.C&&(y.C=vn(M(y.Za,y),6e3));if(1>=Ga(y.h)&&y.ca){try{y.ca()}catch{}y.ca=void 0}}else ur(y,11)}else if((l.K||y.g==l)&&Is(y),!le(f))for(O=y.Da.g.parse(f),f=0;f<O.length;f++){let De=O[f];if(y.T=De[0],De=De[1],y.G==2)if(De[0]=="c"){y.K=De[1],y.ia=De[2];const vt=De[3];vt!=null&&(y.la=vt,y.j.info("VER="+y.la));const ot=De[4];ot!=null&&(y.Aa=ot,y.j.info("SVER="+y.Aa));const un=De[5];un!=null&&typeof un=="number"&&0<un&&(E=1.5*un,y.L=E,y.j.info("backChannelRequestTimeoutMs_="+E)),E=y;const tn=l.g;if(tn){const xi=tn.g?tn.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(xi){var j=E.h;j.g||xi.indexOf("spdy")==-1&&xi.indexOf("quic")==-1&&xi.indexOf("h2")==-1||(j.j=j.l,j.g=new Set,j.h&&(bo(j,j.h),j.h=null))}if(E.D){const Rs=tn.g?tn.g.getResponseHeader("X-HTTP-Session-Id"):null;Rs&&(E.ya=Rs,ze(E.I,E.D,Rs))}}y.G=3,y.l&&y.l.ua(),y.ba&&(y.R=Date.now()-l.F,y.j.info("Handshake RTT: "+y.R+"ms")),E=y;var J=l;if(E.qa=ol(E,E.J?E.ia:null,E.W),J.K){Ka(E.h,J);var je=J,dt=E.L;dt&&(je.I=dt),je.B&&(Si(je),$e(je)),E.g=J}else Ni(E);0<y.i.length&&zn(y)}else De[0]!="stop"&&De[0]!="close"||ur(y,7);else y.G==3&&(De[0]=="stop"||De[0]=="close"?De[0]=="stop"?ur(y,7):At(y):De[0]!="noop"&&y.l&&y.l.ta(De),y.v=0)}}ir(4)}catch{}}var Wa=class{constructor(l,f){this.g=l,this.map=f}};function Ai(l){this.l=l||10,m.PerformanceNavigationTiming?(l=m.performance.getEntriesByType("navigation"),l=0<l.length&&(l[0].nextHopProtocol=="hq"||l[0].nextHopProtocol=="h2")):l=!!(m.chrome&&m.chrome.loadTimes&&m.chrome.loadTimes()&&m.chrome.loadTimes().wasFetchedViaSpdy),this.j=l?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Jt(l){return l.h?!0:l.g?l.g.size>=l.j:!1}function Ga(l){return l.h?1:l.g?l.g.size:0}function Ut(l,f){return l.h?l.h==f:l.g?l.g.has(f):!1}function bo(l,f){l.g?l.g.add(f):l.h=f}function Ka(l,f){l.h&&l.h==f?l.h=null:l.g&&l.g.has(f)&&l.g.delete(f)}Ai.prototype.cancel=function(){if(this.i=Qa(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const l of this.g.values())l.cancel();this.g.clear()}};function Qa(l){if(l.h!=null)return l.i.concat(l.h.D);if(l.g!=null&&l.g.size!==0){let f=l.i;for(const y of l.g.values())f=f.concat(y.D);return f}return Y(l.i)}function ps(l){if(l.V&&typeof l.V=="function")return l.V();if(typeof Map<"u"&&l instanceof Map||typeof Set<"u"&&l instanceof Set)return Array.from(l.values());if(typeof l=="string")return l.split("");if(g(l)){for(var f=[],y=l.length,E=0;E<y;E++)f.push(l[E]);return f}f=[],y=0;for(E in l)f[y++]=l[E];return f}function ms(l){if(l.na&&typeof l.na=="function")return l.na();if(!l.V||typeof l.V!="function"){if(typeof Map<"u"&&l instanceof Map)return Array.from(l.keys());if(!(typeof Set<"u"&&l instanceof Set)){if(g(l)||typeof l=="string"){var f=[];l=l.length;for(var y=0;y<l;y++)f.push(y);return f}f=[],y=0;for(const E in l)f[y++]=E;return f}}}function Nr(l,f){if(l.forEach&&typeof l.forEach=="function")l.forEach(f,void 0);else if(g(l)||typeof l=="string")Array.prototype.forEach.call(l,f,void 0);else for(var y=ms(l),E=ps(l),O=E.length,j=0;j<O;j++)f.call(void 0,E[j],y&&y[j],l)}var Ri=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function ac(l,f){if(l){l=l.split("&");for(var y=0;y<l.length;y++){var E=l[y].indexOf("="),O=null;if(0<=E){var j=l[y].substring(0,E);O=l[y].substring(E+1)}else j=l[y];f(j,O?decodeURIComponent(O.replace(/\+/g," ")):"")}}}function sr(l){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,l instanceof sr){this.h=l.h,Ci(this,l.j),this.o=l.o,this.g=l.g,xr(this,l.s),this.l=l.l;var f=l.i,y=new Fn;y.i=f.i,f.g&&(y.g=new Map(f.g),y.h=f.h),Dr(this,y),this.m=l.m}else l&&(f=String(l).match(Ri))?(this.h=!1,Ci(this,f[1]||"",!0),this.o=Pe(f[2]||""),this.g=Pe(f[3]||"",!0),xr(this,f[4]),this.l=Pe(f[5]||"",!0),Dr(this,f[6]||"",!0),this.m=Pe(f[7]||"")):(this.h=!1,this.i=new Fn(null,this.h))}sr.prototype.toString=function(){var l=[],f=this.j;f&&l.push(Or(f,gs,!0),":");var y=this.g;return(y||f=="file")&&(l.push("//"),(f=this.o)&&l.push(Or(f,gs,!0),"@"),l.push(encodeURIComponent(String(y)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),y=this.s,y!=null&&l.push(":",String(y))),(y=this.l)&&(this.g&&y.charAt(0)!="/"&&l.push("/"),l.push(Or(y,y.charAt(0)=="/"?Ja:Ya,!0))),(y=this.i.toString())&&l.push("?",y),(y=this.m)&&l.push("#",Or(y,Fo)),l.join("")};function Zt(l){return new sr(l)}function Ci(l,f,y){l.j=y?Pe(f,!0):f,l.j&&(l.j=l.j.replace(/:$/,""))}function xr(l,f){if(f){if(f=Number(f),isNaN(f)||0>f)throw Error("Bad port number "+f);l.s=f}else l.s=null}function Dr(l,f,y){f instanceof Fn?(l.i=f,Un(l.i,l.h)):(y||(f=Or(f,Za)),l.i=new Fn(f,l.h))}function ze(l,f,y){l.i.set(f,y)}function Vr(l){return ze(l,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),l}function Pe(l,f){return l?f?decodeURI(l.replace(/%25/g,"%2525")):decodeURIComponent(l):""}function Or(l,f,y){return typeof l=="string"?(l=encodeURI(l).replace(f,Xa),y&&(l=l.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l):null}function Xa(l){return l=l.charCodeAt(0),"%"+(l>>4&15).toString(16)+(l&15).toString(16)}var gs=/[#\/\?@]/g,Ya=/[#\?:]/g,Ja=/[#\?]/g,Za=/[#\?@]/g,Fo=/#/g;function Fn(l,f){this.h=this.g=null,this.i=l||null,this.j=!!f}function St(l){l.g||(l.g=new Map,l.h=0,l.i&&ac(l.i,function(f,y){l.add(decodeURIComponent(f.replace(/\+/g," ")),y)}))}i=Fn.prototype,i.add=function(l,f){St(this),this.i=null,l=ln(this,l);var y=this.g.get(l);return y||this.g.set(l,y=[]),y.push(f),this.h+=1,this};function In(l,f){St(l),f=ln(l,f),l.g.has(f)&&(l.i=null,l.h-=l.g.get(f).length,l.g.delete(f))}function Sn(l,f){return St(l),f=ln(l,f),l.g.has(f)}i.forEach=function(l,f){St(this),this.g.forEach(function(y,E){y.forEach(function(O){l.call(f,O,E,this)},this)},this)},i.na=function(){St(this);const l=Array.from(this.g.values()),f=Array.from(this.g.keys()),y=[];for(let E=0;E<f.length;E++){const O=l[E];for(let j=0;j<O.length;j++)y.push(f[E])}return y},i.V=function(l){St(this);let f=[];if(typeof l=="string")Sn(this,l)&&(f=f.concat(this.g.get(ln(this,l))));else{l=Array.from(this.g.values());for(let y=0;y<l.length;y++)f=f.concat(l[y])}return f},i.set=function(l,f){return St(this),this.i=null,l=ln(this,l),Sn(this,l)&&(this.h-=this.g.get(l).length),this.g.set(l,[f]),this.h+=1,this},i.get=function(l,f){return l?(l=this.V(l),0<l.length?String(l[0]):f):f};function Lr(l,f,y){In(l,f),0<y.length&&(l.i=null,l.g.set(ln(l,f),Y(y)),l.h+=y.length)}i.toString=function(){if(this.i)return this.i;if(!this.g)return"";const l=[],f=Array.from(this.g.keys());for(var y=0;y<f.length;y++){var E=f[y];const j=encodeURIComponent(String(E)),J=this.V(E);for(E=0;E<J.length;E++){var O=j;J[E]!==""&&(O+="="+encodeURIComponent(String(J[E]))),l.push(O)}}return this.i=l.join("&")};function ln(l,f){return f=String(f),l.j&&(f=f.toLowerCase()),f}function Un(l,f){f&&!l.j&&(St(l),l.i=null,l.g.forEach(function(y,E){var O=E.toLowerCase();E!=O&&(In(this,E),Lr(this,O,y))},l)),l.j=f}function lc(l,f){const y=new wi;if(m.Image){const E=new Image;E.onload=B($t,y,"TestLoadImage: loaded",!0,f,E),E.onerror=B($t,y,"TestLoadImage: error",!1,f,E),E.onabort=B($t,y,"TestLoadImage: abort",!1,f,E),E.ontimeout=B($t,y,"TestLoadImage: timeout",!1,f,E),m.setTimeout(function(){E.ontimeout&&E.ontimeout()},1e4),E.src=l}else f(!1)}function el(l,f){const y=new wi,E=new AbortController,O=setTimeout(()=>{E.abort(),$t(y,"TestPingServer: timeout",!1,f)},1e4);fetch(l,{signal:E.signal}).then(j=>{clearTimeout(O),j.ok?$t(y,"TestPingServer: ok",!0,f):$t(y,"TestPingServer: server error",!1,f)}).catch(()=>{clearTimeout(O),$t(y,"TestPingServer: error",!1,f)})}function $t(l,f,y,E,O){try{O&&(O.onload=null,O.onerror=null,O.onabort=null,O.ontimeout=null),E(y)}catch{}}function uc(){this.g=new Po}function tl(l,f,y){const E=y||"";try{Nr(l,function(O,j){let J=O;v(O)&&(J=Co(O)),f.push(E+j+"="+encodeURIComponent(J))})}catch(O){throw f.push(E+"type="+encodeURIComponent("_badmap")),O}}function or(l){this.l=l.Ub||null,this.j=l.eb||!1}Q(or,vi),or.prototype.g=function(){return new ki(this.l,this.j)},or.prototype.i=function(l){return function(){return l}}({});function ki(l,f){ct.call(this),this.D=l,this.o=f,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}Q(ki,ct),i=ki.prototype,i.open=function(l,f){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=l,this.A=f,this.readyState=1,Rn(this)},i.send=function(l){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const f={headers:this.u,method:this.B,credentials:this.m,cache:void 0};l&&(f.body=l),(this.D||m).fetch(new Request(this.A,f)).then(this.Sa.bind(this),this.ga.bind(this))},i.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,An(this)),this.readyState=0},i.Sa=function(l){if(this.g&&(this.l=l,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=l.headers,this.readyState=2,Rn(this)),this.g&&(this.readyState=3,Rn(this),this.g)))if(this.responseType==="arraybuffer")l.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof m.ReadableStream<"u"&&"body"in l){if(this.j=l.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;nl(this)}else l.text().then(this.Ra.bind(this),this.ga.bind(this))};function nl(l){l.j.read().then(l.Pa.bind(l)).catch(l.ga.bind(l))}i.Pa=function(l){if(this.g){if(this.o&&l.value)this.response.push(l.value);else if(!this.o){var f=l.value?l.value:new Uint8Array(0);(f=this.v.decode(f,{stream:!l.done}))&&(this.response=this.responseText+=f)}l.done?An(this):Rn(this),this.readyState==3&&nl(this)}},i.Ra=function(l){this.g&&(this.response=this.responseText=l,An(this))},i.Qa=function(l){this.g&&(this.response=l,An(this))},i.ga=function(){this.g&&An(this)};function An(l){l.readyState=4,l.l=null,l.j=null,l.v=null,Rn(l)}i.setRequestHeader=function(l,f){this.u.append(l,f)},i.getResponseHeader=function(l){return this.h&&this.h.get(l.toLowerCase())||""},i.getAllResponseHeaders=function(){if(!this.h)return"";const l=[],f=this.h.entries();for(var y=f.next();!y.done;)y=y.value,l.push(y[0]+": "+y[1]),y=f.next();return l.join(`\r
`)};function Rn(l){l.onreadystatechange&&l.onreadystatechange.call(l)}Object.defineProperty(ki.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(l){this.m=l?"include":"same-origin"}});function ar(l){let f="";return ue(l,function(y,E){f+=E,f+=":",f+=y,f+=`\r
`}),f}function Mr(l,f,y){e:{for(E in y){var E=!1;break e}E=!0}E||(y=ar(y),typeof l=="string"?y!=null&&encodeURIComponent(String(y)):ze(l,f,y))}function Xe(l){ct.call(this),this.headers=new Map,this.o=l||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}Q(Xe,ct);var cc=/^https?$/i,Uo=["POST","PUT"];i=Xe.prototype,i.Ha=function(l){this.J=l},i.ea=function(l,f,y,E){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+l);f=f?f.toUpperCase():"GET",this.D=l,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():wn.g(),this.v=this.o?os(this.o):os(wn),this.g.onreadystatechange=M(this.Ea,this);try{this.B=!0,this.g.open(f,String(l),!0),this.B=!1}catch(j){Pi(this,j);return}if(l=y||"",y=new Map(this.headers),E)if(Object.getPrototypeOf(E)===Object.prototype)for(var O in E)y.set(O,E[O]);else if(typeof E.keys=="function"&&typeof E.get=="function")for(const j of E.keys())y.set(j,E.get(j));else throw Error("Unknown input type for opt_headers: "+String(E));E=Array.from(y.keys()).find(j=>j.toLowerCase()=="content-type"),O=m.FormData&&l instanceof m.FormData,!(0<=Array.prototype.indexOf.call(Uo,f,void 0))||E||O||y.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[j,J]of y)this.g.setRequestHeader(j,J);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{_s(this),this.u=!0,this.g.send(l),this.u=!1}catch(j){Pi(this,j)}};function Pi(l,f){l.h=!1,l.g&&(l.j=!0,l.g.abort(),l.j=!1),l.l=f,l.m=5,ys(l),en(l)}function ys(l){l.A||(l.A=!0,ht(l,"complete"),ht(l,"error"))}i.abort=function(l){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=l||7,ht(this,"complete"),ht(this,"abort"),en(this))},i.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),en(this,!0)),Xe.aa.N.call(this)},i.Ea=function(){this.s||(this.B||this.u||this.j?jo(this):this.bb())},i.bb=function(){jo(this)};function jo(l){if(l.h&&typeof h<"u"&&(!l.v[1]||qt(l)!=4||l.Z()!=2)){if(l.u&&qt(l)==4)So(l.Ea,0,l);else if(ht(l,"readystatechange"),qt(l)==4){l.h=!1;try{const J=l.Z();e:switch(J){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var f=!0;break e;default:f=!1}var y;if(!(y=f)){var E;if(E=J===0){var O=String(l.D).match(Ri)[1]||null;!O&&m.self&&m.self.location&&(O=m.self.location.protocol.slice(0,-1)),E=!cc.test(O?O.toLowerCase():"")}y=E}if(y)ht(l,"complete"),ht(l,"success");else{l.m=6;try{var j=2<qt(l)?l.g.statusText:""}catch{j=""}l.l=j+" ["+l.Z()+"]",ys(l)}}finally{en(l)}}}}function en(l,f){if(l.g){_s(l);const y=l.g,E=l.v[0]?()=>{}:null;l.g=null,l.v=null,f||ht(l,"ready");try{y.onreadystatechange=E}catch{}}}function _s(l){l.I&&(m.clearTimeout(l.I),l.I=null)}i.isActive=function(){return!!this.g};function qt(l){return l.g?l.g.readyState:0}i.Z=function(){try{return 2<qt(this)?this.g.status:-1}catch{return-1}},i.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},i.Oa=function(l){if(this.g){var f=this.g.responseText;return l&&f.indexOf(l)==0&&(f=f.substring(l.length)),ko(f)}};function zo(l){try{if(!l.g)return null;if("response"in l.g)return l.g.response;switch(l.H){case"":case"text":return l.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in l.g)return l.g.mozResponseArrayBuffer}return null}catch{return null}}function vs(l){const f={};l=(l.g&&2<=qt(l)&&l.g.getAllResponseHeaders()||"").split(`\r
`);for(let E=0;E<l.length;E++){if(le(l[E]))continue;var y=x(l[E]);const O=y[0];if(y=y[1],typeof y!="string")continue;y=y.trim();const j=f[O]||[];f[O]=j,j.push(y)}P(f,function(E){return E.join(", ")})}i.Ba=function(){return this.m},i.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function jn(l,f,y){return y&&y.internalChannelParams&&y.internalChannelParams[l]||f}function Bo(l){this.Aa=0,this.i=[],this.j=new wi,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=jn("failFast",!1,l),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=jn("baseRetryDelayMs",5e3,l),this.cb=jn("retryDelaySeedMs",1e4,l),this.Wa=jn("forwardChannelMaxRetries",2,l),this.wa=jn("forwardChannelRequestTimeoutMs",2e4,l),this.pa=l&&l.xmlHttpFactory||void 0,this.Xa=l&&l.Tb||void 0,this.Ca=l&&l.useFetchStreams||!1,this.L=void 0,this.J=l&&l.supportsCrossDomainXhr||!1,this.K="",this.h=new Ai(l&&l.concurrentRequestLimit),this.Da=new uc,this.P=l&&l.fastHandshake||!1,this.O=l&&l.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=l&&l.Rb||!1,l&&l.xa&&this.j.xa(),l&&l.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&l&&l.detectBufferingProxy||!1,this.ja=void 0,l&&l.longPollingTimeout&&0<l.longPollingTimeout&&(this.ja=l.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}i=Bo.prototype,i.la=8,i.G=1,i.connect=function(l,f,y,E){nt(0),this.W=l,this.H=f||{},y&&E!==void 0&&(this.H.OSID=y,this.H.OAID=E),this.F=this.X,this.I=ol(this,null,this.W),zn(this)};function At(l){if(Es(l),l.G==3){var f=l.U++,y=Zt(l.I);if(ze(y,"SID",l.K),ze(y,"RID",f),ze(y,"TYPE","terminate"),lr(l,y),f=new Tn(l,l.j,f),f.L=2,f.v=Vr(Zt(y)),y=!1,m.navigator&&m.navigator.sendBeacon)try{y=m.navigator.sendBeacon(f.v.toString(),"")}catch{}!y&&m.Image&&(new Image().src=f.v,y=!0),y||(f.g=al(f.j,null),f.g.ea(f.v)),f.F=Date.now(),$e(f)}sl(l)}function Cn(l){l.g&&($o(l),l.g.cancel(),l.g=null)}function Es(l){Cn(l),l.u&&(m.clearTimeout(l.u),l.u=null),Is(l),l.h.cancel(),l.s&&(typeof l.s=="number"&&m.clearTimeout(l.s),l.s=null)}function zn(l){if(!Jt(l.h)&&!l.s){l.s=!0;var f=l.Ga;Le||ne(),Z||(Le(),Z=!0),de.add(f,l),l.B=0}}function hc(l,f){return Ga(l.h)>=l.h.j-(l.s?1:0)?!1:l.s?(l.i=f.D.concat(l.i),!0):l.G==1||l.G==2||l.B>=(l.Va?0:l.Wa)?!1:(l.s=vn(M(l.Ga,l,f),il(l,l.B)),l.B++,!0)}i.Ga=function(l){if(this.s)if(this.s=null,this.G==1){if(!l){this.U=Math.floor(1e5*Math.random()),l=this.U++;const O=new Tn(this,this.j,l);let j=this.o;if(this.S&&(j?(j=T(j),R(j,this.S)):j=this.S),this.m!==null||this.O||(O.H=j,j=null),this.P)e:{for(var f=0,y=0;y<this.i.length;y++){t:{var E=this.i[y];if("__data__"in E.map&&(E=E.map.__data__,typeof E=="string")){E=E.length;break t}E=void 0}if(E===void 0)break;if(f+=E,4096<f){f=y;break e}if(f===4096||y===this.i.length-1){f=y+1;break e}}f=1e3}else f=1e3;f=br(this,O,f),y=Zt(this.I),ze(y,"RID",l),ze(y,"CVER",22),this.D&&ze(y,"X-HTTP-Session-Id",this.D),lr(this,y),j&&(this.O?f="headers="+encodeURIComponent(String(ar(j)))+"&"+f:this.m&&Mr(y,this.m,j)),bo(this.h,O),this.Ua&&ze(y,"TYPE","init"),this.P?(ze(y,"$req",f),ze(y,"SID","null"),O.T=!0,fs(O,y,null)):fs(O,y,f),this.G=2}}else this.G==3&&(l?ws(this,l):this.i.length==0||Jt(this.h)||ws(this))};function ws(l,f){var y;f?y=f.l:y=l.U++;const E=Zt(l.I);ze(E,"SID",l.K),ze(E,"RID",y),ze(E,"AID",l.T),lr(l,E),l.m&&l.o&&Mr(E,l.m,l.o),y=new Tn(l,l.j,y,l.B+1),l.m===null&&(y.H=l.o),f&&(l.i=f.D.concat(l.i)),f=br(l,y,1e3),y.I=Math.round(.5*l.wa)+Math.round(.5*l.wa*Math.random()),bo(l.h,y),fs(y,E,f)}function lr(l,f){l.H&&ue(l.H,function(y,E){ze(f,E,y)}),l.l&&Nr({},function(y,E){ze(f,E,y)})}function br(l,f,y){y=Math.min(l.i.length,y);var E=l.l?M(l.l.Na,l.l,l):null;e:{var O=l.i;let j=-1;for(;;){const J=["count="+y];j==-1?0<y?(j=O[0].g,J.push("ofs="+j)):j=0:J.push("ofs="+j);let je=!0;for(let dt=0;dt<y;dt++){let De=O[dt].g;const vt=O[dt].map;if(De-=j,0>De)j=Math.max(0,O[dt].g-100),je=!1;else try{tl(vt,J,"req"+De+"_")}catch{E&&E(vt)}}if(je){E=J.join("&");break e}}}return l=l.i.splice(0,y),f.D=l,E}function Ni(l){if(!l.g&&!l.u){l.Y=1;var f=l.Fa;Le||ne(),Z||(Le(),Z=!0),de.add(f,l),l.v=0}}function Ts(l){return l.g||l.u||3<=l.v?!1:(l.Y++,l.u=vn(M(l.Fa,l),il(l,l.v)),l.v++,!0)}i.Fa=function(){if(this.u=null,rl(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var l=2*this.R;this.j.info("BP detection timer enabled: "+l),this.A=vn(M(this.ab,this),l)}},i.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,nt(10),Cn(this),rl(this))};function $o(l){l.A!=null&&(m.clearTimeout(l.A),l.A=null)}function rl(l){l.g=new Tn(l,l.j,"rpc",l.Y),l.m===null&&(l.g.H=l.o),l.g.O=0;var f=Zt(l.qa);ze(f,"RID","rpc"),ze(f,"SID",l.K),ze(f,"AID",l.T),ze(f,"CI",l.F?"0":"1"),!l.F&&l.ja&&ze(f,"TO",l.ja),ze(f,"TYPE","xmlhttp"),lr(l,f),l.m&&l.o&&Mr(f,l.m,l.o),l.L&&(l.g.I=l.L);var y=l.g;l=l.ia,y.L=1,y.v=Vr(Zt(f)),y.m=null,y.P=!0,Lo(y,l)}i.Za=function(){this.C!=null&&(this.C=null,Cn(this),Ts(this),nt(19))};function Is(l){l.C!=null&&(m.clearTimeout(l.C),l.C=null)}function Ss(l,f){var y=null;if(l.g==f){Is(l),$o(l),l.g=null;var E=2}else if(Ut(l.h,f))y=f.D,Ka(l.h,f),E=1;else return;if(l.G!=0){if(f.o)if(E==1){y=f.m?f.m.length:0,f=Date.now()-f.F;var O=l.B;E=Ei(),ht(E,new us(E,y)),zn(l)}else Ni(l);else if(O=f.s,O==3||O==0&&0<f.X||!(E==1&&hc(l,f)||E==2&&Ts(l)))switch(y&&0<y.length&&(f=l.h,f.i=f.i.concat(y)),O){case 1:ur(l,5);break;case 4:ur(l,10);break;case 3:ur(l,6);break;default:ur(l,2)}}}function il(l,f){let y=l.Ta+Math.floor(Math.random()*l.cb);return l.isActive()||(y*=2),y*f}function ur(l,f){if(l.j.info("Error code "+f),f==2){var y=M(l.fb,l),E=l.Xa;const O=!E;E=new sr(E||"//www.google.com/images/cleardot.gif"),m.location&&m.location.protocol=="http"||Ci(E,"https"),Vr(E),O?lc(E.toString(),y):el(E.toString(),y)}else nt(2);l.G=0,l.l&&l.l.sa(f),sl(l),Es(l)}i.fb=function(l){l?(this.j.info("Successfully pinged google.com"),nt(2)):(this.j.info("Failed to ping google.com"),nt(1))};function sl(l){if(l.G=0,l.ka=[],l.l){const f=Qa(l.h);(f.length!=0||l.i.length!=0)&&(z(l.ka,f),z(l.ka,l.i),l.h.i.length=0,Y(l.i),l.i.length=0),l.l.ra()}}function ol(l,f,y){var E=y instanceof sr?Zt(y):new sr(y);if(E.g!="")f&&(E.g=f+"."+E.g),xr(E,E.s);else{var O=m.location;E=O.protocol,f=f?f+"."+O.hostname:O.hostname,O=+O.port;var j=new sr(null);E&&Ci(j,E),f&&(j.g=f),O&&xr(j,O),y&&(j.l=y),E=j}return y=l.D,f=l.ya,y&&f&&ze(E,y,f),ze(E,"VER",l.la),lr(l,E),E}function al(l,f,y){if(f&&!l.J)throw Error("Can't create secondary domain capable XhrIo object.");return f=l.Ca&&!l.pa?new Xe(new or({eb:y})):new Xe(l.pa),f.Ha(l.J),f}i.isActive=function(){return!!this.l&&this.l.isActive(this)};function qo(){}i=qo.prototype,i.ua=function(){},i.ta=function(){},i.sa=function(){},i.ra=function(){},i.isActive=function(){return!0},i.Na=function(){};function As(){}As.prototype.g=function(l,f){return new jt(l,f)};function jt(l,f){ct.call(this),this.g=new Bo(f),this.l=l,this.h=f&&f.messageUrlParams||null,l=f&&f.messageHeaders||null,f&&f.clientProtocolHeaderRequired&&(l?l["X-Client-Protocol"]="webchannel":l={"X-Client-Protocol":"webchannel"}),this.g.o=l,l=f&&f.initMessageHeaders||null,f&&f.messageContentType&&(l?l["X-WebChannel-Content-Type"]=f.messageContentType:l={"X-WebChannel-Content-Type":f.messageContentType}),f&&f.va&&(l?l["X-WebChannel-Client-Profile"]=f.va:l={"X-WebChannel-Client-Profile":f.va}),this.g.S=l,(l=f&&f.Sb)&&!le(l)&&(this.g.m=l),this.v=f&&f.supportsCrossDomainXhr||!1,this.u=f&&f.sendRawJson||!1,(f=f&&f.httpSessionIdParam)&&!le(f)&&(this.g.D=f,l=this.h,l!==null&&f in l&&(l=this.h,f in l&&delete l[f])),this.j=new Bn(this)}Q(jt,ct),jt.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},jt.prototype.close=function(){At(this.g)},jt.prototype.o=function(l){var f=this.g;if(typeof l=="string"){var y={};y.__data__=l,l=y}else this.u&&(y={},y.__data__=Co(l),l=y);f.i.push(new Wa(f.Ya++,l)),f.G==3&&zn(f)},jt.prototype.N=function(){this.g.l=null,delete this.j,At(this.g),delete this.g,jt.aa.N.call(this)};function ll(l){Mn.call(this),l.__headers__&&(this.headers=l.__headers__,this.statusCode=l.__status__,delete l.__headers__,delete l.__status__);var f=l.__sm__;if(f){e:{for(const y in f){l=y;break e}l=void 0}(this.i=l)&&(l=this.i,f=f!==null&&l in f?f[l]:void 0),this.data=f}else this.data=l}Q(ll,Mn);function ul(){ls.call(this),this.status=1}Q(ul,ls);function Bn(l){this.g=l}Q(Bn,qo),Bn.prototype.ua=function(){ht(this.g,"a")},Bn.prototype.ta=function(l){ht(this.g,new ll(l))},Bn.prototype.sa=function(l){ht(this.g,new ul)},Bn.prototype.ra=function(){ht(this.g,"b")},As.prototype.createWebChannel=As.prototype.g,jt.prototype.send=jt.prototype.o,jt.prototype.open=jt.prototype.m,jt.prototype.close=jt.prototype.close,ty=function(){return new As},ey=function(){return Ei()},Zg=bn,Jh={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},hs.NO_ERROR=0,hs.TIMEOUT=8,hs.HTTP_ERROR=6,cu=hs,Ba.COMPLETE="complete",Jg=Ba,as.EventType=on,on.OPEN="a",on.CLOSE="b",on.ERROR="c",on.MESSAGE="d",ct.prototype.listen=ct.prototype.K,ma=as,Xe.prototype.listenOnce=Xe.prototype.L,Xe.prototype.getLastError=Xe.prototype.Ka,Xe.prototype.getLastErrorCode=Xe.prototype.Ba,Xe.prototype.getStatus=Xe.prototype.Z,Xe.prototype.getResponseJson=Xe.prototype.Oa,Xe.prototype.getResponseText=Xe.prototype.oa,Xe.prototype.send=Xe.prototype.ea,Xe.prototype.setWithCredentials=Xe.prototype.Ha,Yg=Xe}).apply(typeof ru<"u"?ru:typeof self<"u"?self:typeof window<"u"?window:{});const Vm="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qi=new _d("@firebase/firestore");function Gs(){return Qi.logLevel}function re(i,...e){if(Qi.logLevel<=Ce.DEBUG){const t=e.map(wd);Qi.debug(`Firestore (${po}): ${i}`,...t)}}function Tr(i,...e){if(Qi.logLevel<=Ce.ERROR){const t=e.map(wd);Qi.error(`Firestore (${po}): ${i}`,...t)}}function ro(i,...e){if(Qi.logLevel<=Ce.WARN){const t=e.map(wd);Qi.warn(`Firestore (${po}): ${i}`,...t)}}function wd(i){if(typeof i=="string")return i;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mo(i){if(i.code!==H.FAILED_PRECONDITION||i.message!==JE)throw i;re("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tw=new et(ge.comparator);function Ir(){return Tw}const yy=new et(ge.comparator);function ga(...i){let e=yy;for(const t of i)e=e.insert(t.key,t);return e}function _y(i){let e=yy;return i.forEach((t,s)=>e=e.insert(t,s.overlayedDocument)),e}function Hi(){return Ea()}function vy(){return Ea()}function Ea(){return new Ji(i=>i.toString(),(i,e)=>i.isEqual(e))}const Iw=new et(ge.comparator),Sw=new gt(ge.comparator);function ke(...i){let e=Sw;for(const t of i)e=e.add(t);return e}const Aw=new gt(Ne);function Rw(){return Aw}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fT{constructor(){this.changes=new Ji(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,bt.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const s=this.changes.get(t);return s!==void 0?$.resolve(s):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yT{constructor(){this.overlays=new et(ge.comparator),this.dr=new Map}getOverlay(e,t){return $.resolve(this.overlays.get(t))}getOverlays(e,t){const s=Hi();return $.forEach(t,o=>this.getOverlay(e,o).next(u=>{u!==null&&s.set(o,u)})).next(()=>s)}saveOverlays(e,t,s){return s.forEach((o,u)=>{this.Tt(e,t,u)}),$.resolve()}removeOverlaysForBatchId(e,t,s){const o=this.dr.get(s);return o!==void 0&&(o.forEach(u=>this.overlays=this.overlays.remove(u)),this.dr.delete(s)),$.resolve()}getOverlaysForCollection(e,t,s){const o=Hi(),u=t.length+1,h=new ge(t.child("")),m=this.overlays.getIteratorFrom(h);for(;m.hasNext();){const g=m.getNext().value,v=g.getKey();if(!t.isPrefixOf(v.path))break;v.path.length===u&&g.largestBatchId>s&&o.set(g.getKey(),g)}return $.resolve(o)}getOverlaysForCollectionGroup(e,t,s,o){let u=new et((v,w)=>v-w);const h=this.overlays.getIterator();for(;h.hasNext();){const v=h.getNext().value;if(v.getKey().getCollectionGroup()===t&&v.largestBatchId>s){let w=u.get(v.largestBatchId);w===null&&(w=Hi(),u=u.insert(v.largestBatchId,w)),w.set(v.getKey(),v)}}const m=Hi(),g=u.getIterator();for(;g.hasNext()&&(g.getNext().value.forEach((v,w)=>m.set(v,w)),!(m.size()>=o)););return $.resolve(m)}Tt(e,t,s){const o=this.overlays.get(s.key);if(o!==null){const h=this.dr.get(o.largestBatchId).delete(s.key);this.dr.set(o.largestBatchId,h)}this.overlays=this.overlays.insert(s.key,new Mw(t,s));let u=this.dr.get(t);u===void 0&&(u=ke(),this.dr.set(t,u)),this.dr.set(t,u.add(s.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _T{constructor(){this.sessionToken=Nt.EMPTY_BYTE_STRING}getSessionToken(e){return $.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,$.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xd{constructor(){this.Er=new gt(It.Ar),this.Rr=new gt(It.Vr)}isEmpty(){return this.Er.isEmpty()}addReference(e,t){const s=new It(e,t);this.Er=this.Er.add(s),this.Rr=this.Rr.add(s)}mr(e,t){e.forEach(s=>this.addReference(s,t))}removeReference(e,t){this.gr(new It(e,t))}pr(e,t){e.forEach(s=>this.removeReference(s,t))}yr(e){const t=new ge(new Qe([])),s=new It(t,e),o=new It(t,e+1),u=[];return this.Rr.forEachInRange([s,o],h=>{this.gr(h),u.push(h.key)}),u}wr(){this.Er.forEach(e=>this.gr(e))}gr(e){this.Er=this.Er.delete(e),this.Rr=this.Rr.delete(e)}Sr(e){const t=new ge(new Qe([])),s=new It(t,e),o=new It(t,e+1);let u=ke();return this.Rr.forEachInRange([s,o],h=>{u=u.add(h.key)}),u}containsKey(e){const t=new It(e,0),s=this.Er.firstAfterOrEqual(t);return s!==null&&e.isEqual(s.key)}}class It{constructor(e,t){this.key=e,this.br=t}static Ar(e,t){return ge.comparator(e.key,t.key)||Ne(e.br,t.br)}static Vr(e,t){return Ne(e.br,t.br)||ge.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vT{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.Dr=1,this.vr=new gt(It.Ar)}checkEmpty(e){return $.resolve(this.mutationQueue.length===0)}addMutationBatch(e,t,s,o){const u=this.Dr;this.Dr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const h=new Lw(u,t,s,o);this.mutationQueue.push(h);for(const m of o)this.vr=this.vr.add(new It(m.key,u)),this.indexManager.addToCollectionParentIndex(e,m.key.path.popLast());return $.resolve(h)}lookupMutationBatch(e,t){return $.resolve(this.Cr(t))}getNextMutationBatchAfterBatchId(e,t){const s=t+1,o=this.Fr(s),u=o<0?0:o;return $.resolve(this.mutationQueue.length>u?this.mutationQueue[u]:null)}getHighestUnacknowledgedBatchId(){return $.resolve(this.mutationQueue.length===0?-1:this.Dr-1)}getAllMutationBatches(e){return $.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const s=new It(t,0),o=new It(t,Number.POSITIVE_INFINITY),u=[];return this.vr.forEachInRange([s,o],h=>{const m=this.Cr(h.br);u.push(m)}),$.resolve(u)}getAllMutationBatchesAffectingDocumentKeys(e,t){let s=new gt(Ne);return t.forEach(o=>{const u=new It(o,0),h=new It(o,Number.POSITIVE_INFINITY);this.vr.forEachInRange([u,h],m=>{s=s.add(m.br)})}),$.resolve(this.Mr(s))}getAllMutationBatchesAffectingQuery(e,t){const s=t.path,o=s.length+1;let u=s;ge.isDocumentKey(u)||(u=u.child(""));const h=new It(new ge(u),0);let m=new gt(Ne);return this.vr.forEachWhile(g=>{const v=g.key.path;return!!s.isPrefixOf(v)&&(v.length===o&&(m=m.add(g.br)),!0)},h),$.resolve(this.Mr(m))}Mr(e){const t=[];return e.forEach(s=>{const o=this.Cr(s);o!==null&&t.push(o)}),t}removeMutationBatch(e,t){Ue(this.Or(t.batchId,"removed")===0),this.mutationQueue.shift();let s=this.vr;return $.forEach(t.mutations,o=>{const u=new It(o.key,t.batchId);return s=s.delete(u),this.referenceDelegate.markPotentiallyOrphaned(e,o.key)}).next(()=>{this.vr=s})}Bn(e){}containsKey(e,t){const s=new It(t,0),o=this.vr.firstAfterOrEqual(s);return $.resolve(t.isEqual(o&&o.key))}performConsistencyCheck(e){return this.mutationQueue.length,$.resolve()}Or(e,t){return this.Fr(e)}Fr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Cr(e){const t=this.Fr(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class AT{constructor(){this.ji=!1,this.Hi=!1,this.Ji=100,this.Yi=function(){return I0()?8:ew(Ft())>0?6:4}()}initialize(e,t){this.Zi=e,this.indexManager=t,this.ji=!0}getDocumentsMatchingQuery(e,t,s,o){const u={result:null};return this.Xi(e,t).next(h=>{u.result=h}).next(()=>{if(!u.result)return this.es(e,t,o,s).next(h=>{u.result=h})}).next(()=>{if(u.result)return;const h=new ST;return this.ts(e,t,h).next(m=>{if(u.result=m,this.Hi)return this.ns(e,t,h,m.size)})}).next(()=>u.result)}ns(e,t,s,o){return s.documentReadCount<this.Ji?(Gs()<=Ce.DEBUG&&re("QueryEngine","SDK will not create cache indexes for query:",Ks(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Ji,"documents"),$.resolve()):(Gs()<=Ce.DEBUG&&re("QueryEngine","Query:",Ks(t),"scans",s.documentReadCount,"local documents and returns",o,"documents as results."),s.documentReadCount>this.Yi*o?(Gs()<=Ce.DEBUG&&re("QueryEngine","The SDK decides to create cache indexes for query:",Ks(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Kn(t))):$.resolve())}Xi(e,t){if(Hm(t))return $.resolve(null);let s=Kn(t);return this.indexManager.getIndexType(e,s).next(o=>o===0?null:(t.limit!==null&&o===1&&(t=id(t,null,"F"),s=Kn(t)),this.indexManager.getDocumentsMatchingTarget(e,s).next(u=>{const h=ke(...u);return this.Zi.getDocuments(e,h).next(m=>this.indexManager.getMinOffset(e,s).next(g=>{const v=this.rs(t,m);return this.ss(t,v,h,g.readTime)?this.Xi(e,id(t,null,"F")):this.os(e,v,t,g)}))})))}es(e,t,s,o){return Hm(t)||o.isEqual(Te.min())?$.resolve(null):this.Zi.getDocuments(e,s).next(u=>{const h=this.rs(t,u);return this.ss(t,h,s,o)?$.resolve(null):(Gs()<=Ce.DEBUG&&re("QueryEngine","Re-using previous result from %s to execute query: %s",o.toString(),Ks(t)),this.os(e,h,t,QE(o,-1)).next(m=>m))})}rs(e,t){let s=new gt(gy(e));return t.forEach((o,u)=>{$u(e,u)&&(s=s.add(u))}),s}ss(e,t,s,o){if(e.limit===null)return!1;if(s.size!==t.size)return!0;const u=e.limitType==="F"?t.last():t.first();return!!u&&(u.hasPendingWrites||u.version.compareTo(o)>0)}ts(e,t,s){return Gs()<=Ce.DEBUG&&re("QueryEngine","Using full collection scan to execute query:",Ks(t)),this.Zi.getDocumentsMatchingQuery(e,t,hi.min(),s)}os(e,t,s,o){return this.Zi.getDocumentsMatchingQuery(e,s,o).next(u=>(t.forEach(h=>{u=u.insert(h.key,h)}),u))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sg{constructor(){this.co=()=>this.lo(),this.ho=()=>this.Po(),this.To=[],this.Io()}uo(e){this.To.push(e)}shutdown(){window.removeEventListener("online",this.co),window.removeEventListener("offline",this.ho)}Io(){window.addEventListener("online",this.co),window.addEventListener("offline",this.ho)}lo(){re("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.To)e(0)}Po(){re("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.To)e(1)}static p(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lt="WebChannelConnection";class FT extends class{get Co(){return!1}constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const s=t.ssl?"https":"http",o=encodeURIComponent(this.databaseId.projectId),u=encodeURIComponent(this.databaseId.database);this.Fo=s+"://"+t.host,this.Mo=`projects/${o}/databases/${u}`,this.xo=this.databaseId.database==="(default)"?`project_id=${o}`:`project_id=${o}&database_id=${u}`}Oo(t,s,o,u,h){const m=Bh(),g=this.No(t,s.toUriEncodedString());re("RestConnection",`Sending RPC '${t}' ${m}:`,g,o);const v={"google-cloud-resource-prefix":this.Mo,"x-goog-request-params":this.xo};return this.Bo(v,u,h),this.Lo(t,g,v,o).then(w=>(re("RestConnection",`Received RPC '${t}' ${m}: `,w),w),w=>{throw ro("RestConnection",`RPC '${t}' ${m} failed with error: `,w,"url: ",g,"request:",o),w})}ko(t,s,o,u,h,m){return this.Oo(t,s,o,u,h)}Bo(t,s,o){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+po}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),s&&s.headers.forEach((u,h)=>t[h]=u),o&&o.headers.forEach((u,h)=>t[h]=u)}No(t,s){const o=MT[t];return`${this.Fo}/v1/${s}:${o}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Lo(e,t,s,o){const u=Bh();return new Promise((h,m)=>{const g=new Yg;g.setWithCredentials(!0),g.listenOnce(Jg.COMPLETE,()=>{try{switch(g.getLastErrorCode()){case cu.NO_ERROR:const w=g.getResponseJson();re(Lt,`XHR for RPC '${e}' ${u} received:`,JSON.stringify(w)),h(w);break;case cu.TIMEOUT:re(Lt,`RPC '${e}' ${u} timed out`),m(new oe(H.DEADLINE_EXCEEDED,"Request time out"));break;case cu.HTTP_ERROR:const k=g.getStatus();if(re(Lt,`RPC '${e}' ${u} failed with status:`,k,"response text:",g.getResponseText()),k>0){let M=g.getResponseJson();Array.isArray(M)&&(M=M[0]);const B=M==null?void 0:M.error;if(B&&B.status&&B.message){const Q=function(z){const ee=z.toLowerCase().replace(/_/g,"-");return Object.values(H).indexOf(ee)>=0?ee:H.UNKNOWN}(B.status);m(new oe(Q,B.message))}else m(new oe(H.UNKNOWN,"Server responded with status "+g.getStatus()))}else m(new oe(H.UNAVAILABLE,"Connection failed."));break;default:Ee()}}finally{re(Lt,`RPC '${e}' ${u} completed.`)}});const v=JSON.stringify(o);re(Lt,`RPC '${e}' ${u} sending request:`,o),g.send(t,"POST",v,s,15)})}qo(e,t,s){const o=Bh(),u=[this.Fo,"/","google.firestore.v1.Firestore","/",e,"/channel"],h=ty(),m=ey(),g={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},v=this.longPollingOptions.timeoutSeconds;v!==void 0&&(g.longPollingTimeout=Math.round(1e3*v)),this.useFetchStreams&&(g.useFetchStreams=!0),this.Bo(g.initMessageHeaders,t,s),g.encodeInitMessageHeaders=!0;const w=u.join("");re(Lt,`Creating RPC '${e}' stream ${o}: ${w}`,g);const k=h.createWebChannel(w,g);let M=!1,B=!1;const Q=new bT({Eo:z=>{B?re(Lt,`Not sending because RPC '${e}' stream ${o} is closed:`,z):(M||(re(Lt,`Opening RPC '${e}' stream ${o} transport.`),k.open(),M=!0),re(Lt,`RPC '${e}' stream ${o} sending:`,z),k.send(z))},Ao:()=>k.close()}),Y=(z,ee,le)=>{z.listen(ee,he=>{try{le(he)}catch(pe){setTimeout(()=>{throw pe},0)}})};return Y(k,ma.EventType.OPEN,()=>{B||(re(Lt,`RPC '${e}' stream ${o} transport opened.`),Q.So())}),Y(k,ma.EventType.CLOSE,()=>{B||(B=!0,re(Lt,`RPC '${e}' stream ${o} transport closed`),Q.Do())}),Y(k,ma.EventType.ERROR,z=>{B||(B=!0,ro(Lt,`RPC '${e}' stream ${o} transport errored:`,z),Q.Do(new oe(H.UNAVAILABLE,"The operation could not be completed")))}),Y(k,ma.EventType.MESSAGE,z=>{var ee;if(!B){const le=z.data[0];Ue(!!le);const he=le,pe=(he==null?void 0:he.error)||((ee=he[0])===null||ee===void 0?void 0:ee.error);if(pe){re(Lt,`RPC '${e}' stream ${o} received error:`,pe);const me=pe.status;let ue=function(S){const R=lt[S];if(R!==void 0)return Cy(R)}(me),P=pe.message;ue===void 0&&(ue=H.INTERNAL,P="Unknown error status: "+me+" with message "+pe.message),B=!0,Q.Do(new oe(ue,P)),k.close()}else re(Lt,`RPC '${e}' stream ${o} received:`,le),Q.vo(le)}}),Y(m,Zg.STAT_EVENT,z=>{z.stat===Jh.PROXY?re(Lt,`RPC '${e}' stream ${o} detected buffering proxy`):z.stat===Jh.NOPROXY&&re(Lt,`RPC '${e}' stream ${o} detected no buffering proxy`)}),setTimeout(()=>{Q.bo()},0),Q}}function $h(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KS=5*60,QS=$g("authIdTokenMaxAge")||KS;let Mg=null;const XS=i=>async e=>{const t=e&&await e.getIdTokenResult(),s=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(s&&s>QS)return;const o=t==null?void 0:t.token;Mg!==o&&(Mg=o,await fetch(i,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function YS(i=Gg()){const e=Ed(i,"auth");if(e.isInitialized())return e.getImmediate();const t=N1(i,{popupRedirectResolver:qS,persistence:[tS,$1,$_]}),s=$g("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const u=new URL(s,location.origin);if(location.origin===u.origin){const h=XS(u.toString());j1(t,h,()=>h(t.currentUser)),U1(t,m=>h(m))}}const o=zg("auth");return o&&D1(t,`http://${o}`),t}function JS(){var i,e;return(e=(i=document.getElementsByTagName("head"))===null||i===void 0?void 0:i[0])!==null&&e!==void 0?e:document}R1({loadJS(i){return new Promise((e,t)=>{const s=document.createElement("script");s.setAttribute("src",i),s.onload=e,s.onerror=o=>{const u=Yn("internal-error");u.customData=o,t(u)},s.type="text/javascript",s.charset="UTF-8",JS().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});GS("Browser");const ZS={apiKey:"AIzaSyC70tn1M08W6TSHahhfTIuPBw-lUUtj-EU",authDomain:"calculadora-horarios-v2.firebaseapp.com",projectId:"calculadora-horarios-v2",storageBucket:"calculadora-horarios-v2.firebasestorage.app",messagingSenderId:"217559594958",appId:"1:217559594958:web:9293409f4f344a7201dd9f",measurementId:"G-Y5XBNRSB4Z"},eA=Wg(ZS);YS();const Gi=OI(eA);function tA(i){const[e,t]=He.useState(!1),[s,o]=He.useState(!1),u=async h=>{h.preventDefault();const m=document.querySelector("#login-email"),g=document.querySelector("#login-senha"),v=Zu(uo(Gi,"usuario"),tc("email","==",m.value)),w=await nc(v);if(w.empty){t(!0);return}else t(!1);for(const k of w.docs){if(k.data().senha!==g.value){o(!0);return}else o(!1);const M=k.data().nome;i.getUsuNome(M),i.getEmail(m.value)}i.onConfirm()};return b.jsx(b.Fragment,{children:b.jsx("div",{className:"modal show d-block",tabIndex:-1,style:{backgroundColor:"rgba(0, 0, 0, 0.5)"},children:b.jsx("form",{onSubmit:u,children:b.jsx("div",{className:"modal-dialog",children:b.jsxs("div",{className:"modal-content",children:[b.jsxs("div",{className:"modal-header",children:[b.jsx("h5",{className:"modal-title",children:"Login"}),e&&b.jsxs("div",{className:"warning",children:[b.jsx("img",{src:"/assets/warning-sign-9769.svg"}),b.jsx("p",{style:{paddingRight:"5px",paddingLeft:"5px",display:"flex",alignContent:"center",margin:"auto"},children:"Email não cadastrado!"})]}),!e&&s&&b.jsxs("div",{className:"warning",children:[b.jsx("img",{src:"/assets/warning-sign-9769.svg"}),b.jsx("p",{style:{paddingLeft:"5px",display:"flex",alignContent:"center",margin:"auto"},children:"Senha incorreta!"})]}),b.jsx("button",{type:"button",className:"btn-close","aria-label":"Close",onClick:i.onClose})]}),b.jsxs("div",{className:"modal-body",style:{display:"grid"},children:[b.jsxs("div",{style:{display:"grid"},children:[b.jsx("label",{htmlFor:"email",className:"mb-2",children:"Digite seu email:"}),b.jsx("input",{id:"login-email",name:"email",type:"email",placeholder:"Email",className:"form-control mb-3",required:!0})]}),b.jsxs("div",{style:{display:"grid"},children:[b.jsx("label",{htmlFor:"senha",className:"mb-2",children:"Digite sua senha:"}),b.jsx("input",{id:"login-senha",name:"senha",type:"password",placeholder:"Senha",className:"form-control mb-3",required:!0})]})]}),b.jsxs("div",{className:"modal-footer",children:[b.jsx("button",{type:"button",className:"btn btn-secondary",onClick:i.onClose,children:"Cancelar"}),b.jsx("button",{type:"submit",className:"btn btn-primary",children:"Fazer Login"})]})]})})})})})}function nA(i){const[e,t]=He.useState(!1),[s,o]=He.useState(!1),u=async h=>{h.preventDefault();const m=document.querySelector("#cadastro-nome"),g=document.querySelector("#cadastro-email"),v=document.querySelector("#cadastro-senha"),w=document.querySelector("#cadastro-confSenha"),k=Zu(uo(Gi,"usuario"),tc("email","==",g.value));if((await nc(k)).empty)o(!1);else{o(!0);return}if(w.value!==v.value){t(!0);return}else t(!1);try{await g_(uo(Gi,"usuario"),{nome:(m==null?void 0:m.value)??"",email:(g==null?void 0:g.value)??"",senha:(v==null?void 0:v.value)??""})}catch(B){console.log(B)}i.onConfirm()};return b.jsx(b.Fragment,{children:b.jsx("div",{className:"modal show d-block",tabIndex:-1,style:{backgroundColor:"rgba(0, 0, 0, 0.5)"},children:b.jsx("form",{onSubmit:u,children:b.jsx("div",{className:"modal-dialog",children:b.jsxs("div",{className:"modal-content",children:[b.jsxs("div",{className:"modal-header",children:[b.jsx("h5",{className:"modal-title",children:"Cadastro"}),e&&b.jsxs("div",{className:"warning",children:[b.jsx("img",{src:"/assets/warning-sign-9769.svg"}),b.jsx("p",{style:{paddingRight:"5px",paddingLeft:"5px",display:"flex",alignContent:"center",margin:"auto"},children:"Senhas diferentes!"})]}),s&&b.jsxs("div",{className:"warning",children:[b.jsx("img",{src:"/assets/warning-sign-9769.svg"}),b.jsx("p",{style:{paddingRight:"5px",paddingLeft:"5px",display:"flex",alignContent:"center",margin:"auto"},children:"Email já cadastrado!"})]}),b.jsx("button",{type:"button",className:"btn-close","aria-label":"Close",onClick:i.onClose})]}),b.jsxs("div",{className:"modal-body",style:{display:"grid"},children:[b.jsxs("div",{style:{display:"grid"},children:[b.jsx("label",{htmlFor:"Nome",className:"mb-2",children:"Digite seu Nome:"}),b.jsx("input",{id:"cadastro-nome",name:"nome",type:"name",placeholder:"Nome de Usuário",className:"form-control mb-3",required:!0,minLength:3})]}),b.jsxs("div",{style:{display:"grid"},children:[b.jsx("label",{htmlFor:"email",className:"mb-2",children:"Digite seu email:"}),b.jsx("input",{id:"cadastro-email",name:"email",type:"email",placeholder:"Email",className:"form-control mb-3",required:!0})]}),b.jsxs("div",{style:{display:"grid"},children:[b.jsx("label",{htmlFor:"senha",className:"mb-2",children:"Digite sua senha:"}),b.jsx("input",{id:"cadastro-senha",name:"senha",type:"password",placeholder:"Senha",className:"form-control mb-3",required:!0,minLength:8})]}),b.jsxs("div",{style:{display:"grid"},children:[b.jsx("label",{htmlFor:"confSenha",className:"mb-2",children:"Confirme sua senha:"}),b.jsx("input",{id:"cadastro-confSenha",name:"confSenha",type:"password",placeholder:"Confirme sua Senha",className:"form-control mb-3",required:!0,minLength:8})]})]}),b.jsxs("div",{className:"modal-footer",children:[b.jsx("button",{type:"button",className:"btn btn-secondary",onClick:i.onClose,children:"Cancelar"}),b.jsx("button",{type:"submit",className:"btn btn-primary",children:"Fazer Cadastro"})]})]})})})})})}function rA(i){let e=0;for(let s=0;s<i.length;s++)e=i.charCodeAt(s)+((e<<5)-e);let t="#";for(let s=0;s<3;s++){const o=e>>s*8&255;t+=("00"+o.toString(16)).substr(-2)}return t}function iA(i){var h;const e=`${((h=i.nome[0])==null?void 0:h.toUpperCase())??""}`,t=rA(i.nome),[s,o]=He.useState(!1),u=()=>{o(!s)};return b.jsxs(b.Fragment,{children:[b.jsx("div",{className:"profile-image",style:{backgroundColor:t},onClick:u,children:e}),s&&b.jsxs("div",{style:{backgroundColor:"white",width:"200px",borderRadius:"5px",zIndex:"1",position:"absolute",border:"1px solid #333"},children:[b.jsx("div",{style:{borderBottom:"2px solid #ccc",paddingBottom:"5px"},children:b.jsxs("p",{style:{color:"black",paddingLeft:"12px",paddingTop:"5px",marginBottom:"0",overflow:"hidden"},children:["Olá, ",i.nome]})}),b.jsxs("button",{className:"btn",type:"button",onClick:()=>i.setMostrarResumo(!0),style:{display:"flex",width:"100%",justifyContent:"space-between",color:"black",border:"none"},children:["Visualizar Horários",b.jsx("img",{src:"/assets/clock.svg",alt:"Clock"})]}),b.jsxs("button",{className:"btn",type:"button",onClick:i.isLogado,style:{display:"flex",width:"100%",justifyContent:"space-between",color:"black",border:"none"},children:["Sair",b.jsx("img",{src:"/assets/exit-svgrepo-com.svg",alt:"Exit"})]})]})]})}function sA(i){const[e,t]=He.useState("00:00"),[s,o]=He.useState(""),[u,h]=He.useState(!1),[m,g]=He.useState(!1),[v,w]=He.useState(""),[k,M]=He.useState(""),B=()=>h(!0),Q=()=>h(!1),Y=()=>{i.onLogin(k),g(!0),h(!1)},[z,ee]=He.useState(!1),le=()=>ee(!0),he=()=>ee(!1),pe=()=>{i.onCadastro(),ee(!1)},me=R=>{t(R.target.value)},ue=R=>{o(R.target.value)},P=()=>{g(!1),M(""),i.getEmail(""),i.setTotalHoras("0"),i.setTotalMinutos("0")};function T(R){w(R)}function S(R){M(R),i.getEmail(R)}return b.jsxs(b.Fragment,{children:[b.jsxs("div",{className:"text-bg-success p-4",style:{display:"grid",gridTemplateColumns:"1fr auto 1fr",margin:"auto",justifyContent:"space-between",alignItems:"center",position:"relative"},children:[b.jsx("div",{children:m&&b.jsx("div",{style:{alignContent:"center"},children:b.jsx(iA,{nome:v,isLogado:P,setMostrarResumo:i.setMostrarResumo})})}),b.jsx("h2",{style:{padding:"20px",textAlign:"center",justifySelf:"center"},children:"Calculadora de Horários:"}),b.jsxs("div",{style:{display:"flex",gap:"10px",alignItems:"flex-end",flexDirection:"column"},children:[!m&&b.jsx("button",{type:"button",className:"btn btn-light",style:{width:"100px"},onClick:B,children:"Login"}),!m&&b.jsx("button",{type:"button",className:"btn btn-primary",style:{width:"100px"},onClick:le,children:"Cadastro"})]})]}),b.jsxs("form",{onSubmit:R=>{R.preventDefault();let x=new Date,D=document.querySelector("#observacao"),A=(D==null?void 0:D.value)??"",We=x.toLocaleDateString(),yt=x.toLocaleTimeString(),st=parseInt(e.slice(0,e.indexOf(":"))),Le=parseInt(e.slice(e.indexOf(":")+1)),Z="",de="";st<10?Z="0"+String(st):Z=String(st),Le<10?de="0"+String(Le):de=String(Le),i.onButtonClick(A,k,We,yt,Z,de),t("00:00"),o("")},children:[b.jsx("div",{className:"d-block",style:{width:"300px",margin:"auto"},children:b.jsxs("div",{className:"text-center input-group my-3",children:[b.jsx("span",{className:"input-group-text",id:"basic-addon1",children:"Descrição:"}),b.jsx("input",{type:"text",className:"form-control",id:"observacao",placeholder:"Descrição",value:s,onChange:ue})]})}),b.jsxs("div",{className:"d-block mb-5",style:{width:"300px",margin:"auto"},children:[b.jsxs("div",{className:"text-center input-group my-3",children:[b.jsx("span",{className:"input-group-text",id:"basic-addon1",children:"Digite o tempo:"}),b.jsx("input",{type:"time",className:"form-control",id:"EntradaHorario",onChange:me,value:e,required:!0})]}),b.jsx("div",{children:b.jsx("button",{type:"submit",className:"btn text-bg-primary",style:{width:"300px",margin:"auto"},children:"Enviar"})})]})]}),u&&b.jsx(tA,{getEmail:S,getUsuNome:T,onClose:Q,onConfirm:Y}),z&&b.jsx(nA,{onClose:he,onConfirm:pe})]})}function oA(i){return b.jsx("div",{className:"modal show d-block",tabIndex:-1,style:{backgroundColor:"rgba(0, 0, 0, 0.5)"},children:b.jsx("div",{className:"modal-dialog",children:b.jsxs("div",{className:"modal-content",children:[b.jsxs("div",{className:"modal-header",children:[b.jsx("h5",{className:"modal-title",children:"Confirma Exclusão?"}),b.jsx("button",{type:"button",className:"btn-close","aria-label":"Close",onClick:i.onClose})]}),b.jsx("div",{className:"modal-body",children:b.jsx("p",{children:"Certeza que quer excluir este horário?"})}),b.jsxs("div",{className:"modal-footer",children:[b.jsx("button",{type:"button",className:"btn btn-secondary",onClick:i.onClose,children:"Fechar"}),b.jsx("button",{type:"button",className:"btn btn-primary",onClick:i.onConfirm,children:"Excluir"})]})]})})})}function gd(i){const[e,t]=He.useState(!1),s=()=>t(!0),o=()=>t(!1),u=()=>{var h;(h=i.onRemove)==null||h.call(i),t(!1)};return b.jsxs(b.Fragment,{children:[b.jsxs("div",{className:"rounded d-block",style:{width:"300px",margin:"auto",marginBottom:"20px"},children:[b.jsxs("div",{className:"rounded-top p-2 d-flex text-bg-primary justify-content-between",style:{width:"300px",margin:"auto"},children:[b.jsx("p",{style:{marginBottom:"0px"},children:String(i.observacaoAdicionada).length>0?`${i.observacaoAdicionada}:`:"Horário adicionado:"}),i.onRemove&&b.jsx("button",{type:"button",className:"btn-close","aria-label":"Close",onClick:s})]}),b.jsxs("div",{className:"px-2  rounded-bottom border border-primary",children:[b.jsxs("span",{children:[i.newHora,":",i.newMinuto]}),b.jsxs("p",{style:{fontSize:"12px",marginBottom:"2px"},children:["Data: ",i.addedDate]}),b.jsxs("p",{style:{fontSize:"12px",marginBottom:"2px"},children:["Hora: ",i.addedTime]})]})]}),e&&b.jsx(oA,{onClose:o,onConfirm:u})]})}function bg(i){return b.jsx(b.Fragment,{children:b.jsxs("div",{className:"text-center rounded border border-success",style:{width:"300px",margin:"auto"},children:[b.jsx("h3",{className:"text-bg-success p-3 rounded-top",children:"Total de horas:"}),b.jsxs("p",{children:[parseInt(i.totalHoras)<10?"0"+i.totalHoras:i.totalHoras,":",parseInt(i.totalMinutos)<10?"0"+i.totalMinutos:i.totalMinutos]})]})})}const aA=i=>{if(!i.isOpen)return null;const[e,t]=He.useState([]),[s,o]=He.useState(!1),[u,h]=He.useState(!1),[m,g]=He.useState(0),[v,w]=He.useState(0),k=i.email,M=async B=>{B.preventDefault();const Q=document.querySelector("#mes"),Y=document.querySelector("#ano"),z=parseInt(Q.value),ee=parseInt(Y.value);if(z<1||z>12||isNaN(z)){o(!0);return}else o(!1);if(ee<1989||ee>2300||isNaN(ee)){h(!0);return}else h(!1);try{const le=Zu(uo(Gi,"horario"),tc("email","==",k)),pe=(await nc(le)).docs.map(T=>{const S=T.data();return{id:T.id,email:k,observacao:S.observacao??"",date:S.date??"",time:S.time??"",hora:S.hora??"",minuto:S.minuto??""}}).filter(T=>{if(!T.date)return!1;const[,S,R]=T.date.split("/");return parseInt(R)===ee&&parseInt(S)===z});t(pe);let me=0,ue=0;pe.forEach(T=>{me+=parseInt(T.hora)||0,ue+=parseInt(T.minuto)||0});const P=Math.floor(ue/60);me+=P,ue=ue%60,g(me),w(ue)}catch(le){console.error("Erro ao buscar horários:",le)}};return b.jsx("div",{className:"modal fade show d-block",tabIndex:-1,role:"dialog",style:{backgroundColor:"rgba(0, 0, 0, 0.5)"},children:b.jsx("div",{className:"modal-dialog modal-lg modal-dialog-centered",role:"document",children:b.jsxs("div",{className:"modal-content",children:[b.jsxs("div",{className:"modal-header",children:[b.jsx("h5",{className:"modal-title",children:"Resumo de Horários por Mês"}),s&&b.jsxs("div",{className:"warning",children:[b.jsx("img",{src:"/assets/warning-sign-9769.svg",alt:"Warning"}),b.jsx("p",{style:{paddingRight:"5px",paddingLeft:"5px",display:"flex",alignItems:"center",margin:"auto"},children:"Mês inválido!"})]}),u&&b.jsxs("div",{className:"warning",children:[b.jsx("img",{src:"/assets/warning-sign-9769.svg",alt:"Warning"}),b.jsx("p",{style:{paddingRight:"5px",paddingLeft:"5px",display:"flex",alignItems:"center",margin:"auto"},children:"Ano inválido!"})]})]}),b.jsx("div",{className:"modal-body",children:b.jsx("form",{onSubmit:M,children:b.jsxs("div",{className:"row d-flex justify-content-between",children:[b.jsx("div",{className:"col-5 text-center",children:b.jsxs("div",{className:"text-center input-group my-3",children:[b.jsx("span",{className:"input-group-text",children:"Mês:"}),b.jsx("input",{type:"text",className:"form-control",id:"mes"})]})}),b.jsx("div",{className:"col-5 text-center",children:b.jsxs("div",{className:"text-center input-group my-3",children:[b.jsx("span",{className:"input-group-text",children:"Ano:"}),b.jsx("input",{type:"text",className:"form-control",id:"ano"})]})}),b.jsx("div",{className:"col-2 text-end m-auto",children:b.jsx("button",{type:"submit",className:"btn rounded",style:{width:"50px",height:"40px",backgroundColor:"#e4e6ef"},children:b.jsx("img",{src:"/assets/filter.svg",alt:"Filter"})})})]})})}),b.jsx("div",{className:"modal-body",style:{overflow:"auto",maxHeight:"400px"},children:e.map((B,Q)=>b.jsx(gd,{observacaoAdicionada:B.observacao,addedDate:B.date,addedTime:B.time,newHora:B.hora,newMinuto:B.minuto},Q))}),b.jsxs("div",{className:"modal-footer",children:[b.jsx("div",{style:{marginRight:"auto",marginLeft:"20px"},children:b.jsxs("strong",{children:["Total: ",m," hora",m!==1?"s":""," e ",v," minuto",v!==1?"s":""]})}),b.jsx("button",{type:"button",className:"btn btn-secondary",onClick:i.onClose,children:"Fechar"})]})]})})})};function lA(){const[i,e]=He.useState(!1),[t,s]=He.useState([]),[o,u]=He.useState(""),[h,m]=He.useState(""),[g,v]=He.useState(""),w=window.innerWidth,k=z=>{v(z)};He.useEffect(()=>{s([])},[g]);const M=async z=>{if(z){u("0"),m("0");try{const ee=Zu(uo(Gi,"horario"),tc("email","==",z)),le=await nc(ee),he=new Date,pe=le.docs.map(T=>{const S=T.data();return{id:T.id,email:z,observacao:S.observacao??"",date:S.date??"",time:S.time??"",hora:S.hora??"",minuto:S.minuto??""}}).filter(T=>{if(!T.date)return!1;const[S,R,x]=T.date.split("/"),D=`${x}-${R}-${S}`,A=new Date(D);return A.getFullYear()===he.getFullYear()&&A.getMonth()===he.getMonth()});s(pe);let me=0,ue=0;pe.forEach(T=>{me+=parseInt(T.minuto),ue+=parseInt(T.hora)});const P=Math.floor(me/60);ue+=P,me=me%60,u(String(ue)),m(String(me))}catch(ee){console.error("Erro ao buscar horários:",ee)}}};He.useEffect(()=>{M(g)},[g]);const B=async(z,ee,le,he,pe,me)=>{if((pe!=="00"||me!=="00")&&!isNaN(parseInt(pe))&&!isNaN(parseInt(me)))try{if(ee){const A=await g_(uo(Gi,"horario"),{observacao:z??"",email:ee??"",date:le??"",time:he??"",hora:pe??"",minuto:me??""});s(We=>[...We,{id:A.id,observacao:z,email:ee,date:le,time:he,hora:pe,minuto:me}])}else s(A=>[...A,{id:"",observacao:z,email:ee,date:le,time:he,hora:pe,minuto:me}]);const ue=h===""?0:parseInt(h),P=o===""?0:parseInt(o),T=parseInt(me),S=parseInt(pe);let R=ue+T,x=P+S;const D=Math.floor(R/60);x+=D,R=R%60,m(String(R)),u(String(x))}catch(ue){console.error("Erro ao adicionar horário:",ue)}},Q=()=>{},Y=async z=>{try{const ee=t[z];if(!ee||!ee.id){s(T=>T.filter((S,R)=>R!==z));let me=0,ue=0;t.forEach((T,S)=>{S!==z&&(me+=parseInt(T.minuto),ue+=parseInt(T.hora))});const P=Math.floor(me/60);ue+=P,me=me%60,u(String(ue)),m(String(me));return}await ZI(s_(Gi,"horario",ee.id)),s(me=>me.filter((ue,P)=>P!==z));let le=0,he=0;t.forEach((me,ue)=>{ue!==z&&(le+=parseInt(me.minuto),he+=parseInt(me.hora))});const pe=Math.floor(le/60);he+=pe,le=le%60,u(String(he)),m(String(le))}catch(ee){console.error("Erro ao remover horário:",ee)}};return b.jsxs(b.Fragment,{children:[b.jsx(sA,{getEmail:k,onButtonClick:B,onLogin:M,onCadastro:Q,setTotalHoras:u,setTotalMinutos:m,setMostrarResumo:e}),w>=700&&t.length>0?b.jsxs("div",{className:"row",children:[b.jsx("div",{className:"col",children:t.map((z,ee)=>b.jsx(gd,{observacaoAdicionada:z.observacao,addedDate:z.date,addedTime:z.time,newHora:z.hora,newMinuto:z.minuto,onRemove:()=>Y(ee)},ee))}),b.jsx("div",{className:"col",children:b.jsx(bg,{totalHoras:o===""?"0":o,totalMinutos:h===""?"0":h})})]}):b.jsxs("div",{children:[t.map((z,ee)=>b.jsx(gd,{observacaoAdicionada:z.observacao,addedDate:z.date,addedTime:z.time,newHora:z.hora,newMinuto:z.minuto,onRemove:()=>Y(ee)},ee)),b.jsx(bg,{totalHoras:o===""?"0":o,totalMinutos:h===""?"0":h})]}),i&&b.jsx(aA,{isOpen:i,onClose:()=>e(!1),email:g})]})}o0.createRoot(document.getElementById("root")).render(b.jsx(He.StrictMode,{children:b.jsx(lA,{})}));
